...
public class LogFactoryImpl extends LogFactory
{
    ...
    private ClassLoader getBaseClassLoader() throws LogConfigurationException {
        final ClassLoader thisClassLoader = getClassLoader((LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl == null) ? (LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl = class$("org.apache.commons.logging.impl.LogFactoryImpl")) : LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl);
        if (!this.useTCCL) {
    ...
    private void handleFlawedHierarchy(final ClassLoader badClassLoader, final Class badClass) throws LogConfigurationException {
        ...
        final String logInterfaceName = ((LogFactoryImpl.class$org$apache$commons$logging$Log == null) ? (LogFactoryImpl.class$org$apache$commons$logging$Log = class$("org.apache.commons.logging.Log")) : LogFactoryImpl.class$org$apache$commons$logging$Log).getName();
        ...
        if (implementsLog) {
            if (isDiagnosticsEnabled()) {
                try {
                    final ClassLoader logInterfaceClassLoader = getClassLoader((LogFactoryImpl.class$org$apache$commons$logging$Log == null) ? (LogFactoryImpl.class$org$apache$commons$logging$Log = class$("org.apache.commons.logging.Log")) : LogFactoryImpl.class$org$apache$commons$logging$Log);
            ...
            if (!this.allowFlawedHierarchy) {
                ...
                msg.append(((LogFactoryImpl.class$org$apache$commons$logging$Log == null) ? (LogFactoryImpl.class$org$apache$commons$logging$Log = class$("org.apache.commons.logging.Log")) : LogFactoryImpl.class$org$apache$commons$logging$Log).getName());
                msg.append("' visible.");
                if (isDiagnosticsEnabled()) {
