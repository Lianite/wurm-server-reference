...
public class FontAwesome extends GlyphFont
{
    ...
    public FontAwesome(final String url) {
        super(FontAwesome.fontName, 14, url, true);
        this.registerAll(Arrays.asList(Glyph.values()));
    }
    
    public FontAwesome(final InputStream is) {
        super(FontAwesome.fontName, 14, is, true);
        this.registerAll(Arrays.asList(Glyph.values()));
    }
