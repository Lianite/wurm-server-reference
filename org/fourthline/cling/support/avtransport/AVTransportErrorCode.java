...
public enum AVTransportErrorCode
{
    ...
    private AVTransportErrorCode(final int code, final String description) {
        this.code = code;
    ...
    public static AVTransportErrorCode getByCode(final int code) {
        for (final AVTransportErrorCode errorCode : values()) {
