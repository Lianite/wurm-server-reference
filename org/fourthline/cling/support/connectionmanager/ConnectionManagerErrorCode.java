...
public enum ConnectionManagerErrorCode
{
    ...
    private ConnectionManagerErrorCode(final int code, final String description) {
        this.code = code;
    ...
    public static ConnectionManagerErrorCode getByCode(final int code) {
        for (final ConnectionManagerErrorCode errorCode : values()) {
