...
{
    public JDBC4ServerPreparedStatement(final ConnectionImpl conn, final String sql, final String catalog, final int resultSetType, final int resultSetConcurrency) throws SQLException {
