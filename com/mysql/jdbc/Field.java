...
public class Field
{
    ...
    Field(final ConnectionImpl conn, final byte[] buffer, final int nameStart, final int nameLength, final int tableNameStart, final int tableNameLength, final int length, final int mysqlType, final short colFlag, final int colDecimals) throws SQLException {
    ...
    public void setConnection(final ConnectionImpl conn) {
        this.connection = conn;
