...
class Buffer
{
    ...
    final void writeLenString(final String s, final String encoding, final String serverEncoding, final SingleByteCharsetConverter converter, final boolean parserKnowsUnicode, final ConnectionImpl conn) throws UnsupportedEncodingException, SQLException {
        byte[] b = null;
        if (converter != null) {
    ...
    final void writeString(final String s, final String encoding, final ConnectionImpl conn) throws SQLException {
        this.ensureCapacity(s.length() * 2 + 1);
        try {
    ...
    final void writeStringNoNull(final String s, final String encoding, final String serverEncoding, final boolean parserKnowsUnicode, final ConnectionImpl conn) throws UnsupportedEncodingException, SQLException {
