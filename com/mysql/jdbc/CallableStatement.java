...
public class CallableStatement extends PreparedStatement implements java.sql.CallableStatement
{
    ...
    static /* synthetic */ Class class$com$mysql$jdbc$CallableStatement$CallableStatementParamInfo;
    ...
    public CallableStatement(final ConnectionImpl conn, final CallableStatementParamInfo paramInfo) throws SQLException {
    ...
    protected static CallableStatement getInstance(final ConnectionImpl conn, final String sql, final String catalog, final boolean isFunctionCall) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    protected static CallableStatement getInstance(final ConnectionImpl conn, final CallableStatementParamInfo paramInfo) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    public CallableStatement(final ConnectionImpl conn, final String sql, final String catalog, final boolean isFunctionCall) throws SQLException {
    ...
    private void determineParameterTypes() throws SQLException {
        ...
        try {
            final String procName = this.extractProcedureName();
    ...
    protected String fixParameterName(final String paramNameIn) throws SQLException {
    ...
    private boolean checkReadOnlyProcedure() throws SQLException {
        ...
        synchronized (this.paramInfo) {
            ...
            try {
                ...
                ps = ((DatabaseMetaData)this.connection.getMetaData()).prepareMetaDataSafeStatement("SELECT SQL_DATA_ACCESS FROM  information_schema.routines  WHERE routine_schema = ?  AND routine_name = ?");
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CSTMT_2_ARGS_CTOR = Class.forName("com.mysql.jdbc.JDBC4CallableStatement").getConstructor((CallableStatement.class$com$mysql$jdbc$ConnectionImpl == null) ? (CallableStatement.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : CallableStatement.class$com$mysql$jdbc$ConnectionImpl, (CallableStatement.class$com$mysql$jdbc$CallableStatement$CallableStatementParamInfo == null) ? (CallableStatement.class$com$mysql$jdbc$CallableStatement$CallableStatementParamInfo = class$("com.mysql.jdbc.CallableStatement$CallableStatementParamInfo")) : CallableStatement.class$com$mysql$jdbc$CallableStatement$CallableStatementParamInfo);
                JDBC_4_CSTMT_4_ARGS_CTOR = Class.forName("com.mysql.jdbc.JDBC4CallableStatement").getConstructor((CallableStatement.class$com$mysql$jdbc$ConnectionImpl == null) ? (CallableStatement.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : CallableStatement.class$com$mysql$jdbc$ConnectionImpl, (CallableStatement.class$java$lang$String == null) ? (CallableStatement.class$java$lang$String = class$("java.lang.String")) : CallableStatement.class$java$lang$String, (CallableStatement.class$java$lang$String == null) ? (CallableStatement.class$java$lang$String = class$("java.lang.String")) : CallableStatement.class$java$lang$String, Boolean.TYPE);
                return;
            }
