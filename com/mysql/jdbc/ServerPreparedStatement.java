...
public class ServerPreparedStatement extends PreparedStatement
{
    ...
    protected static ServerPreparedStatement getInstance(final ConnectionImpl conn, final String sql, final String catalog, final int resultSetType, final int resultSetConcurrency) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    protected ServerPreparedStatement(final ConnectionImpl conn, final String sql, final String catalog, final int resultSetType, final int resultSetConcurrency) throws SQLException {
        super(conn, catalog);
    ...
    private ResultSetInternalMethods serverExecute(final int maxRowsToRetrieve, final boolean createStreamingResultSet, final Field[] metadataFromCache) throws SQLException {
        synchronized (this.connection.getMutex()) {
            ...
            try {
                ...
                final ResultSetInternalMethods rs = mysql.readAllResults(this, maxRowsToRetrieve, this.resultSetType, this.resultSetConcurrency, createStreamingResultSet, this.currentCatalog, resultPacket, true, this.fieldCount, metadataFromCache);
                if (this.profileSQL) {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_SPS_CTOR = Class.forName("com.mysql.jdbc.JDBC4ServerPreparedStatement").getConstructor((ServerPreparedStatement.class$com$mysql$jdbc$ConnectionImpl == null) ? (ServerPreparedStatement.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : ServerPreparedStatement.class$com$mysql$jdbc$ConnectionImpl, (ServerPreparedStatement.class$java$lang$String == null) ? (ServerPreparedStatement.class$java$lang$String = class$("java.lang.String")) : ServerPreparedStatement.class$java$lang$String, (ServerPreparedStatement.class$java$lang$String == null) ? (ServerPreparedStatement.class$java$lang$String = class$("java.lang.String")) : ServerPreparedStatement.class$java$lang$String, Integer.TYPE, Integer.TYPE);
                return;
            }
