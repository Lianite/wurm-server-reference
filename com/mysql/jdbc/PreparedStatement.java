...
public class PreparedStatement extends StatementImpl implements java.sql.PreparedStatement
{
    ...
    static /* synthetic */ Class class$com$mysql$jdbc$ConnectionImpl;
    static /* synthetic */ Class class$java$lang$String;
    static /* synthetic */ Class class$com$mysql$jdbc$PreparedStatement$ParseInfo;
    ...
    protected static PreparedStatement getInstance(final ConnectionImpl conn, final String catalog) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    protected static PreparedStatement getInstance(final ConnectionImpl conn, final String sql, final String catalog) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    protected static PreparedStatement getInstance(final ConnectionImpl conn, final String sql, final String catalog, final ParseInfo cachedParseInfo) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    public PreparedStatement(final ConnectionImpl conn, final String catalog) throws SQLException {
        super(conn, catalog);
    ...
    public PreparedStatement(final ConnectionImpl conn, final String sql, final String catalog) throws SQLException {
        super(conn, catalog);
        this.batchHasPlainStatements = false;
        this.dbmd = null;
        this.firstCharOfStmt = '\0';
    ...
    public PreparedStatement(final ConnectionImpl conn, final String sql, final String catalog, final ParseInfo cachedParseInfo) throws SQLException {
        super(conn, catalog);
        this.batchHasPlainStatements = false;
        this.dbmd = null;
        this.firstCharOfStmt = '\0';
    ...
    protected ResultSetInternalMethods executeInternal(final int maxRowsToRetrieve, final Buffer sendPacket, final boolean createStreamingResultSet, final boolean queryIsSelectOnly, final Field[] metadataFromCache, final boolean isBatch) throws SQLException {
        ...
        // 
        //     0: aload_0         /* this */
        //     1: invokevirtual   com/mysql/jdbc/PreparedStatement.resetCancelledState:()V
        //     4: aload_0         /* this */
        //     5: getfield        com/mysql/jdbc/PreparedStatement.connection:Lcom/mysql/jdbc/ConnectionImpl;
        //     8: astore          locallyScopedConnection
        //    10: aload_0         /* this */
        //    11: dup            
        //    12: getfield        com/mysql/jdbc/PreparedStatement.numberOfExecutions:I
        //    15: iconst_1       
        //    16: iadd           
        //    17: putfield        com/mysql/jdbc/PreparedStatement.numberOfExecutions:I
        //    20: aload_0         /* this */
        //    21: getfield        com/mysql/jdbc/PreparedStatement.doPingInstead:Z
        //    24: ifeq            36
        //    27: aload_0         /* this */
        //    28: invokevirtual   com/mysql/jdbc/PreparedStatement.doPingInstead:()V
        //    31: aload_0         /* this */
        //    32: getfield        com/mysql/jdbc/PreparedStatement.results:Lcom/mysql/jdbc/ResultSetInternalMethods;
        //    35: areturn        
        //    36: aconst_null    
        //    37: astore          timeoutTask
        //    39: aload           locallyScopedConnection
        //    41: invokevirtual   com/mysql/jdbc/ConnectionImpl.getEnableQueryTimeouts:()Z
        //    44: ifeq            89
        //    47: aload_0         /* this */
        //    48: getfield        com/mysql/jdbc/PreparedStatement.timeoutInMillis:I
        //    51: ifeq            89
        //    54: aload           locallyScopedConnection
        //    56: iconst_5       
        //    57: iconst_0       
        //    58: iconst_0       
        //    59: invokevirtual   com/mysql/jdbc/ConnectionImpl.versionMeetsMinimum:(III)Z
        //    62: ifeq            89
        //    65: new             Lcom/mysql/jdbc/StatementImpl$CancelTask;
        //    68: dup            
        //    69: aload_0         /* this */
        //    70: aload_0         /* this */
        //    71: invokespecial   com/mysql/jdbc/StatementImpl$CancelTask.<init>:(Lcom/mysql/jdbc/StatementImpl;Lcom/mysql/jdbc/StatementImpl;)V
        //    74: astore          timeoutTask
        //    76: invokestatic    com/mysql/jdbc/ConnectionImpl.getCancelTimer:()Ljava/util/Timer;
        //    79: aload           timeoutTask
        //    81: aload_0         /* this */
        //    82: getfield        com/mysql/jdbc/PreparedStatement.timeoutInMillis:I
        //    85: i2l            
        //    86: invokevirtual   java/util/Timer.schedule:(Ljava/util/TimerTask;J)V
        //    89: aload           locallyScopedConnection
        //    91: aload_0         /* this */
        //    92: aconst_null    
        //    93: iload_1         /* maxRowsToRetrieve */
        //    94: aload_2         /* sendPacket */
        //    95: aload_0         /* this */
        //    96: getfield        com/mysql/jdbc/PreparedStatement.resultSetType:I
        //    99: aload_0         /* this */
        //   100: getfield        com/mysql/jdbc/PreparedStatement.resultSetConcurrency:I
        //   103: iload_3         /* createStreamingResultSet */
        //   104: aload_0         /* this */
        //   105: getfield        com/mysql/jdbc/PreparedStatement.currentCatalog:Ljava/lang/String;
        //   108: aload           metadataFromCache
        //   110: iload           isBatch
        //   112: invokevirtual   com/mysql/jdbc/ConnectionImpl.execSQL:(Lcom/mysql/jdbc/StatementImpl;Ljava/lang/String;ILcom/mysql/jdbc/Buffer;IIZLjava/lang/String;[Lcom/mysql/jdbc/Field;Z)Lcom/mysql/jdbc/ResultSetInternalMethods;
        //   115: astore          rs
        //   117: aload           timeoutTask
        //   119: ifnull          145
        //   122: aload           timeoutTask
        //   124: invokevirtual   com/mysql/jdbc/StatementImpl$CancelTask.cancel:()Z
        //   127: pop            
        //   128: aload           timeoutTask
        //   130: getfield        com/mysql/jdbc/StatementImpl$CancelTask.caughtWhileCancelling:Ljava/sql/SQLException;
        //   133: ifnull          142
        //   136: aload           timeoutTask
        //   138: getfield        com/mysql/jdbc/StatementImpl$CancelTask.caughtWhileCancelling:Ljava/sql/SQLException;
        //   141: athrow         
        //   142: aconst_null    
        //   143: astore          timeoutTask
        //   145: aload_0         /* this */
        //   146: getfield        com/mysql/jdbc/PreparedStatement.cancelTimeoutMutex:Ljava/lang/Object;
        //   149: dup            
        //   150: astore          10
        //   152: monitorenter   
        //   153: aload_0         /* this */
        //   154: getfield        com/mysql/jdbc/PreparedStatement.wasCancelled:Z
        //   157: ifeq            198
        //   160: aconst_null    
        //   161: astore          cause
        //   163: aload_0         /* this */
        //   164: getfield        com/mysql/jdbc/PreparedStatement.wasCancelledByTimeout:Z
        //   167: ifeq            182
        //   170: new             Lcom/mysql/jdbc/exceptions/MySQLTimeoutException;
        //   173: dup            
        //   174: invokespecial   com/mysql/jdbc/exceptions/MySQLTimeoutException.<init>:()V
        //   177: astore          cause
        //   179: goto            191
        //   182: new             Lcom/mysql/jdbc/exceptions/MySQLStatementCancelledException;
        //   185: dup            
        //   186: invokespecial   com/mysql/jdbc/exceptions/MySQLStatementCancelledException.<init>:()V
        //   189: astore          cause
        //   191: aload_0         /* this */
        //   192: invokevirtual   com/mysql/jdbc/PreparedStatement.resetCancelledState:()V
        //   195: aload           cause
        //   197: athrow         
        //   198: aload           10
        //   200: monitorexit    
        ...
        //   209: aload           12
        //   211: athrow         
        //   212: aload           timeoutTask
        //   214: ifnull          242
        //   217: aload           timeoutTask
        //   219: invokevirtual   com/mysql/jdbc/StatementImpl$CancelTask.cancel:()Z
        //   222: pop            
        //   223: goto            242
        //   226: astore          13
        //   228: aload           timeoutTask
        //   230: ifnull          239
        //   233: aload           timeoutTask
        //   235: invokevirtual   com/mysql/jdbc/StatementImpl$CancelTask.cancel:()Z
        //   238: pop            
        //   239: aload           13
        //   241: athrow         
        //   242: aload           8
        ...
        //   245: astore          npe
        //   247: aload_0         /* this */
        //   248: invokevirtual   com/mysql/jdbc/PreparedStatement.checkClosed:()V
        //   251: aload           npe
        //   253: athrow         
        //    Exceptions:
        ...
        //  -----  ------  ----  ------------------------  -----------------------------------------
        //  163    35      11    cause                     Ljava/sql/SQLException;
        //  117    109     8     rs                        Lcom/mysql/jdbc/ResultSetInternalMethods;
        //  10     235     7     locallyScopedConnection   Lcom/mysql/jdbc/ConnectionImpl;
        //  39     206     9     timeoutTask               Lcom/mysql/jdbc/StatementImpl$CancelTask;
        //  247    7       7     npe                       Ljava/lang/NullPointerException;
        //  0      254     0     this                      Lcom/mysql/jdbc/PreparedStatement;
        //  0      254     1     maxRowsToRetrieve         I
        //  0      254     2     sendPacket                Lcom/mysql/jdbc/Buffer;
        //  0      254     3     createStreamingResultSet  Z
        //  0      254     4     queryIsSelectOnly         Z
        //  0      254     5     metadataFromCache         [Lcom/mysql/jdbc/Field;
        //  0      254     6     isBatch                   Z
        //    Exceptions:
        //  Try           Handler
        ...
        //  39     212    226    242    Any
        //  226    228    226    242    Any
        //  0      35     245    254    Ljava/lang/NullPointerException;
        //  36     244    245    254    Ljava/lang/NullPointerException;
        // 
    ...
    protected PreparedStatement prepareBatchedInsertSQL(final ConnectionImpl localConn, final int numBatches) throws SQLException {
        final PreparedStatement pstmt = new PreparedStatement(localConn, "batch statement, no sql available", this.currentCatalog, this.parseInfo.getParseInfoForBatch(numBatches));
    ...
    private synchronized void newSetDateInternal(final int parameterIndex, final Date x, final Calendar targetCalendar) throws SQLException {
        if (this.ddf == null) {
    ...
    static {
        Label_0324: {
            if (Util.isJdbc4()) {
                try {
                    JDBC_4_PSTMT_2_ARG_CTOR = Class.forName("com.mysql.jdbc.JDBC4PreparedStatement").getConstructor((PreparedStatement.class$com$mysql$jdbc$ConnectionImpl == null) ? (PreparedStatement.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : PreparedStatement.class$com$mysql$jdbc$ConnectionImpl, (PreparedStatement.class$java$lang$String == null) ? (PreparedStatement.class$java$lang$String = class$("java.lang.String")) : PreparedStatement.class$java$lang$String);
                    JDBC_4_PSTMT_3_ARG_CTOR = Class.forName("com.mysql.jdbc.JDBC4PreparedStatement").getConstructor((PreparedStatement.class$com$mysql$jdbc$ConnectionImpl == null) ? (PreparedStatement.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : PreparedStatement.class$com$mysql$jdbc$ConnectionImpl, (PreparedStatement.class$java$lang$String == null) ? (PreparedStatement.class$java$lang$String = class$("java.lang.String")) : PreparedStatement.class$java$lang$String, (PreparedStatement.class$java$lang$String == null) ? (PreparedStatement.class$java$lang$String = class$("java.lang.String")) : PreparedStatement.class$java$lang$String);
                    JDBC_4_PSTMT_4_ARG_CTOR = Class.forName("com.mysql.jdbc.JDBC4PreparedStatement").getConstructor((PreparedStatement.class$com$mysql$jdbc$ConnectionImpl == null) ? (PreparedStatement.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : PreparedStatement.class$com$mysql$jdbc$ConnectionImpl, (PreparedStatement.class$java$lang$String == null) ? (PreparedStatement.class$java$lang$String = class$("java.lang.String")) : PreparedStatement.class$java$lang$String, (PreparedStatement.class$java$lang$String == null) ? (PreparedStatement.class$java$lang$String = class$("java.lang.String")) : PreparedStatement.class$java$lang$String, (PreparedStatement.class$com$mysql$jdbc$PreparedStatement$ParseInfo == null) ? (PreparedStatement.class$com$mysql$jdbc$PreparedStatement$ParseInfo = class$("com.mysql.jdbc.PreparedStatement$ParseInfo")) : PreparedStatement.class$com$mysql$jdbc$PreparedStatement$ParseInfo);
                    break Label_0324;
                }
    ...
    class ParseInfo
    {
        ...
        ParseInfo(final PreparedStatement this$0, final String sql, final ConnectionImpl conn, final DatabaseMetaData dbmd, final String encoding, final SingleByteCharsetConverter converter) throws SQLException {
            this(this$0, sql, conn, dbmd, encoding, converter, true);
        }
        
        public ParseInfo(final String sql, final ConnectionImpl conn, final DatabaseMetaData dbmd, final String encoding, final SingleByteCharsetConverter converter, final boolean buildRewriteInfo) throws SQLException {
        ...
        private void buildRewriteBatchedParams(final String sql, final ConnectionImpl conn, final DatabaseMetaData metadata, final String encoding, final SingleByteCharsetConverter converter) throws SQLException {
        ...
        private String extractValuesClause(final String sql) throws SQLException {
            ...
            while (indexOfValues == -1) {
                ...
                final char c = PreparedStatement.this.originalSql.charAt(indexOfValues - 1);
                switch (c) {
                    case '\t':
                    case '\n':
                    case ' ':
            ...
            final int indexOfFirstParen = sql.indexOf(40, indexOfValues + 7);
