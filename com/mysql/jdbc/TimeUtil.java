...
public class TimeUtil
{
    ...
    public static Time changeTimezone(final ConnectionImpl conn, final Calendar sessionCalendar, final Calendar targetCalendar, final Time t, final TimeZone fromTz, final TimeZone toTz, final boolean rollForward) {
        if (conn != null) {
    ...
    public static Timestamp changeTimezone(final ConnectionImpl conn, final Calendar sessionCalendar, final Calendar targetCalendar, final Timestamp tstamp, final TimeZone fromTz, final TimeZone toTz, final boolean rollForward) {
        if (conn != null) {
