...
public class DatabaseMetaData implements java.sql.DatabaseMetaData
{
    ...
    protected static DatabaseMetaData getInstance(final ConnectionImpl connToSet, final String databaseToSet, final boolean checkForInfoSchema) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    protected DatabaseMetaData(final ConnectionImpl connToSet, final String databaseToSet) {
        this.database = null;
        this.quotedId = null;
        this.conn = connToSet;
    ...
    static ResultSet buildResultSet(final Field[] fields, final ArrayList rows, final ConnectionImpl c) throws SQLException {
    ...
    private ResultSetRow convertTypeDescriptorToProcedureRow(final byte[] procNameAsBytes, final String paramName, final boolean isOutParam, final boolean isInParam, final boolean isReturnParam, final TypeDescriptor typeDesc, final boolean forGetFunctionColumns, final int ordinal) throws SQLException {
    ...
    public ResultSet extractForeignKeyFromCreateTable(final String catalog, final String tableName) throws SQLException {
        ...
        try {
            for (int i = 0; i < numTables; ++i) {
                ...
                final String query = "SHOW CREATE TABLE " + quoteChar + catalog + quoteChar + "." + quoteChar + tableToExtract + quoteChar;
                try {
    ...
    private void getCallStmtParameterTypes(String catalog, String procName, String parameterNamePattern, final List resultRows, final boolean forGetFunctionColumns) throws SQLException {
        ...
        if (parameterDef != null) {
            ...
            for (int parseListLen = parseList.size(), i = 0; i < parseListLen; ++i) {
                final String declaration = parseList.get(i);
                ...
                if (wildCompareRes != -1) {
                    final ResultSetRow row = this.convertTypeDescriptorToProcedureRow(procNameAsBytes, paramName, isOutParam, isInParam, false, typeDesc, forGetFunctionColumns, ordinal++);
                    resultRows.add(row);
                }
            }
        }
                            ...
                            while (fkresults.next()) {
                                ...
                                if (tableType != null && (tableType.equalsIgnoreCase("innodb") || tableType.equalsIgnoreCase("SUPPORTS_FK"))) {
                                    ...
                                    if (commentTokens.hasMoreTokens()) {
                                        final String dummy = commentTokens.nextToken();
                                    }
    ...
    public String getDriverVersion() throws SQLException {
        return "mysql-connector-java-5.1.10 ( Revision: ${svn.Revision} )";
    }
    ...
    protected Field[] createIndexInfoFields() {
        final Field[] fields = { new Field("", "TABLE_CAT", 1, 255), new Field("", "TABLE_SCHEM", 1, 0), new Field("", "TABLE_NAME", 1, 255), new Field("", "NON_UNIQUE", 16, 4), new Field("", "INDEX_QUALIFIER", 1, 1), new Field("", "INDEX_NAME", 1, 32), new Field("", "TYPE", 5, 32), new Field("", "ORDINAL_POSITION", 5, 5), new Field("", "COLUMN_NAME", 1, 32), new Field("", "ASC_OR_DESC", 1, 1), new Field("", "CARDINALITY", 4, 10), new Field("", "PAGES", 4, 10), new Field("", "FILTER_CONDITION", 1, 32) };
        return fields;
    }
    ...
    protected ResultSet getProcedureOrFunctionColumns(final Field[] fields, final String catalog, final String schemaPattern, final String procedureOrFunctionNamePattern, final String columnNamePattern, final boolean returnProcedures, final boolean returnFunctions) throws SQLException {
    ...
    protected ResultSet getProceduresAndOrFunctions(final Field[] fields, final String catalog, final String schemaPattern, String procedureNamePattern, final boolean returnProcedures, final boolean returnFunctions) throws SQLException {
        ...
        if (this.supportsStoredProcedures()) {
            ...
            new IterateBlock(this.getCatalogIterator(catalog)) {
                void forEach(final Object catalogStr) throws SQLException {
                    final String db = catalogStr.toString();
    ...
    protected PreparedStatement prepareMetaDataSafeStatement(final String sql) throws SQLException {
        final PreparedStatement pStmt = (PreparedStatement)this.conn.clientPrepareStatement(sql);
    ...
    static {
        ...
        Label_0205: {
            if (Util.isJdbc4()) {
                try {
                    JDBC_4_DBMD_SHOW_CTOR = Class.forName("com.mysql.jdbc.JDBC4DatabaseMetaData").getConstructor((DatabaseMetaData.class$com$mysql$jdbc$ConnectionImpl == null) ? (DatabaseMetaData.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : DatabaseMetaData.class$com$mysql$jdbc$ConnectionImpl, (DatabaseMetaData.class$java$lang$String == null) ? (DatabaseMetaData.class$java$lang$String = class$("java.lang.String")) : DatabaseMetaData.class$java$lang$String);
                    JDBC_4_DBMD_IS_CTOR = Class.forName("com.mysql.jdbc.JDBC4DatabaseMetaDataUsingInfoSchema").getConstructor((DatabaseMetaData.class$com$mysql$jdbc$ConnectionImpl == null) ? (DatabaseMetaData.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : DatabaseMetaData.class$com$mysql$jdbc$ConnectionImpl, (DatabaseMetaData.class$java$lang$String == null) ? (DatabaseMetaData.class$java$lang$String = class$("java.lang.String")) : DatabaseMetaData.class$java$lang$String);
                    break Label_0205;
                }
