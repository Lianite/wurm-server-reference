...
public class ConnectionImpl extends ConnectionPropertiesImpl implements Connection
{
    ...
    protected static SQLException appendMessageToException(final SQLException sqlEx, final String messageToAppend, final ExceptionInterceptor interceptor) {
        ...
        try {
            ...
            getStackTraceMethod = ((ConnectionImpl.class$java$lang$Throwable == null) ? (ConnectionImpl.class$java$lang$Throwable = class$("java.lang.Throwable")) : ConnectionImpl.class$java$lang$Throwable).getMethod("getStackTrace", (Class[])new Class[0]);
            setStackTraceMethod = ((ConnectionImpl.class$java$lang$Throwable == null) ? (ConnectionImpl.class$java$lang$Throwable = class$("java.lang.Throwable")) : ConnectionImpl.class$java$lang$Throwable).getMethod("setStackTrace", stackTraceElementArrayClass);
    ...
    protected static Timer getCancelTimer() {
        return ConnectionImpl.cancelTimer;
    }
    ...
    protected ConnectionImpl(final String hostToConnectTo, final int portToConnectTo, final Properties info, String databaseToConnectTo, final String url) throws SQLException {
        ...
        try {
            ((ConnectionImpl.class$java$sql$Blob == null) ? (ConnectionImpl.class$java$sql$Blob = class$("java.sql.Blob")) : ConnectionImpl.class$java$sql$Blob).getMethod("truncate", Long.TYPE);
            this.isRunningOnJDK13 = false;
        }
        ...
        final int numHosts = Integer.parseInt(info.getProperty("NUM_HOSTS"));
        if (hostToConnectTo == null) {
            ...
            for (int i = 0; i < numHosts; ++i) {
                final int index = i + 1;
                this.hostList.add(info.getProperty("HOST." + index) + ":" + info.getProperty("PORT." + index));
            }
        }
        else {
        ...
        Label_0289: {
            if (this.getCachePreparedStatements()) {
                synchronized (this.cachedPreparedStatementParams) {
                    ...
                    if (pStmtInfo == null) {
                        pStmt = com.mysql.jdbc.PreparedStatement.getInstance(this, nativeSql, this.database);
                        ...
                        pStmt = new com.mysql.jdbc.PreparedStatement(this, nativeSql, this.database, pStmtInfo);
                    }
                    break Label_0289;
                }
            }
    ...
    public synchronized void close() throws SQLException {
        if (this.connectionLifecycleInterceptors != null) {
            new IterateBlock((Iterator)this.connectionLifecycleInterceptors.iterator()) {
    ...
    public void commit() throws SQLException {
        synchronized (this.getMutex()) {
            ...
            try {
                if (this.connectionLifecycleInterceptors != null) {
                    final IterateBlock iter = new IterateBlock((Iterator)this.connectionLifecycleInterceptors.iterator()) {
                        void forEach(final Object each) throws SQLException {
                    ...
                    if (realJavaEncoding != null) {
                        if (realJavaEncoding.equalsIgnoreCase("UTF-8") || realJavaEncoding.equalsIgnoreCase("UTF8")) {
                            if (!this.getUseOldUTF8Behavior() && (dontCheckServerMatch || !this.characterSetNamesMatches("utf8"))) {
                                this.execSQL(null, "SET NAMES utf8", -1, null, 1003, 1007, false, this.database, null, false);
                            }
                            this.setEncoding(realJavaEncoding);
                        }
                        else {
    ...
    protected void createNewIO(final boolean isForReconnect) throws SQLException {
        synchronized (this.mutex) {
            ...
            try {
                if (!this.getHighAvailability() && !this.failedOver) {
                        ...
                        try {
                            ...
                            if (hostPortPair[1] != null) {
                                try {
                                    ...
                                    throw SQLError.createSQLException("Illegal connection port value '" + hostPortPair[1] + "'", "01S00", this.getExceptionInterceptor());
                                }
                            }
                            (this.io = new MysqlIO(newHost, newPort, mergedProps, this.getSocketFactoryClassName(), this, this.getSocketTimeout(), this.largeRowSizeThreshold.getValueAsInt())).doHandshake(this.user, this.password, this.database);
                            ...
                            if (this.getRoundRobinLoadBalance()) {
                                ...
                                throw SQLError.createCommunicationsException(this, (this.io != null) ? this.io.getLastPacketSentTimeMs() : 0L, (this.io != null) ? this.io.getLastPacketReceivedTimeMs() : 0L, EEE, this.getExceptionInterceptor());
                            }
                            ++hostIndex;
                            continue;
                        }
                    ...
                    while (hostIndex2 < this.hostListSize && !connectionGood2) {
                        ...
                        while (attemptCount < this.getMaxReconnects() && !connectionGood2) {
                            try {
                                ...
                                if (newHost2 == null || StringUtils.isEmptyOrWhitespaceOnly(newHost2)) {
                                    newHost2 = "localhost";
                                }
                                if (hostPortPair2[1] != null) {
                                    try {
                                        ...
                                        throw SQLError.createSQLException("Illegal connection port value '" + hostPortPair2[1] + "'", "01S00", this.getExceptionInterceptor());
                                    }
                                }
                                (this.io = new MysqlIO(newHost2, newPort2, mergedProps, this.getSocketFactoryClassName(), this, this.getSocketTimeout(), this.largeRowSizeThreshold.getValueAsInt())).doHandshake(this.user, this.password, this.database);
                    ...
                    if (!connectionGood2) {
                        final SQLException chainedEx2 = SQLError.createSQLException(Messages.getString("Connection.UnableToConnectWithRetries", new Object[] { new Integer(this.getMaxReconnects()) }), "08001", this.getExceptionInterceptor());
                        chainedEx2.initCause(connectionException);
                        throw chainedEx2;
                    }
                }
    ...
    public Statement createStatement(final int resultSetType, final int resultSetConcurrency) throws SQLException {
        this.checkClosed();
        final StatementImpl stmt = new StatementImpl(this, this.database);
    ...
    ResultSetInternalMethods execSQL(final StatementImpl callingStatement, final String sql, final int maxRows, final Buffer packet, final int resultSetType, final int resultSetConcurrency, final boolean streamResults, final String catalog, final Field[] cachedMetadata) throws SQLException {
    ...
    ResultSetInternalMethods execSQL(final StatementImpl callingStatement, final String sql, final int maxRows, final Buffer packet, final int resultSetType, final int resultSetConcurrency, final boolean streamResults, final String catalog, final Field[] cachedMetadata, final boolean isBatch) throws SQLException {
        synchronized (this.mutex) {
    ...
    private void initializePropsFromServer() throws SQLException {
        ...
        if (connectionInterceptorClasses != null) {
            ...
            final Iterator iter = this.connectionLifecycleInterceptors.iterator();
    ...
    void maxRowsChanged(final com.mysql.jdbc.Statement stmt) {
        synchronized (this.mutex) {
    ...
    protected void pingInternal(final boolean checkForClosedConnection, final int timeoutMillis) throws SQLException {
    ...
    protected void recachePreparedStatement(final ServerPreparedStatement pstmt) throws SQLException {
        if (pstmt.isPoolable()) {
            synchronized (this.serverSideStatementCache) {
    ...
    void registerStatement(final com.mysql.jdbc.Statement stmt) {
        synchronized (this.openStatements) {
    ...
    public PreparedStatement serverPrepareStatement(final String sql) throws SQLException {
        final String nativeSql = this.getProcessEscapeCodesForPrepStmts() ? this.nativeSQL(sql) : sql;
        return ServerPreparedStatement.getInstance(this, nativeSql, this.getCatalog(), 1003, 1007);
    }
    
    public PreparedStatement serverPrepareStatement(final String sql, final int autoGenKeyIndex) throws SQLException {
        final String nativeSql = this.getProcessEscapeCodesForPrepStmts() ? this.nativeSQL(sql) : sql;
        final com.mysql.jdbc.PreparedStatement pStmt = ServerPreparedStatement.getInstance(this, nativeSql, this.getCatalog(), 1003, 1007);
    ...
    void unregisterStatement(final com.mysql.jdbc.Statement stmt) {
        if (this.openStatements != null) {
            synchronized (this.openStatements) {
    ...
    void unsetMaxRows(final com.mysql.jdbc.Statement stmt) throws SQLException {
        synchronized (this.mutex) {
            if (this.statementsUsingMaxRows != null) {
    ...
    protected void initializeResultsMetadataFromCache(final String sql, CachedResultSetMetaData cachedMetaData, final ResultSetInternalMethods resultSet) throws SQLException {
    ...
    static {
        ...
        try {
            final Constructor ctr = ((ConnectionImpl.class$java$util$Timer == null) ? (ConnectionImpl.class$java$util$Timer = class$("java.util.Timer")) : ConnectionImpl.class$java$util$Timer).getConstructor((ConnectionImpl.class$java$lang$String == null) ? (ConnectionImpl.class$java$lang$String = class$("java.lang.String")) : ConnectionImpl.class$java$lang$String, Boolean.TYPE);
            ConnectionImpl.cancelTimer = ctr.newInstance("MySQL Statement Cancellation Timer", Boolean.TRUE);
        ...
        if (!createdNamedTimer) {
            ConnectionImpl.cancelTimer = new Timer(true);
        }
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CONNECTION_CTOR = Class.forName("com.mysql.jdbc.JDBC4Connection").getConstructor((ConnectionImpl.class$java$lang$String == null) ? (ConnectionImpl.class$java$lang$String = class$("java.lang.String")) : ConnectionImpl.class$java$lang$String, Integer.TYPE, (ConnectionImpl.class$java$util$Properties == null) ? (ConnectionImpl.class$java$util$Properties = class$("java.util.Properties")) : ConnectionImpl.class$java$util$Properties, (ConnectionImpl.class$java$lang$String == null) ? (ConnectionImpl.class$java$lang$String = class$("java.lang.String")) : ConnectionImpl.class$java$lang$String, (ConnectionImpl.class$java$lang$String == null) ? (ConnectionImpl.class$java$lang$String = class$("java.lang.String")) : ConnectionImpl.class$java$lang$String);
                return;
            }
