...
public class StatementWrapper extends WrapperBase implements Statement
{
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_STATEMENT_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper").getConstructor((StatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper == null) ? (StatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper = class$("com.mysql.jdbc.jdbc2.optional.ConnectionWrapper")) : StatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper, (StatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection == null) ? (StatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection = class$("com.mysql.jdbc.jdbc2.optional.MysqlPooledConnection")) : StatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection, (StatementWrapper.class$java$sql$Statement == null) ? (StatementWrapper.class$java$sql$Statement = class$("java.sql.Statement")) : StatementWrapper.class$java$sql$Statement);
                return;
            }
