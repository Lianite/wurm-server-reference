...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement
{
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_PREPARED_STATEMENT_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4PreparedStatementWrapper").getConstructor((PreparedStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper == null) ? (PreparedStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper = class$("com.mysql.jdbc.jdbc2.optional.ConnectionWrapper")) : PreparedStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper, (PreparedStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection == null) ? (PreparedStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection = class$("com.mysql.jdbc.jdbc2.optional.MysqlPooledConnection")) : PreparedStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection, (PreparedStatementWrapper.class$java$sql$PreparedStatement == null) ? (PreparedStatementWrapper.class$java$sql$PreparedStatement = class$("java.sql.PreparedStatement")) : PreparedStatementWrapper.class$java$sql$PreparedStatement);
                return;
            }
