...
public class MysqlXAConnection extends MysqlPooledConnection implements XAConnection, XAResource
{
    ...
    static {
        ...
        if (Util.isJdbc4()) {
            try {
                JDBC_4_XA_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4MysqlXAConnection").getConstructor((MysqlXAConnection.class$com$mysql$jdbc$ConnectionImpl == null) ? (MysqlXAConnection.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : MysqlXAConnection.class$com$mysql$jdbc$ConnectionImpl, Boolean.TYPE);
                return;
            }
