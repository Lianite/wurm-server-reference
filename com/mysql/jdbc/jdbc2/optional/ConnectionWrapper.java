...
public class ConnectionWrapper extends WrapperBase implements Connection
{
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4ConnectionWrapper").getConstructor((ConnectionWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection == null) ? (ConnectionWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection = class$("com.mysql.jdbc.jdbc2.optional.MysqlPooledConnection")) : ConnectionWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection, (ConnectionWrapper.class$com$mysql$jdbc$Connection == null) ? (ConnectionWrapper.class$com$mysql$jdbc$Connection = class$("com.mysql.jdbc.Connection")) : ConnectionWrapper.class$com$mysql$jdbc$Connection, Boolean.TYPE);
                return;
            }
