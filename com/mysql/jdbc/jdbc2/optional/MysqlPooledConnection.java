...
public class MysqlPooledConnection implements PooledConnection
{
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_POOLED_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4MysqlPooledConnection").getConstructor((MysqlPooledConnection.class$com$mysql$jdbc$Connection == null) ? (MysqlPooledConnection.class$com$mysql$jdbc$Connection = class$("com.mysql.jdbc.Connection")) : MysqlPooledConnection.class$com$mysql$jdbc$Connection);
                return;
            }
