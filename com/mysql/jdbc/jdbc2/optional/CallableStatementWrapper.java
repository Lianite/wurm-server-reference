...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement
{
    ...
    static /* synthetic */ Class class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper;
    static /* synthetic */ Class class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection;
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CALLABLE_STATEMENT_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4CallableStatementWrapper").getConstructor((CallableStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper == null) ? (CallableStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper = class$("com.mysql.jdbc.jdbc2.optional.ConnectionWrapper")) : CallableStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$ConnectionWrapper, (CallableStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection == null) ? (CallableStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection = class$("com.mysql.jdbc.jdbc2.optional.MysqlPooledConnection")) : CallableStatementWrapper.class$com$mysql$jdbc$jdbc2$optional$MysqlPooledConnection, (CallableStatementWrapper.class$java$sql$CallableStatement == null) ? (CallableStatementWrapper.class$java$sql$CallableStatement = class$("java.sql.CallableStatement")) : CallableStatementWrapper.class$java$sql$CallableStatement);
                return;
            }
