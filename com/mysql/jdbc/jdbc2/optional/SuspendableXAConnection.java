...
public class SuspendableXAConnection extends MysqlPooledConnection implements XAConnection, XAResource
{
    ...
    static {
        Label_0082: {
            if (Util.isJdbc4()) {
                try {
                    JDBC_4_XA_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4SuspendableXAConnection").getConstructor((SuspendableXAConnection.class$com$mysql$jdbc$ConnectionImpl == null) ? (SuspendableXAConnection.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : SuspendableXAConnection.class$com$mysql$jdbc$ConnectionImpl);
                    break Label_0082;
                }
