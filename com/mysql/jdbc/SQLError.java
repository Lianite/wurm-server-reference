...
public class SQLError
{
    ...
    public static void dumpSqlStatesMappingsAsXml() throws Exception {
        ...
        final Field[] possibleFields = ((SQLError.class$com$mysql$jdbc$MysqlErrorNumbers == null) ? (SQLError.class$com$mysql$jdbc$MysqlErrorNumbers = class$("com.mysql.jdbc.MysqlErrorNumbers")) : SQLError.class$com$mysql$jdbc$MysqlErrorNumbers).getDeclaredFields();
    ...
    public static SQLException createSQLException(String message, final String sqlState, final Throwable cause, final ExceptionInterceptor interceptor) {
            ...
            if (sqlState != null) {
                if (sqlState.startsWith("08")) {
                    if (isTransient) {
                        ...
                        return (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLTransientConnectionException", new Class[] { (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
                    }
                    else {
                        if (!Util.isJdbc4()) {
                            return new MySQLNonTransientConnectionException(message, sqlState, vendorErrorCode);
                        }
                        return (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException", new Class[] { (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
                    }
                }
                    ...
                    return (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLDataException", new Class[] { (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
                }
                else if (sqlState.startsWith("23")) {
                    if (!Util.isJdbc4()) {
                        return new MySQLIntegrityConstraintViolationException(message, sqlState, vendorErrorCode);
                    }
                    return (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException", new Class[] { (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
                }
                else if (sqlState.startsWith("42")) {
                    if (!Util.isJdbc4()) {
                        return new MySQLSyntaxErrorException(message, sqlState, vendorErrorCode);
                    }
                    return (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException", new Class[] { (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
                }
                else if (sqlState.startsWith("40")) {
                    if (!Util.isJdbc4()) {
                        return new MySQLTransactionRollbackException(message, sqlState, vendorErrorCode);
                    }
                    return (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLTransactionRollbackException", new Class[] { (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, (SQLError.class$java$lang$String == null) ? (SQLError.class$java$lang$String = class$("java.lang.String")) : SQLError.class$java$lang$String, Integer.TYPE }, new Object[] { message, sqlState, Constants.integerValueOf(vendorErrorCode) }, interceptor);
                }
            }
    ...
    public static SQLException createCommunicationsException(final ConnectionImpl conn, final long lastPacketSentTimeMs, final long lastPacketReceivedTimeMs, final Exception underlyingException, final ExceptionInterceptor interceptor) {
    ...
    public static String createLinkFailureMessageBasedOnHeuristics(final ConnectionImpl conn, long lastPacketSentTimeMs, final long lastPacketReceivedTimeMs, final Exception underlyingException, final boolean streamingResultSetInPlay) {
    ...
    static {
        Label_0118: {
            if (Util.isJdbc4()) {
                try {
                    JDBC_4_COMMUNICATIONS_EXCEPTION_CTOR = Class.forName("com.mysql.jdbc.exceptions.jdbc4.CommunicationsException").getConstructor((SQLError.class$com$mysql$jdbc$ConnectionImpl == null) ? (SQLError.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : SQLError.class$com$mysql$jdbc$ConnectionImpl, Long.TYPE, Long.TYPE, (SQLError.class$java$lang$Exception == null) ? (SQLError.class$java$lang$Exception = class$("java.lang.Exception")) : SQLError.class$java$lang$Exception);
                    break Label_0118;
                }
            ...
            try {
                SQLError.THROWABLE_INIT_CAUSE_METHOD = ((SQLError.class$java$lang$Throwable == null) ? (SQLError.class$java$lang$Throwable = class$("java.lang.Throwable")) : SQLError.class$java$lang$Throwable).getMethod("initCause", (SQLError.class$java$lang$Throwable == null) ? (SQLError.class$java$lang$Throwable = class$("java.lang.Throwable")) : SQLError.class$java$lang$Throwable);
            }
            catch (Throwable t) {
