...
public class ResultSetScannerInterceptor implements StatementInterceptor
{
    ...
    static /* synthetic */ Class class$com$mysql$jdbc$ResultSetInternalMethods;
    ...
    public ResultSetInternalMethods postProcess(final String sql, final Statement interceptedStatement, final ResultSetInternalMethods originalResultSet, final Connection connection) throws SQLException {
        return (ResultSetInternalMethods)Proxy.newProxyInstance(originalResultSet.getClass().getClassLoader(), new Class[] { (ResultSetScannerInterceptor.class$com$mysql$jdbc$ResultSetInternalMethods == null) ? (ResultSetScannerInterceptor.class$com$mysql$jdbc$ResultSetInternalMethods = class$("com.mysql.jdbc.ResultSetInternalMethods")) : ResultSetScannerInterceptor.class$com$mysql$jdbc$ResultSetInternalMethods }, new InvocationHandler() {
