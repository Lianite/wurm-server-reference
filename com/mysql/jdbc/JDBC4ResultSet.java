...
{
    public JDBC4ResultSet(final long updateCount, final long updateID, final ConnectionImpl conn, final StatementImpl creatorStmt) {
        super(updateCount, updateID, conn, creatorStmt);
    }
    
    public JDBC4ResultSet(final String catalog, final Field[] fields, final RowData tuples, final ConnectionImpl conn, final StatementImpl creatorStmt) throws SQLException {
