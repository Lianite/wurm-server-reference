...
public class ConnectionPropertiesImpl implements Serializable, ConnectionProperties
{
    ...
    static /* synthetic */ Class class$com$mysql$jdbc$ConnectionPropertiesImpl;
    static /* synthetic */ Class class$com$mysql$jdbc$ConnectionPropertiesImpl$ConnectionProperty;
    ...
    public ConnectionPropertiesImpl() {
        ...
        this.loadBalanceStrategy = new StringConnectionProperty("loadBalanceStrategy", "random", new String[] { "random", "bestResponseTime" }, Messages.getString("ConnectionProperties.loadBalanceStrategy"), "5.0.6", ConnectionPropertiesImpl.PERFORMANCE_CATEGORY, Integer.MIN_VALUE);
        ...
        this.loggerClassName = new StringConnectionProperty("logger", ConnectionPropertiesImpl.STANDARD_LOGGER_NAME, Messages.getString("ConnectionProperties.logger", new Object[] { ((ConnectionPropertiesImpl.class$com$mysql$jdbc$log$Log == null) ? (ConnectionPropertiesImpl.class$com$mysql$jdbc$log$Log = class$("com.mysql.jdbc.log.Log")) : ConnectionPropertiesImpl.class$com$mysql$jdbc$log$Log).getName(), ConnectionPropertiesImpl.STANDARD_LOGGER_NAME }), "3.1.1", ConnectionPropertiesImpl.DEBUGING_PROFILING_CATEGORY, 0);
        ...
        this.socketFactoryClassName = new StringConnectionProperty("socketFactory", ((ConnectionPropertiesImpl.class$com$mysql$jdbc$StandardSocketFactory == null) ? (ConnectionPropertiesImpl.class$com$mysql$jdbc$StandardSocketFactory = class$("com.mysql.jdbc.StandardSocketFactory")) : ConnectionPropertiesImpl.class$com$mysql$jdbc$StandardSocketFactory).getName(), Messages.getString("ConnectionProperties.socketFactory"), "3.0.3", ConnectionPropertiesImpl.CONNECTION_AND_AUTH_CATEGORY, 4);
        ...
        this.clientCertificateKeyStoreType = new StringConnectionProperty("clientCertificateKeyStoreType", null, Messages.getString("ConnectionProperties.clientCertificateKeyStoreType"), "5.1.0", ConnectionPropertiesImpl.SECURITY_CATEGORY, 6);
        ...
        this.trustCertificateKeyStoreType = new StringConnectionProperty("trustCertificateKeyStoreType", null, Messages.getString("ConnectionProperties.trustCertificateKeyStoreType"), "5.1.0", ConnectionPropertiesImpl.SECURITY_CATEGORY, 9);
    ...
    static {
        ...
        STANDARD_LOGGER_NAME = ((ConnectionPropertiesImpl.class$com$mysql$jdbc$log$StandardLogger == null) ? (ConnectionPropertiesImpl.class$com$mysql$jdbc$log$StandardLogger = class$("com.mysql.jdbc.log.StandardLogger")) : ConnectionPropertiesImpl.class$com$mysql$jdbc$log$StandardLogger).getName();
        try {
            final Field[] declaredFields = ((ConnectionPropertiesImpl.class$com$mysql$jdbc$ConnectionPropertiesImpl == null) ? (ConnectionPropertiesImpl.class$com$mysql$jdbc$ConnectionPropertiesImpl = class$("com.mysql.jdbc.ConnectionPropertiesImpl")) : ConnectionPropertiesImpl.class$com$mysql$jdbc$ConnectionPropertiesImpl).getDeclaredFields();
            for (int i = 0; i < declaredFields.length; ++i) {
                if (((ConnectionPropertiesImpl.class$com$mysql$jdbc$ConnectionPropertiesImpl$ConnectionProperty == null) ? (ConnectionPropertiesImpl.class$com$mysql$jdbc$ConnectionPropertiesImpl$ConnectionProperty = class$("com.mysql.jdbc.ConnectionPropertiesImpl$ConnectionProperty")) : ConnectionPropertiesImpl.class$com$mysql$jdbc$ConnectionPropertiesImpl$ConnectionProperty).isAssignableFrom(declaredFields[i].getType())) {
    ...
    class IntegerConnectionProperty extends ConnectionProperty implements Serializable
    {
        ...
        IntegerConnectionProperty(final ConnectionPropertiesImpl this$0, final String propertyNameToSet, final int defaultValueToSet, final String descriptionToSet, final String sinceVersionToSet, final String category, final int orderInCategory) {
            this(this$0, propertyNameToSet, defaultValueToSet, 0, 0, descriptionToSet, sinceVersionToSet, category, orderInCategory);
        }
    ...
    public class LongConnectionProperty extends IntegerConnectionProperty
    {
        ...
        LongConnectionProperty(final ConnectionPropertiesImpl this$0, final String propertyNameToSet, final long defaultValueToSet, final String descriptionToSet, final String sinceVersionToSet, final String category, final int orderInCategory) {
            this(this$0, propertyNameToSet, defaultValueToSet, 0L, 0L, descriptionToSet, sinceVersionToSet, category, orderInCategory);
        }
    ...
    class StringConnectionProperty extends ConnectionProperty implements Serializable
    {
        ...
        StringConnectionProperty(final ConnectionPropertiesImpl this$0, final String propertyNameToSet, final String defaultValueToSet, final String descriptionToSet, final String sinceVersionToSet, final String category, final int orderInCategory) {
            this(this$0, propertyNameToSet, defaultValueToSet, null, descriptionToSet, sinceVersionToSet, category, orderInCategory);
        }
