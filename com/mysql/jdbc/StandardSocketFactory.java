...
public class StandardSocketFactory implements SocketFactory
{
        ...
        if (props != null) {
            ...
            if (wantsTimeout || wantsLocalBind || needsConfigurationBeforeConnect) {
                ...
                try {
                    ...
                    connectWithTimeoutMethod = ((StandardSocketFactory.class$java$net$Socket == null) ? (StandardSocketFactory.class$java$net$Socket = class$("java.net.Socket")) : StandardSocketFactory.class$java$net$Socket).getMethod("connect", socketAddressClass, Integer.TYPE);
                    socketBindMethod = ((StandardSocketFactory.class$java$net$Socket == null) ? (StandardSocketFactory.class$java$net$Socket = class$("java.net.Socket")) : StandardSocketFactory.class$java$net$Socket).getMethod("bind", socketAddressClass);
                }
                ...
                if (!wantsLocalBind && !wantsTimeout && !needsConfigurationBeforeConnect) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            addrConstructor = inetSocketAddressClass.getConstructor((StandardSocketFactory.class$java$net$InetAddress == null) ? (StandardSocketFactory.class$java$net$InetAddress = class$("java.net.InetAddress")) : StandardSocketFactory.class$java$net$InetAddress, Integer.TYPE);
                            if (wantsLocalBind) {
    ...
    static {
        try {
            StandardSocketFactory.setTraficClassMethod = ((StandardSocketFactory.class$java$net$Socket == null) ? (StandardSocketFactory.class$java$net$Socket = class$("java.net.Socket")) : StandardSocketFactory.class$java$net$Socket).getMethod("setTrafficClass", Integer.TYPE);
        }
