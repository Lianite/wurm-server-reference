...
public class StringUtils
{
    ...
    public static final byte[] getBytes(final char[] c, final String encoding, final String serverEncoding, final boolean parserKnowsUnicode, final ConnectionImpl conn, final ExceptionInterceptor exceptionInterceptor) throws SQLException {
        try {
    ...
    public static final byte[] getBytes(final String s, final String encoding, final String serverEncoding, final boolean parserKnowsUnicode, final ConnectionImpl conn, final ExceptionInterceptor exceptionInterceptor) throws SQLException {
        try {
            SingleByteCharsetConverter converter = null;
            if (conn != null) {
                converter = conn.getCharsetConverter(encoding);
    ...
    public static final List split(final String stringToSplit, final String delimiter, final String markers, final String markerCloses, final boolean trim) {
        if (stringToSplit == null) {
            return new ArrayList();
        }
        if (delimiter == null) {
        ...
        int delimPos = 0;
        int currentPos = 0;
        final List splitTokens = new ArrayList();
    ...
    static byte[] s2b(final String s, final ConnectionImpl conn) throws SQLException {
        if (s == null) {
            return null;
        }
    ...
    static {
        ...
        try {
            StringUtils.toPlainStringMethod = ((StringUtils.class$java$math$BigDecimal == null) ? (StringUtils.class$java$math$BigDecimal = class$("java.math.BigDecimal")) : StringUtils.class$java$math$BigDecimal).getMethod("toPlainString", (Class[])new Class[0]);
        }
