...
public abstract class ResultSetRow
{
    ...
    protected final Date getDateFast(final int columnIndex, final byte[] dateAsBytes, final int offset, final int length, final ConnectionImpl conn, final ResultSetImpl rs, final Calendar targetCalendar) throws SQLException {
        int year = 0;
        int month = 0;
        int day = 0;
        try {
    ...
    public abstract Date getDateFast(final int p0, final ConnectionImpl p1, final ResultSetImpl p2, final Calendar p3) throws SQLException;
    
    public abstract int getInt(final int p0) throws SQLException;
    
    public abstract long getLong(final int p0) throws SQLException;
    
    protected Date getNativeDate(final int columnIndex, final byte[] bits, final int offset, final int length, final ConnectionImpl conn, final ResultSetImpl rs, final Calendar cal) throws SQLException {
        int year = 0;
        int month = 0;
        int day = 0;
        if (length != 0) {
    ...
    public abstract Date getNativeDate(final int p0, final ConnectionImpl p1, final ResultSetImpl p2, final Calendar p3) throws SQLException;
    
    protected Object getNativeDateTimeValue(final int columnIndex, final byte[] bits, final int offset, final int length, final Calendar targetCalendar, final int jdbcType, final int mysqlType, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        int year = 0;
        int month = 0;
        int day = 0;
        int hour = 0;
    ...
    public abstract Object getNativeDateTimeValue(final int p0, final Calendar p1, final int p2, final int p3, final TimeZone p4, final boolean p5, final ConnectionImpl p6, final ResultSetImpl p7) throws SQLException;
    ...
    protected Time getNativeTime(final int columnIndex, final byte[] bits, final int offset, final int length, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        int hour = 0;
        int minute = 0;
        int seconds = 0;
        if (length != 0) {
    ...
    public abstract Time getNativeTime(final int p0, final Calendar p1, final TimeZone p2, final boolean p3, final ConnectionImpl p4, final ResultSetImpl p5) throws SQLException;
    
    protected Timestamp getNativeTimestamp(final byte[] bits, final int offset, final int length, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        int year = 0;
        int month = 0;
        int day = 0;
        int hour = 0;
    ...
    public abstract Timestamp getNativeTimestamp(final int p0, final Calendar p1, final TimeZone p2, final boolean p3, final ConnectionImpl p4, final ResultSetImpl p5) throws SQLException;
    
    public abstract Reader getReader(final int p0) throws SQLException;
    
    public abstract String getString(final int p0, final String p1, final ConnectionImpl p2) throws SQLException;
    
    protected String getString(final String encoding, final ConnectionImpl conn, final byte[] value, final int offset, final int length) throws SQLException {
    ...
    protected Time getTimeFast(final int columnIndex, final byte[] timeAsBytes, final int offset, final int length, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        int hr = 0;
        int min = 0;
        int sec = 0;
        try {
    ...
    public abstract Time getTimeFast(final int p0, final Calendar p1, final TimeZone p2, final boolean p3, final ConnectionImpl p4, final ResultSetImpl p5) throws SQLException;
    
    protected Timestamp getTimestampFast(final int columnIndex, final byte[] timestampAsBytes, final int offset, int length, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        try {
            final Calendar sessionCalendar = conn.getUseJDBCCompliantTimezoneShift() ? conn.getUtcCalendar() : rs.getCalendarInstanceForSessionOrNew();
            synchronized (sessionCalendar) {
    ...
    public abstract Timestamp getTimestampFast(final int p0, final Calendar p1, final TimeZone p2, final boolean p3, final ConnectionImpl p4, final ResultSetImpl p5) throws SQLException;
