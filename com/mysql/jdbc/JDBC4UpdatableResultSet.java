...
{
    public JDBC4UpdatableResultSet(final String catalog, final Field[] fields, final RowData tuples, final ConnectionImpl conn, final StatementImpl creatorStmt) throws SQLException {
    ...
    public synchronized void updateNString(final int columnIndex, final String x) throws SQLException {
        ...
        if (!this.onInsertRow) {
            ...
            if (x == null) {
                ...
                this.thisRow.setColumnValue(columnIndex - 1, StringUtils.getBytes(x, this.charConverter, fieldEncoding, this.connection.getServerCharacterEncoding(), this.connection.parserKnowsUnicode(), this.getExceptionInterceptor()));
            }
        }
    }
