...
public class BufferRow extends ResultSetRow
{
    ...
    public Timestamp getNativeTimestamp(final int columnIndex, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public String getString(final int columnIndex, final String encoding, final ConnectionImpl conn) throws SQLException {
        if (this.isBinaryEncoded && this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public Time getTimeFast(final int columnIndex, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public Timestamp getTimestampFast(final int columnIndex, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public Date getDateFast(final int columnIndex, final ConnectionImpl conn, final ResultSetImpl rs, final Calendar targetCalendar) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public Date getNativeDate(final int columnIndex, final ConnectionImpl conn, final ResultSetImpl rs, final Calendar cal) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public Object getNativeDateTimeValue(final int columnIndex, final Calendar targetCalendar, final int jdbcType, final int mysqlType, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
    ...
    public Time getNativeTime(final int columnIndex, final Calendar targetCalendar, final TimeZone tz, final boolean rollForward, final ConnectionImpl conn, final ResultSetImpl rs) throws SQLException {
        if (this.isNull(columnIndex)) {
            return null;
        }
        this.findAndSeekToOffset(columnIndex);
