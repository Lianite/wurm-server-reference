...
public class ResultSetImpl implements ResultSetInternalMethods
{
    ...
    static /* synthetic */ Class class$com$mysql$jdbc$StatementImpl;
    static /* synthetic */ Class class$java$lang$String;
    static /* synthetic */ Class array$Lcom$mysql$jdbc$Field;
    static /* synthetic */ Class class$com$mysql$jdbc$RowData;
    ...
    protected static ResultSetImpl getInstance(final long updateCount, final long updateID, final ConnectionImpl conn, final StatementImpl creatorStmt) throws SQLException {
        if (!Util.isJdbc4()) {
    ...
    protected static ResultSetImpl getInstance(final String catalog, final Field[] fields, final RowData tuples, final ConnectionImpl conn, final StatementImpl creatorStmt, final boolean isUpdatable) throws SQLException {
        if (!Util.isJdbc4()) {
            if (!isUpdatable) {
    ...
    public ResultSetImpl(final long updateCount, final long updateID, final ConnectionImpl conn, final StatementImpl creatorStmt) {
        this.catalog = null;
    ...
    public ResultSetImpl(final String catalog, final Field[] fields, final RowData tuples, final ConnectionImpl conn, final StatementImpl creatorStmt) throws SQLException {
        this.catalog = null;
        this.columnLabelToIndex = null;
        this.columnToIndexCache = null;
        this.columnUsed = null;
    ...
    private String getNativeConvertToString(final int columnIndex, final Field field) throws SQLException {
        ...
        switch (sqlType) {
            ...
            case 3: {
                ...
                this.wasNullFlag = false;
                if (stringVal.length() == 0) {
                    final BigDecimal val = new BigDecimal(0.0);
                    return val.toString();
                }
                BigDecimal val;
                try {
    ...
    static {
        Label_0411: {
            if (Util.isJdbc4()) {
                try {
                    JDBC_4_RS_4_ARG_CTOR = Class.forName("com.mysql.jdbc.JDBC4ResultSet").getConstructor(Long.TYPE, Long.TYPE, (ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl == null) ? (ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl, (ResultSetImpl.class$com$mysql$jdbc$StatementImpl == null) ? (ResultSetImpl.class$com$mysql$jdbc$StatementImpl = class$("com.mysql.jdbc.StatementImpl")) : ResultSetImpl.class$com$mysql$jdbc$StatementImpl);
                    JDBC_4_RS_6_ARG_CTOR = Class.forName("com.mysql.jdbc.JDBC4ResultSet").getConstructor((ResultSetImpl.class$java$lang$String == null) ? (ResultSetImpl.class$java$lang$String = class$("java.lang.String")) : ResultSetImpl.class$java$lang$String, (ResultSetImpl.array$Lcom$mysql$jdbc$Field == null) ? (ResultSetImpl.array$Lcom$mysql$jdbc$Field = class$("[Lcom.mysql.jdbc.Field;")) : ResultSetImpl.array$Lcom$mysql$jdbc$Field, (ResultSetImpl.class$com$mysql$jdbc$RowData == null) ? (ResultSetImpl.class$com$mysql$jdbc$RowData = class$("com.mysql.jdbc.RowData")) : ResultSetImpl.class$com$mysql$jdbc$RowData, (ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl == null) ? (ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl, (ResultSetImpl.class$com$mysql$jdbc$StatementImpl == null) ? (ResultSetImpl.class$com$mysql$jdbc$StatementImpl = class$("com.mysql.jdbc.StatementImpl")) : ResultSetImpl.class$com$mysql$jdbc$StatementImpl);
                    JDBC_4_UPD_RS_6_ARG_CTOR = Class.forName("com.mysql.jdbc.JDBC4UpdatableResultSet").getConstructor((ResultSetImpl.class$java$lang$String == null) ? (ResultSetImpl.class$java$lang$String = class$("java.lang.String")) : ResultSetImpl.class$java$lang$String, (ResultSetImpl.array$Lcom$mysql$jdbc$Field == null) ? (ResultSetImpl.array$Lcom$mysql$jdbc$Field = class$("[Lcom.mysql.jdbc.Field;")) : ResultSetImpl.array$Lcom$mysql$jdbc$Field, (ResultSetImpl.class$com$mysql$jdbc$RowData == null) ? (ResultSetImpl.class$com$mysql$jdbc$RowData = class$("com.mysql.jdbc.RowData")) : ResultSetImpl.class$com$mysql$jdbc$RowData, (ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl == null) ? (ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl = class$("com.mysql.jdbc.ConnectionImpl")) : ResultSetImpl.class$com$mysql$jdbc$ConnectionImpl, (ResultSetImpl.class$com$mysql$jdbc$StatementImpl == null) ? (ResultSetImpl.class$com$mysql$jdbc$StatementImpl = class$("com.mysql.jdbc.StatementImpl")) : ResultSetImpl.class$com$mysql$jdbc$StatementImpl);
                    break Label_0411;
                }
