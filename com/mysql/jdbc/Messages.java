...
public class Messages
{
    ...
    static {
        ...
        try {
            temp = ResourceBundle.getBundle("com.mysql.jdbc.LocalizedErrorMessages", Locale.getDefault(), ((Messages.class$com$mysql$jdbc$Messages == null) ? (Messages.class$com$mysql$jdbc$Messages = class$("com.mysql.jdbc.Messages")) : Messages.class$com$mysql$jdbc$Messages).getClassLoader());
        }
        catch (Throwable t) {
            try {
