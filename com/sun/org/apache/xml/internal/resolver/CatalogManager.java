...
public class CatalogManager
{
    ...
    private int queryVerbosity() {
        ...
        String verbStr = System.getProperty(CatalogManager.pVerbosity);
        if (verbStr == null) {
    ...
    private String queryCatalogFiles() {
        String catalogList = System.getProperty(CatalogManager.pFiles);
        this.fromPropertiesFile = false;
        if (catalogList == null) {
            if (this.resources == null) {
                this.readProperties();
    ...
    private boolean queryPreferPublic() {
        String prefer = System.getProperty(CatalogManager.pPrefer);
        if (prefer == null) {
            if (this.resources == null) {
                this.readProperties();
            }
    ...
    private boolean queryUseStaticCatalog() {
        String staticCatalog = System.getProperty(CatalogManager.pStatic);
    ...
    public Catalog getPrivateCatalog() {
        ...
        try {
            ...
            if (catalogClassName == null) {
                ...
                catch (ClassCastException cnfe2) {
    ...
    public boolean queryAllowOasisXMLCatalogPI() {
        String allow = System.getProperty(CatalogManager.pAllowPI);
        if (allow == null) {
            if (this.resources == null) {
                this.readProperties();
            }
    ...
    public String queryCatalogClassName() {
        final String className = System.getProperty(CatalogManager.pClassname);
        if (className == null) {
            if (this.resources == null) {
                this.readProperties();
            }
