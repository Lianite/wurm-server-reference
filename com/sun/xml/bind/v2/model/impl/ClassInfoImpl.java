...
class ClassInfoImpl<T, C, F, M> extends TypeInfoImpl<T, C, F, M> implements ClassInfo<T, C>, Element<T, C>
{
    ...
    private void findFieldProperties(final C c, final XmlAccessType at) {
        ...
        for (final F f : this.nav().getDeclaredFields(c)) {
            ...
            if (this.nav().isTransient(f)) {
                ...
                this.addProperty(this.createFieldSeed(f), annotations);
            }
            else {
    ...
    private void checkConflict(final Annotation a, final Annotation b) throws DupliateException {
        assert b != null;
        if (a != null) {
    ...
    private void addProperty(final PropertySeed<T, C, F, M> seed, final Annotation[] annotations) {
        XmlTransient t = null;
        ...
        for (final String name : complete) {
            ...
            if ((at == XmlAccessType.PROPERTY && !isOverriding) || (at == XmlAccessType.PUBLIC_MEMBER && this.isConsideredPublic(getter) && this.isConsideredPublic(setter) && !isOverriding) || hasAnnotation) {
                if (getter != null && setter != null && !this.nav().getReturnType(getter).equals(this.nav().getMethodParameters(setter)[0])) {
                    ...
                    this.addProperty(this.createAccessorSeed(getter, setter), r);
                }
            }
        }
    ...
    static {
        ...
        final Class[] annotations = { XmlTransient.class, XmlAnyAttribute.class, XmlAttribute.class, XmlValue.class, XmlElement.class, XmlElements.class, XmlElementRef.class, XmlElementRefs.class, XmlAnyElement.class, XmlMixed.class };
    ...
    private static final class DupliateException extends Exception
    {
        ...
        public DupliateException(final Annotation a1, final Annotation a2) {
            this.a1 = a1;
            this.a2 = a2;
        }
    }
