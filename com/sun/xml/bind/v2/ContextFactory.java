...
public class ContextFactory
{
    ...
    public static JAXBContext createContext(final Class[] classes, Map<String, Object> properties) throws JAXBException {
        ...
        return createContext(classes, (Collection<TypeReference>)Collections.emptyList(), subclassReplacements, defaultNsUri, c14nSupport, ar, xmlAccessorFactorySupport, allNillable);
    }
