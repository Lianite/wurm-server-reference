    ...
    public void beginStartTag(final Name name) throws IOException {
        ...
        if (this.nsContext.getCurrent().count() == 0) {
            ...
            if (qNameIndex >= 0) {
                ...
                final int prefix = this.nsUriIndex2prefixIndex[name.nsUriIndex];
                this.writeLiteral(60, name, this.nsContext.getPrefix(prefix), this.nsContext.getNamespaceURI(prefix));
            }
        }
        else {
