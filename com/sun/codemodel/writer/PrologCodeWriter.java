...
public class PrologCodeWriter implements CodeWriter
{
    ...
    public PrologCodeWriter(final CodeWriter core, final String prolog) throws IOException {
        // 
        ...
        //  -----  ------  ----  ------  -------------------------------------------
        //  0      15      0     this    Lcom/sun/codemodel/writer/PrologCodeWriter;
        //  0      15      1     core    Lcom/sun/codemodel/CodeWriter;
    ...
    public OutputStream open(final JPackage pkg, final String fileName) throws IOException {
        ...
        // The error that occurred was:
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'com/sun/codemodel/writer/PrologCodeWriter.open:(Lcom/sun/codemodel/JPackage;Ljava/lang/String;)Ljava/io/OutputStream;'.
        ...
        //     at com.strobel.decompiler.DecompilerDriver.decompileJar(DecompilerDriver.java:238)
        //     at com.strobel.decompiler.DecompilerDriver.main(DecompilerDriver.java:123)
        // Caused by: java.lang.IndexOutOfBoundsException: No instruction found at offset -55.
