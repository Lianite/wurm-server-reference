...
{
    public static WhitespaceNormalizer PRESERVE;
    public static WhitespaceNormalizer REPLACE;
    public static WhitespaceNormalizer COLLAPSE;
    ...
    public abstract JExpression generate(final JCodeModel p0, final JExpression p1);
    
    public static WhitespaceNormalizer parse(final String method) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
