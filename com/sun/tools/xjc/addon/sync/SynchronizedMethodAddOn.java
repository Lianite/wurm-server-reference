...
public class SynchronizedMethodAddOn implements CodeAugmenter
{
    public SynchronizedMethodAddOn() {
        ...
        //  -----  ------  ----  ----  ------------------------------------------------------
        //  0      5       0     this  Lcom/sun/tools/xjc/addon/sync/SynchronizedMethodAddOn;
        // 
    ...
    public String getOptionName() {
        ...
        //  Start  Length  Slot  Name  Signature
        //  -----  ------  ----  ----  ------------------------------------------------------
        //  0      3       0     this  Lcom/sun/tools/xjc/addon/sync/SynchronizedMethodAddOn;
        // 
        // The error that occurred was:
        // 
    ...
    public String getUsage() {
        ...
        // The error that occurred was:
        // 
        // com.strobel.assembler.metadata.MethodBodyParseException: An error occurred while parsing the bytecode of method 'com/sun/tools/xjc/addon/sync/SynchronizedMethodAddOn.getUsage:()Ljava/lang/String;'.
    ...
    public int parseArgument(final Options opt, final String[] args, final int i) throws BadCommandLineException, IOException {
        ...
        //  Start  Length  Slot  Name  Signature
        //  -----  ------  ----  ----  ------------------------------------------------------
        //  0      2       0     this  Lcom/sun/tools/xjc/addon/sync/SynchronizedMethodAddOn;
        //  0      2       1     opt   Lcom/sun/tools/xjc/Options;
    ...
    private void augument(final ClassContext cc) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
