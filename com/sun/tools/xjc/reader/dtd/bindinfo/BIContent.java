...
public abstract class BIContent
{
    ...
    private BIContent(final Element e, final BIElement _parent) {
        // 
    ...
    public final Expression wrap(final Expression exp) throws BIContent.MismatchException {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    protected abstract boolean checkMatch(final Expression p0);
    
    static BIContent create(final Element e, final BIElement _parent) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
