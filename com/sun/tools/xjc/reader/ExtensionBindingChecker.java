...
public class ExtensionBindingChecker extends XMLFilterImpl
{
    ...
    private int count;
    private final Set enabledExtensions;
    ...
    public ExtensionBindingChecker(final String schemaLanguage, final ErrorHandler handler) {
        // 
    ...
    protected boolean isSupportedExtension(final String namespaceUri) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    private SAXParseException error(final String msg) throws SAXException {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
