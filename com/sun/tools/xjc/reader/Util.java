...
public class Util
{
    ...
    public static InputSource getInputSource(final String fileOrURL) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    public static String getPackageNameFromNamespaceURI(final String nsUri, final NameConverter nameConv) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    private static ArrayList tokenize(final String str, final String sep) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    private static ArrayList reverse(final List a) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
