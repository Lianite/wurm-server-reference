...
class idSymbolSpace extends NGCCHandler
{
    private String name;
    ...
    public idSymbolSpace(final NGCCHandler parent, final NGCCEventSource source, final NGCCRuntimeEx runtime, final int cookie) {
        super(source, parent, cookie);
        this.$runtime = runtime;
        this.$_ngcc_current_state = 5;
    }
    
    public idSymbolSpace(final NGCCRuntimeEx runtime) {
    ...
    private BIXIdSymbolSpace makeResult() {
        return new BIXIdSymbolSpace(this.loc, this.name);
    }
}
