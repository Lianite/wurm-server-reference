...
public final class Vector3f implements Externalizable, Cloneable
{
    ...
    public void scaleAdd(final float scalar, final Vector3f add) {
        this.x = this.x * scalar + add.x;
        this.y = this.y * scalar + add.y;
        this.z = this.z * scalar + add.z;
    }
    
    public void scaleAdd(final float scalar, final Vector3f mult, final Vector3f add) {
    ...
    public void interpolate(final Vector3f finalVec, final float changeAmnt) {
    ...
    public void interpolate(final Vector3f beginVec, final Vector3f finalVec, final float changeAmnt) {
