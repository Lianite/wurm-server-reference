...
public final class Tiles implements CounterTypes
{
    ...
    public static Tile getTile(final int id) {
        if (Tiles.tiles[id & 0xFF] == null) {
            final int length = Tile.values().length;
        }
    ...
    public static TileBorderDirection decodeDirection(final long clientWurmId) {
        final byte code = (byte)(clientWurmId >> 8 & 0xFL);
        if (code == 0) {
    ...
    public static byte decodeLayer(final long clientWurmId) {
        final byte code = (byte)(clientWurmId >> 12 & 0xFL);
        if (code == 0) {
            return 0;
        }
        return -1;
    ...
    public static boolean isReinforcedCaveWall(final byte _id) {
        boolean toReturn = false;
        switch (_id & 0xFF) {
            case 203:
            case 231:
    ...
    public static boolean isSolidCave(final Tile theTile) {
    ...
    public static boolean isReinforcedFloor(final byte _id) {
        switch (_id & 0xFF) {
            case 207:
            case 246: {
                return true;
    ...
    public static boolean isTundra(final int tileId) {
        switch (tileId & 0xFF) {
            case 19:
            case 172: {
                return true;
    ...
    public static long getBorderObjectId(final int x, final int y, final int heightOffset, final byte layer, final int dir, final byte type) {
        final int layerBit = (layer == 0) ? 0 : 128;
        return (heightOffset << 48) + (x << 32) + (y << 16) + (layerBit + dir << 8) + (type & 0xFF);
    }
    
    public static long getBorderId(final int x, final int y, final int heightOffset, final byte layer, final int dir) {
        return getBorderObjectId(x, y, heightOffset, layer, dir, (byte)12);
    }
    
    public static long getHouseWallId(final int x, final int y, final int heightOffset, final byte layer, final byte dir) {
        return getBorderObjectId(x, y, heightOffset, layer, dir, (byte)5);
    }
    
    public static long getFenceId(final int x, final int y, final int heightOffset, final byte layer, final byte dir) {
        return getBorderObjectId(x, y, heightOffset, layer, dir, (byte)7);
    }
    
    public static long getFloorId(final int x, final int y, final int heightOffset, final byte layer) {
        return getBorderObjectId(x, y, heightOffset, layer, 0, (byte)23);
    }
    
    public static long getTileCornerId(final int x, final int y, final int heightOffset, final byte layer) {
        return getBorderObjectId(x, y, heightOffset, layer, TileBorderDirection.CORNER.getCode(), (byte)27);
    }
    
    public static long getBridgePartId(final int x, final int y, final int realHeight, final byte layer, final byte dir) {
    ...
    public enum Tile
    {
        TILE_HOLE(0, "Hole", "#000000", 1.0f, "img.texture.terrain.hole", new Flag[] { Flag.ALIGNED }, 60, (byte)3, (byte)2, (byte)2), 
        ...
        private Tile(final int id, final String name, final String color, final float speed, final String textureResource, final Flag[] flags, final int iconId, final byte waterInfiltration, final byte waterReservoir, final byte waterLeakage) {
            this(id, name, name, color, speed, textureResource, flags, iconId, waterInfiltration, waterReservoir, waterLeakage);
        }
        
        private Tile(final int id, final String name, final String uniqueName, final String color, final float speed, final String textureResource, final Flag[] flags, final int iconId, final byte waterInfiltration, final byte waterReservoir, final byte waterLeakage) {
            this.materialId = -1;
            this.aligned = false;
        ...
        public static Tile[] getTiles(final int category, final String filter) {
            final Set<Tile> catTiles = new HashSet<Tile>();
            for (final Tile tile : Tiles.tiles) {
                if (tile != null && tile.direction == TileRoadDirection.DIR_STRAIGHT) {
                    switch (category) {
                        ...
                        case 4: {
                            if (!tile.isCave() && !tile.isTree() && !tile.isBush() && !tile.isRoad() && !tile.isCaveDoor() && wildCardMatch(tile.getName().toLowerCase(), filter.toLowerCase())) {
                                catTiles.add(tile);
                                break;
                            }
                            break;
        ...
        public int getTexturePosX(final byte data) {
            if (this.isTree()) {
        ...
        public int getTexturePosY(final byte data) {
            if (this.isTree()) {
        ...
        public float getTreeImageWidth(final byte data) {
            if (this.isTree()) {
        ...
        public float getTreeImageHeight(final byte data) {
            if (this.isTree()) {
        ...
        public float getTreeBaseRadius(final byte data) {
            if (this.isTree()) {
        ...
        public String getModelResourceName(final byte data) {
    ...
    public enum TileBorderDirection
    {
        ...
        private TileBorderDirection(final byte newId) {
            this.id = newId;
        }
    ...
    public enum TileRoadDirection
    {
        ...
        private TileRoadDirection(final byte newId) {
            this.id = newId;
        }
