...
public enum FoliageAge
{
    ...
    private FoliageAge(final int id, final String name, final int prunedAge, final boolean isPrunable) {
    ...
    public static FoliageAge fromByte(final byte i) {
        return FoliageAge.ages[i];
    }
    
    public static FoliageAge getFoliageAge(final byte tileData) {
        return fromByte(getAgeAsByte(tileData));
    }
    
    public static byte getAgeAsByte(final byte tileData) {
