...
public enum StructureMaterialEnum
{
    ...
    private StructureMaterialEnum(final byte _material, final String _nameString) {
        this.material = _material;
        this.nameString = _nameString;
    }
    
    public static StructureMaterialEnum getEnumByMaterial(final byte material) {
        ...
        return StructureMaterialEnum.WOOD;
    }
}
