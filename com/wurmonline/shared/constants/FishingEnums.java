...
public class FishingEnums
{
    ...
    public enum FishType
    {
        ...
        private FishType(final byte typeId, final String modelName) {
            this.typeId = typeId;
        ...
        public static final int getLength() {
            return FishType.types.length;
        }
        
        public static FishType fromInt(final int id) {
            if (id >= getLength()) {
                return FishType.types[0];
            }
            return FishType.types[id & 0xFF];
        }
        
        public String getModelName(final byte id) {
    ...
    public enum RodType
    {
        ...
        private RodType(final byte id, final String modelName, final short icon) {
            this.typeId = id;
            this.modelName = modelName;
            this.icon = icon;
        }
        ...
        public static final int getLength() {
            return RodType.types.length;
        }
        
        public static RodType fromInt(final int id) {
            if (id >= getLength()) {
                return RodType.types[0];
            }
            return RodType.types[id & 0xFF];
        }
    ...
    public enum FloatType
    {
        ...
        private FloatType(final byte id, final String modelName) {
            this.typeId = id;
            this.modelName = modelName;
        }
    ...
    public enum BaitType
    {
        ...
        private BaitType(final byte id, final String modelName) {
            this.typeId = id;
            this.modelName = modelName;
        }
    ...
    public enum ReelType
    {
        ...
        private ReelType(final byte id, final String modelName) {
            this.typeId = id;
            this.modelName = modelName;
        }
    ...
    public enum HookType
    {
        ...
        private HookType(final byte id, final String modelName) {
            this.typeId = id;
            this.modelName = modelName;
        }
