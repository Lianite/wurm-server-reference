...
public final class SpellEffectConstants
{
    ...
    public static final String getTypeName(final byte type) {
        switch (type) {
            case 0: {
                return "General";
            }
    ...
    public static final String getInfluenceName(final byte influence) {
        switch (influence) {
            case 0: {
                return "Beneficial";
            }
    ...
    public static final String getInfluenceSymbol(final byte influence) {
        switch (influence) {
            case 0: {
                return "+";
            }
    ...
    public static final boolean isTimed(final int duration) {
        return duration != 0;
    }
}
