...
public final class IconConstants
{
    ...
    public static final String[] ICON_SHEET_FILE_NAMES;
    ...
    public static int getRecipeIconFromName(final String iconName) {
        switch (iconName) {
            case "baked apple": {
                return 1445;
            }
    ...
    static {
        ICON_SHEET_FILE_NAMES = new String[] { "img.iconsheet.icons", "img.iconsheet.misc", "img.iconsheet.resource", "img.iconsheet.tools", "img.iconsheet.armor", "img.iconsheet.weapons", "img.iconsheet.resource2" };
    }
}
