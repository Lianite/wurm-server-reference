...
public enum StructureConstantsEnum
{
    ...
    FENCE_PLAN_ROUNDED_STONE_IRON_GATE((short)(-87), BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_GATE, StructureMaterialEnum.ROUNDED_STONE), 
    ...
    FENCE_ROUNDED_STONE_HIGH_IRON_FENCE_GATE((short)138, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_IRON_BARS_TALL_GATE, StructureMaterialEnum.ROUNDED_STONE), 
    ...
    FENCE_PLAN_SLATE_HIGH_IRON_FENCE_GATE((short)168, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL_GATE, StructureMaterialEnum.SLATE), 
    ...
    FENCE_PLAN_ROUNDED_STONE_TALL_STONE_WALL((short)171, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_STONEWALL_HIGH, StructureMaterialEnum.ROUNDED_STONE), 
    ...
    FENCE_PLAN_ROUNDED_STONE_HIGH_IRON_FENCE((short)173, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL, StructureMaterialEnum.ROUNDED_STONE), 
    FENCE_PLAN_ROUNDED_STONE_HIGH_IRON_FENCE_GATE((short)174, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL_GATE, StructureMaterialEnum.ROUNDED_STONE), 
    ...
    FENCE_PLAN_SANDSTONE_HIGH_IRON_FENCE_GATE((short)180, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL_GATE, StructureMaterialEnum.SANDSTONE), 
    ...
    FENCE_PLAN_RENDERED_HIGH_IRON_FENCE_GATE((short)186, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL_GATE, StructureMaterialEnum.RENDERED), 
    ...
    FENCE_PLAN_POTTERY_HIGH_IRON_FENCE_GATE((short)192, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL_GATE, StructureMaterialEnum.POTTERY), 
    ...
    FENCE_PLAN_MARBLE_HIGH_IRON_FENCE_GATE((short)198, BuildingTypesEnum.ALLFENCES, StructureTypeEnum.FENCE_PLAN_IRON_BARS_TALL_GATE, StructureMaterialEnum.MARBLE), 
    ...
    private final HashMap<String, StructureConstantsEnum> lookupMap;
    
    private StructureConstantsEnum(final short _value, final BuildingTypesEnum _structureType, final StructureTypeEnum _type, final StructureMaterialEnum _material) {
        this.modelPath = "";
        this.texturePath = "";
        this.icon = -1;
        this.lookupMap = new HashMap<String, StructureConstantsEnum>();
        this.value = _value;
    ...
    public static StructureConstantsEnum getEnumByINDEX(final short id) {
        if (id <= values().length && id >= 0) {
            return values()[id];
        }
        Logger.getGlobal().warning("Value not a valid id: " + id + " RETURNING WALL_WINDOW_STONE_PLAN(VAL=-31)!");
        return StructureConstantsEnum.WALL_WINDOW_STONE_PLAN;
    }
    
    public static StructureConstantsEnum getEnumByValue(final short value) {
        for (final StructureConstantsEnum e : values()) {
            if (e.value == value) {
                return e;
            }
        }
