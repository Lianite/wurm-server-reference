...
public enum StructureTypeEnum
{
    ...
    private StructureTypeEnum(final byte _value, final String _typeName, final String _modelShortName) {
        this.value = _value;
        this.typeName = _typeName;
        this.modelShortName = _modelShortName;
    }
    
    public static StructureTypeEnum getTypeByINDEX(final int id) {
        ...
        return StructureTypeEnum.PLAN;
    }
    
    public static Optional<StructureTypeEnum> lookup(final String name) {
        Optional<StructureTypeEnum> optional = Optional.empty();
        if (StructureTypeEnum.lookupMap == null) {
            StructureTypeEnum.lookupMap = new HashMap<String, StructureTypeEnum>();
            for (final StructureTypeEnum stt : values()) {
                StructureTypeEnum.lookupMap.put(stt.name(), stt);
            }
        }
        final StructureTypeEnum temp = StructureTypeEnum.lookupMap.get(name);
        if (temp != null) {
    ...
    static {
        StructureTypeEnum.lookupMap = null;
    }
}
