...
public final class WallConstants
{
    ...
    public static final short translateWallType(final StructureTypeEnum type, final String material) {
        final boolean isStone = "stone".equals(material);
        final boolean isPlainStone = "plain stone".equals(material);
        final boolean isTimber = "timber framed".equals(material);
        final boolean isSlate = "slate".equals(material);
        final boolean isRoundedStone = "rounded stone".equals(material);
        final boolean isPottery = "pottery".equals(material);
        final boolean isSandstone = "sandstone".equals(material);
        final boolean isRendered = "rendered".equals(material);
        final boolean isMarble = "marble".equals(material);
        switch (type) {
            case RUBBLE: {
    ...
    @Deprecated
    public static final short translateFenceType(final short id) {
        return id;
    }
    
    public static final String getModelName(final StructureConstantsEnum type, final byte damageState, final int pos) {
        return getModelName(type, damageState, pos, false);
    }
    
    public static final String getModelName(final StructureConstantsEnum type, final byte damageState, final int pos, final boolean initializing) {
        String modelName = null;
        if (!initializing) {
            modelName = type.getModelPath();
    ...
    public static final String getTextureName(final StructureConstantsEnum type) {
        return getTextureName(type, false);
    }
    
    public static final String getTextureName(final StructureConstantsEnum type, final boolean initializing) {
        if (!initializing) {
    ...
    public static final String getName(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_WOODEN: {
                return "Wooden fence";
            }
    ...
    public static final int getIconId(final StructureConstantsEnum type) {
        return getIconId(type, false);
    }
    
    public static final int getIconId(final StructureConstantsEnum type, final boolean initializing) {
        if (!initializing) {
    ...
    public static final float getCollisionWidth(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_WOODEN:
            case FENCE_WOODEN_CRUDE_GATE:
            case FENCE_WOODEN_GATE:
    ...
    public static final float getCollisionThickness(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_WOODEN:
            case FENCE_WOODEN_CRUDE:
            case FENCE_WOODEN_CRUDE_GATE:
    ...
    public static final float getOpening(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_WOODEN_CRUDE_GATE:
            case FENCE_WOODEN_GATE:
            case FENCE_PALISADE_GATE: {
    ...
    public static final boolean isGate(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_WOODEN_CRUDE_GATE:
            case FENCE_WOODEN_GATE:
            case FENCE_PALISADE_GATE:
    ...
    public static final float getCollisionHeight(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_PALISADE: {
                return 4.9f;
            }
    ...
    public static final boolean isBlocking(final StructureConstantsEnum type) {
        switch (type) {
            case FENCE_PLAN_WOODEN:
            case FENCE_PLAN_WOODEN_CRUDE:
            case FENCE_PLAN_WOODEN_GATE_CRUDE:
