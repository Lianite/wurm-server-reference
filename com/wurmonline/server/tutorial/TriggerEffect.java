...
public final class TriggerEffect implements CounterTypes, MiscConstants, Comparable<TriggerEffect>, TimeConstants
{
    ...
    private boolean destroysTarget;
    private boolean inActive;
    private boolean startSkillGain;
    private boolean stopSkillGain;
    ...
    private byte itemMaterial;
    private boolean newbieItem;
    private int modifyTileX;
    private int modifyTileY;
    private int newTileType;
    private byte newTileData;
    ...
    private int missionToDeActivate;
    private int triggerToActivate;
    private int triggerToDeActivate;
    private int effectToActivate;
    private int effectToDeActivate;
    private boolean destroyed;
    private int windowSizeX;
    private int windowSizeY;
    
    public TriggerEffect() {
        this.destroysTarget = false;
        this.inActive = false;
        this.startSkillGain = true;
        this.stopSkillGain = false;
        ...
        this.missionToActivate = 0;
        this.missionToDeActivate = 0;
        this.triggerToActivate = 0;
        this.triggerToDeActivate = 0;
        this.effectToActivate = 0;
        this.effectToDeActivate = 0;
    ...
    public void setMissionToActivate(final int val) {
    ...
    public void setMissionToDeActivate(final int val) {
    ...
    public void setTriggerToActivate(final int val) {
    ...
    public void setTriggerToDeActivate(final int val) {
    ...
    public void setEffectToActivate(final int val) {
    ...
    public void setEffectToDeActivate(final int val) {
    ...
    public void setTeleportY(final int val) {
        this.teleportY = val;
    }
    ...
    public void setTeleportX(final int val) {
        this.teleportX = val;
    }
    ...
    public void setTeleportLayer(final int val) {
    ...
    public void setWindowSizeX(final int val) {
    ...
    public void setWindowSizeY(final int val) {
    ...
    public void setCreatureAge(final int val) {
    ...
    public void setCreatureSpawn(final int val) {
    ...
    public void setCreatureType(final byte val) {
    ...
    public void setSpawnTileY(final int val) {
        this.spawnTileY = val;
    }
    ...
    public void setSpawnTileX(final int val) {
        this.spawnTileX = val;
    }
    ...
    public void setModifyTileY(final int val) {
    ...
    public void setNewTileType(final int val) {
        this.newTileType = val;
    }
    
    public void setModifyTileX(final int val) {
    ...
    public void setNewTileData(final byte tiledata) {
    ...
    public void setItemMaterial(final byte material) {
    ...
    public void setNewbieItem(final boolean newbie) {
    ...
    public void setStopSkillgain(final boolean stop) {
    ...
    public void setStartSkillgain(final boolean start) {
    ...
    public void setDestroyInventory(final boolean destroys) {
    ...
    public void setDestroysTarget(final boolean destroys) {
    ...
    public void setLastModifierName(final String aName) {
    ...
    public void setTopText(final String tdi) {
        this.topText = tdi;
    ...
    public void setTextDisplayed(final String tdi) {
    ...
    public void setRewardItem(final int ri) {
        this.rewardItem = ri;
    }
    
    public void setRewardNumbers(final int nums) {
        this.rewardNumbers = nums;
    }
    
    public void setExistingItemReward(final long rew) {
    ...
    public void setRewardSkillVal(final float snum) {
    ...
    public void setSpecialEffect(final int effectid) {
    ...
    public void setTrigger(final int tid) {
        if (tid > 0) {
    ...
    public int getTriggerId() {
        final MissionTrigger[] trigs = Triggers2Effects.getTriggersForEffect(this.id, true);
        if (trigs.length >= 1) {
    ...
    public void setMissionStateChange(final float stateChange) {
    ...
    public void setMission(final int mid) {
        this.missionId = mid;
    }
    ...
    public void setRewardSkillNum(final int snum) {
    ...
    public void setRewardTargetContainerId(final long rew) {
        this.rewardTargetContainerId = rew;
    }
    
    public void setRewardQl(final int ql) {
        this.rewardQl = ql;
    }
    
    public void setRewardByteValue(final byte bv) {
        this.rewardByteValue = bv;
    }
    
    public void setSoundName(final String sn) {
        this.soundName = sn;
    ...
    public final boolean setMissionState(final Creature performer, MissionPerformed mperf, final boolean setFinishedEpic) {
        boolean toReturn = false;
        final Mission mission = Missions.getMissionWithId(this.missionId);
        if (mission != null && !mission.isInactive()) {
            ...
            if (this.creatorType == 2) {
                ...
                final MissionPerformed mpf = missionPerfor.getMission(this.missionId);
                if (mpf != null) {
                    mperf = mpf;
                }
                else {
            ...
            if (!mperf.isFailed()) {
                if (sendStartPopup && mission.getInstruction() != null && mission.getInstruction().length() > 0) {
                    final SimplePopup pop = new SimplePopup(performer, "Mission start", mission.getInstruction());
                    pop.sendQuestion();
                }
                if (mission.getMaxTimeSeconds() > 0 && System.currentTimeMillis() > mperf.getFinishTimeAsLong(mission.getMaxTimeSeconds())) {
                    ...
                    final SimplePopup pop2 = new SimplePopup(performer, "Mission failed", "You failed " + mission.getName() + ". You are " + miss + " late.");
                    pop2.sendQuestion();
                    toReturn = true;
                }
                else {
    ...
    public boolean sendTriggerDescription(final Creature performer) {
        if ((this.getTextDisplayed() != null && this.getTextDisplayed().length() > 0) || (this.getTopText() != null && this.getTopText().length() > 0)) {
            final MissionPopup pop = new MissionPopup(performer, "Mission progress", "");
    ...
    private static void destroyInventoryItems(final Item inventory, final Creature performer) {
        final Item[] inventoryItems = inventory.getItemsAsArray();
    ...
    public void effect(final Creature performer, final MissionPerformed perf, final long target, final boolean setFinished, final boolean triggerEpicHelper) {
        ...
        if (!this.inActive) {
            ...
            if (this.getMissionStateChange() != 0.0f) {
                ...
                if (this.creatorType == 2) {
                    ...
                    final EpicMission em = EpicServerStatus.getEpicMissionForMission(perf.getMissionId());
                    if (em != null) {
                        if (em.isCurrent()) {
                            ...
                            if ((Deities.getFavoredKingdom(deityNum) == performer.getKingdomTemplateId() || !Servers.localServer.EPIC) && missionEnum != null && !EpicMissionEnum.isMissionKarmaGivenOnKill(missionEnum)) {
                                final int karmaSplit = missionEnum.getKarmaBonusDiffMult() * em.getDifficulty();
                                if (missionEnum.isKarmaMultProgress()) {
                                    final int karmaGained = (int)Math.ceil(karmaSplit / 100.0f * this.getMissionStateChange());
                                    if (karmaGained > 0) {
                                        ...
                                        if (performer.isPaying()) {
                                            ...
                                            if (Servers.localServer.EPIC) {
                                                final WcEpicKarmaCommand wcek = new WcEpicKarmaCommand(WurmId.getNextWCCommandId(), new long[] { performer.getWurmId() }, new int[] { performer.getScenarioKarma() }, em.getEpicEntityId());
                                                wcek.sendToLoginServer();
                                            }
                                        }
                                        if (this.getMissionStateChange() * 10.0f > 10.0f) {
                                            TriggerEffect.logger.log(Level.INFO, "Added karma " + karmaGained + " to " + performer.getName() + " for mission " + em.getMissionId() + " for " + em.getEntityName() + " state change=" + this.getMissionStateChange() + " to " + em.getMissionProgress());
                                        }
                                    }
                                }
                            }
                            ...
                            if (em.isCompleted()) {
                                TriggerEffect.logger.log(Level.INFO, "Mission is complete! " + performer.getName() + " mission " + em.getMissionId() + " for " + em.getEntityName() + ", performer mission is " + perf.getMissionId());
                                if (performer.isPlayer()) {
                                    ((Player)performer).setLastTrigger(this.id);
                                }
                                this.sendTriggerDescription(performer);
                                final Mission m = Missions.getMissionWithId(perf.getMissionId());
                                if (m != null) {
                                    if (Deities.getFavoredKingdom(deityNum) == performer.getKingdomTemplateId() || !Servers.localServer.EPIC) {
                                        ...
                                        final int baseKarma = missionEnum.getBaseKarma();
                                        final int baseSleep = missionEnum.getBaseSleep();
                                        int karmaSplit2 = missionEnum.getKarmaBonusDiffMult() * em.getDifficulty();
                                        int sleepSplit = missionEnum.getSleepBonusDiffMult() * em.getDifficulty();
                                        final ArrayList<Player> totalNearby = new ArrayList<Player>();
                                        for (final Player p : Players.getInstance().getPlayers()) {
                                            if ((Deities.getFavoredKingdom(deityNum) == p.getKingdomTemplateId() || !Servers.localServer.EPIC) && p.isWithinDistanceTo(performer, 300.0f)) {
                                                totalNearby.add(p);
                                            }
                                        }
                                        final ArrayList<PlayerInfo> allParticipants = new ArrayList<PlayerInfo>();
                                        ...
                                        for (final MissionPerformer mp : allPerformers) {
                                            ...
                                            if (thisMission != null) {
                                                ...
                                                final PlayerInfo pinf = PlayerInfoFactory.getPlayerInfoWithWurmId(mp.getWurmId());
                                                if (pinf != null) {
                                        ...
                                        if (karmaSplit2 > 0 && EpicMissionEnum.isKarmaSplitNearby(missionEnum)) {
                                            karmaGainedNearby = (int)Math.ceil(karmaSplit2 / totalNearby.size());
                                            karmaSplit2 = 0;
                                        }
                                        if (sleepSplit > 0 && missionEnum.isSleepMultNearby()) {
                                            sleepGainedNearby = (int)Math.ceil(sleepSplit / totalNearby.size());
                                            sleepSplit = 0;
                                        }
                                        for (final Player p2 : totalNearby) {
                                            if (sleepGainedNearby > 0) {
                                                p2.getSaveFile().addToSleep((int)(Math.min(30, sleepGainedNearby) * 60L));
                                            }
                                            if (karmaGainedNearby > 0) {
                                                p2.modifyKarma(Math.max(1, karmaGainedNearby));
                                                if (!p2.isPaying()) {
                                                    continue;
                                                }
                                                p2.setScenarioKarma(p2.getScenarioKarma() + Math.max(1, karmaGainedNearby));
                                                ids.add(p2.getWurmId());
                                                values.add(p2.getScenarioKarma());
                                            }
                                        }
                                        int karmaGained2 = baseKarma;
                                        if (karmaSplit2 > 0) {
                                            karmaGained2 += (int)Math.ceil(karmaSplit2 / allParticipants.size());
                                        }
                                        int sleepBonusGain = 0;
                                        if (sleepSplit > 0) {
                                            sleepBonusGain += (int)Math.ceil(sleepSplit / allParticipants.size());
                                        }
                                        final Iterator<PlayerInfo> iterator2 = allParticipants.iterator();
                                        while (iterator2.hasNext()) {
                                            final PlayerInfo pinf = iterator2.next();
                                            if (baseSleep > 0 || sleepBonusGain > 0) {
                                                pinf.addToSleep((int)((baseSleep + Math.min(30, sleepBonusGain)) * 60L));
                                            }
                                            if (karmaGained2 > 0) {
                                                pinf.setKarma(pinf.getKarma() + Math.max(1, karmaGained2));
                                                if (pinf.isPaying()) {
                                                    pinf.setScenarioKarma(pinf.getScenarioKarma() + Math.max(1, karmaGained2));
                                                    ids.add(pinf.wurmId);
                                            ...
                                            if (Servers.localServer.PVPSERVER) {
                                                try {
                                                    ...
                                                    TriggerEffect.logger.log(Level.WARNING, this.getName() + ": failed to reset rank decay timer " + pinf.getRank(), iox);
                                                }
                                            }
                                            Achievements.triggerAchievement(pinf.wurmId, 601);
                                        }
                                        if (Servers.localServer.EPIC) {
                                            final long[] idsToSend = new long[ids.size()];
                                            final int[] valuesToSend = new int[values.size()];
                                            for (int x = 0; x < idsToSend.length; ++x) {
                                                idsToSend[x] = ids.get(x);
                                                valuesToSend[x] = values.get(x);
                                            }
                                            final WcEpicKarmaCommand wcek2 = new WcEpicKarmaCommand(WurmId.getNextWCCommandId(), idsToSend, valuesToSend, em.getEpicEntityId());
                                            wcek2.sendToLoginServer();
                                        }
                                        performer.achievement(53);
                                    }
                                    Players.printRanks();
                                    final MissionTrigger[] allTriggers;
                                    final MissionTrigger[] triggers = allTriggers = MissionTriggers.getAllTriggers();
                                    for (final MissionTrigger t : allTriggers) {
                                        if (t.getMissionRequired() == m.getId()) {
                                            TriggerEffect.logger.log(Level.INFO, performer.getName() + "Destroying triggers for  mission " + em.getMissionId() + " for " + em.getEntityName() + ", performer mission is " + perf.getMissionId());
                                            TriggerEffects.destroyEffectsForTrigger(t.getId());
                                            t.destroy();
                                        }
                                    }
                                }
                                TriggerEffect.logger.log(Level.INFO, performer.getName() + "Destroying effect for  mission " + em.getMissionId() + " for " + em.getEntityName() + ", performer mission is " + perf.getMissionId());
                                this.destroy();
                                TriggerEffect.logger.log(Level.INFO, performer.getName() + " Sending report for " + em.getMissionId() + " for " + em.getEntityName() + ", performer mission is " + perf.getMissionId());
                                final WcEpicStatusReport wce = new WcEpicStatusReport(WurmId.getNextWCCommandId(), true, em.getEpicEntityId(), em.getMissionType(), em.getDifficulty());
                                wce.sendToLoginServer();
                                EpicServerStatus.storeLastMissionForEntity(em.getEpicEntityId(), em);
                                if (!Servers.localServer.EPIC) {
                                    final int deityNumber = em.getEpicEntityId();
                                    if (deityNumber > 0 && deityNumber <= 4) {
                                        final String entityName = Deities.getEntityName(deityNumber);
            ...
            if (this.destroysInventory()) {
                ...
                final Item[] boditems = performer.getBody().getContainersAndWornItems();
            ...
            if (this.rewardItem > 0 && this.creatorType != 3) {
                ...
                for (int x2 = 0; x2 < this.rewardNumbers; ++x2) {
                    try {
                        final Item toCreate = ItemFactory.createItem(this.rewardItem, this.rewardQl, this.itemMaterial, (byte)0, performer.getName());
                        if (this.newbieItem) {
                        ...
                        this.insertItem(performer, toCreate, x2);
                    }
                    catch (NoSuchTemplateException nsi) {
                        TriggerEffect.logger.log(Level.WARNING, nsi.getMessage(), nsi);
                        break;
                    }
                    catch (FailedException fe) {
                        TriggerEffect.logger.log(Level.WARNING, fe.getMessage(), fe);
                        break;
                    }
                }
            }
            if (this.existingItemReward > 0L) {
                try {
                    final Item toCreate2 = Items.getItem(this.existingItemReward);
                    this.insertItem(performer, toCreate2, 0);
            ...
            if (this.rewardSkillNum > 0 && this.creatorType != 3) {
                ...
                if (skills != null) {
                    try {
                        final Skill skill = skills.getSkill(this.rewardSkillNum);
                        final double existing = skill.getKnowledge();
                        double reward = this.rewardSkillVal;
                        if (this.rewardSkillVal < 1.0f) {
                            final double diff = 100.0 - existing;
                            reward = diff * this.rewardSkillVal;
                        }
            ...
            if (this.getSpecialEffectId() > 0) {
                if (this.teleportX > 0 || this.teleportY > 0) {
                    ...
                    try {
                        ...
                        TriggerEffect.logger.log(Level.WARNING, ex.getMessage(), ex);
                    }
                }
            }
            ...
            if ((this.getModifyTileX() > 0 || this.getModifyTileY() > 0) && this.getNewTileType() != 0) {
                if (this.getNewTileType() == Tiles.Tile.TILE_CAVE_WALL.id || this.getNewTileType() == Tiles.Tile.TILE_CAVE_WALL_ORE_IRON.id) {
                    ...
                    if (this.getNewTileType() == Tiles.Tile.TILE_CAVE_WALL_ORE_IRON.id) {
                        final int ntile = Server.caveMesh.getTile(this.getModifyTileX(), this.getModifyTileY());
                    ...
                    final int otile = Server.surfaceMesh.getTile(this.getModifyTileX(), this.getModifyTileY());
                    if (Tiles.decodeType(otile) != Tiles.Tile.TILE_HOLE.id) {
                        final VolaTile t2 = Zones.getOrCreateTile(this.getModifyTileX(), this.getModifyTileY(), true);
                        if (t2 != null) {
            ...
            Label_3197: {
                if (this.spawnTileX <= 0) {
                    if (this.spawnTileY <= 0) {
                        break Label_3197;
                    }
                }
                try {
                    if (this.getCreatureSpawn() > 0) {
                        final CreatureTemplate ct = CreatureTemplateFactory.getInstance().getTemplate(this.getCreatureSpawn());
                        byte sex = ct.getSex();
                        if (!ct.keepSex) {
                            sex = (byte)(Server.rand.nextBoolean() ? 1 : 0);
                        }
                        final byte ttype = this.getCreatureType();
                        final byte age = (byte)this.getCreatureAge();
                        try {
                            Creature.doNew(ct.getTemplateId(), true, this.spawnTileX * 4 + 2, this.spawnTileY * 4 + 2, performer.getStatus().getRotation() - 180.0f, performer.getLayer(), ct.getName(), sex, (byte)0, ttype, false, age);
                        }
                        catch (Exception cex) {
                            TriggerEffect.logger.log(Level.WARNING, performer.getName() + " " + cex.getMessage(), cex);
                        }
                    }
                }
                catch (NoSuchCreatureTemplateException nsc) {
                    TriggerEffect.logger.log(Level.WARNING, performer.getName() + " " + nsc.getMessage(), nsc);
                }
            }
            if (this.getMissionToActivate() > 0) {
                final Mission mis = Missions.getMissionWithId(this.getMissionToActivate());
                if (mis != null) {
                    mis.setInactive(false);
                }
            }
            if (this.getMissionToDeActivate() > 0) {
                final Mission mis = Missions.getMissionWithId(this.getMissionToDeActivate());
                if (mis != null) {
                    mis.setInactive(true);
                }
            }
            if (this.getTriggerToActivate() > 0) {
                final MissionTrigger trg = MissionTriggers.getTriggerWithId(this.getTriggerToActivate());
                if (trg != null) {
                    trg.setInactive(false);
                }
            }
            if (this.getTriggerToDeActivate() > 0) {
                final MissionTrigger trg = MissionTriggers.getTriggerWithId(this.getTriggerToDeActivate());
                if (trg != null) {
                    trg.setInactive(true);
                }
            }
            if (this.getEffectToActivate() > 0) {
                final TriggerEffect eff = TriggerEffects.getTriggerEffect(this.getEffectToActivate());
                if (eff != null) {
                    eff.setInactive(false);
                }
            }
            if (this.getEffectToDeActivate() > 0) {
                final TriggerEffect eff = TriggerEffects.getTriggerEffect(this.getEffectToDeActivate());
                if (eff != null) {
            ...
            TriggerEffect.logger.log(Level.WARNING, "The effect " + this.id + " is inactive but called anyways.");
        }
    }
    
    void destroyTarget(final long targetId) {
    ...
    private void insertItem(final Creature performer, final Item toCreate, final int x) {
        if (this.rewardTargetContainerId == 0L) {
            ...
            try {
                final Item container = Items.getItem(this.rewardTargetContainerId);
    ...
    public void update() {
        ...
        try {
            ...
            ps = dbcon.prepareStatement("UPDATE TRIGGEREFFECTS SET NAME=?,DESCRIPTION=?,REWARDITEM=?,REWARDITEMNUMBERS=?,REWARDQUALITY=?,REWARDBYTE=?,EXISTINGREWARDITEMID=?,REWARDTARGETCONTAINERID=?,REWARDSKILLNUM=?,REWARDSKILLVAL=?,SPECIALEFFECTID=?,SOUND=?,TEXT=?,MISSION=?,MISSIONSTATECHANGE=?,INACTIVE=?,CREATOR=?,CREATEDDATE=?,LASTMODIFIER=?,TRIGGERID=?,DESTROYTARGET=?,ITEMMATERIAL=?,NEWBIE=?,MODIFYTILEX=?,MODIFYTILEY=?,NEWTILETYPE=?,NEWTILEDATA=?,SPAWNTILEX=?,SPAWNTILEY=?,CREATURESPAWN=?,CREATUREAGE=?,CREATURE_TYPE=?,CREATURE_NAME=?,TELEPORTX=?,TELEPORTY=?,MISSIONACTIVATED=?,MISSIONDEACTIVATED=?,TRIGGER_ACTIVATED=?,TRIGGER_DEACTIVATED=?,EFFECT_ACTIVATED=?,EFFECT_DEACTIVATED=?,WSZX=?,WSZY=?,STARTSKILLGAIN=?,STOPSKILLGAIN=?,DESTROYITEMS=?,TOP=?,TELEPORTLAYER=?,ACHIEVEMENTID=? WHERE ID=?");
            ...
            TriggerEffect.logger.log(Level.WARNING, sqx.getMessage(), sqx);
        }
        finally {
    ...
    public void create() {
        ...
        try {
            dbcon = DbConnector.getPlayerDbCon();
            ps = dbcon.prepareStatement("INSERT INTO TRIGGEREFFECTS (NAME, DESCRIPTION,REWARDITEM,REWARDITEMNUMBERS,REWARDQUALITY,REWARDBYTE,EXISTINGREWARDITEMID,REWARDTARGETCONTAINERID,REWARDSKILLNUM,REWARDSKILLVAL,SPECIALEFFECTID,SOUND,TEXT,MISSION,MISSIONSTATECHANGE,INACTIVE,CREATOR,CREATEDDATE,LASTMODIFIER,TRIGGERID,DESTROYTARGET,CREATORID,CREATORTYPE,ITEMMATERIAL,NEWBIE,MODIFYTILEX,MODIFYTILEY,NEWTILETYPE,NEWTILEDATA,SPAWNTILEX,SPAWNTILEY,CREATURESPAWN,CREATUREAGE,CREATURE_TYPE,CREATURE_NAME,TELEPORTX,TELEPORTY,MISSIONACTIVATED,MISSIONDEACTIVATED,TRIGGER_ACTIVATED,TRIGGER_DEACTIVATED,EFFECT_ACTIVATED,EFFECT_DEACTIVATED,WSZX,WSZY,STARTSKILLGAIN,STOPSKILLGAIN,DESTROYITEMS,TOP,TELEPORTLAYER,ACHIEVEMENTID) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", 1);
            ps.setString(1, this.name);
            ps.setString(2, this.description);
            ps.setInt(3, this.rewardItem);
            ps.setInt(4, this.rewardNumbers);
            ...
            TriggerEffect.logger.log(Level.INFO, "Trigger effect " + this.name + " (" + this.id + ") created at " + this.createdDate);
        }
        catch (SQLException sqx) {
            TriggerEffect.logger.log(Level.WARNING, sqx.getMessage(), sqx);
        }
    ...
    @Override
    public int compareTo(final TriggerEffect aTriggerEffect) {
    ...
    public void setAchievementId(final int aAchievementId) {
        this.achievementId = aAchievementId;
    }
    
    public boolean hasTargetOf(final long currentTargetId, final Creature performer) {
        final MissionTrigger t = MissionTriggers.getTriggerWithId(this.triggerId);
        return t != null && t.getTarget() == currentTargetId;
    }
    
    static {
        TriggerEffect.logger = Logger.getLogger(TriggerEffect.class.getName());
    }
}
