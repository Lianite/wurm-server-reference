...
public class WoodcuttingStage extends TutorialStage
{
    ...
    public WoodcuttingStage(final long playerId) {
        super(playerId);
    }
    ...
    public class CutDownSubStage extends TutorialSubStage
    {
        public CutDownSubStage(final long playerId) {
            super(playerId);
    ...
    public class CreateLogSubStage extends TutorialSubStage
    {
        public CreateLogSubStage(final long playerId) {
            super(playerId);
