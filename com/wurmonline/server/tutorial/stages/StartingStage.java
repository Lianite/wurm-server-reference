...
public class StartingStage extends TutorialStage
{
    ...
    public StartingStage(final long playerId) {
        super(playerId);
    }
    ...
    public class DeathSubStage extends TutorialSubStage
    {
        public DeathSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class ChatSubStage extends TutorialSubStage
    {
        public ChatSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class EventSubStage extends TutorialSubStage
    {
        public EventSubStage(final long playerId) {
            super(playerId);
        }
