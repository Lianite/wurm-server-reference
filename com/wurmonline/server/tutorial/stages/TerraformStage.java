...
public class TerraformStage extends TutorialStage
{
    ...
    public TerraformStage(final long playerId) {
        super(playerId);
    }
    ...
    public class DigExplainSubStage extends TutorialSubStage
    {
        public DigExplainSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class PlayerDigSubStage extends TutorialSubStage
    {
        public PlayerDigSubStage(final long playerId) {
            super(playerId);
    ...
    public class LevelSubStage extends TutorialSubStage
    {
        public LevelSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class TileTypeSubStage extends TutorialSubStage
    {
        public TileTypeSubStage(final long playerId) {
            super(playerId);
        }
