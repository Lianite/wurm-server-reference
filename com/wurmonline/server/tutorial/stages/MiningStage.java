...
public class MiningStage extends TutorialStage
{
    ...
    public MiningStage(final long playerId) {
        super(playerId);
    }
    ...
    public class DigRockSubStage extends TutorialSubStage
    {
        public DigRockSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class MineIronSubStage extends TutorialSubStage
    {
        public MineIronSubStage(final long playerId) {
            super(playerId);
