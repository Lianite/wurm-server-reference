...
public class RodFishingStage extends TutorialStage
{
    ...
    public RodFishingStage(final long playerId) {
        super(playerId);
    }
    ...
    public class RodStartSubStage extends TutorialSubStage
    {
        public RodStartSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class RodSetupSubStage extends TutorialSubStage
    {
        public RodSetupSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class RodActionSubStage extends TutorialSubStage
    {
        public RodActionSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class RodHookingSubStage extends TutorialSubStage
    {
        public RodHookingSubStage(final long playerId) {
            super(playerId);
        }
