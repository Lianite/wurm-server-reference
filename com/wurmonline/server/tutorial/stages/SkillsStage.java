...
public class SkillsStage extends TutorialStage
{
    ...
    public SkillsStage(final long playerId) {
        super(playerId);
    }
    ...
    public class SkillGainSubStage extends TutorialSubStage
    {
        public SkillGainSubStage(final long playerId) {
            super(playerId);
        }
