...
public class InventoryStage extends TutorialStage
{
    ...
    public InventoryStage(final long playerId) {
        super(playerId);
    }
    ...
    public class InventorySubStage extends TutorialSubStage
    {
        public InventorySubStage(final long playerId) {
            super(playerId);
    ...
    public class MoveItemsSubStage extends TutorialSubStage
    {
        public MoveItemsSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class QualitySubStage extends TutorialSubStage
    {
        public QualitySubStage(final long playerId) {
            super(playerId);
        }
