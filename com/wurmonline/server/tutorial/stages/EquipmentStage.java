...
public class EquipmentStage extends TutorialStage
{
    ...
    public EquipmentStage(final long playerId) {
        super(playerId);
    }
    ...
    public class CharacterSubStage extends TutorialSubStage
    {
        public CharacterSubStage(final long playerId) {
            super(playerId);
    ...
    public class EquipSubStage extends TutorialSubStage
    {
        public EquipSubStage(final long playerId) {
            super(playerId);
    ...
    public class ToolbeltSubStage extends TutorialSubStage
    {
        public ToolbeltSubStage(final long playerId) {
            super(playerId);
        }
