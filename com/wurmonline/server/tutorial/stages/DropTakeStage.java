...
public class DropTakeStage extends TutorialStage
{
    ...
    public DropTakeStage(final long playerId) {
        super(playerId);
    }
    ...
    public class DropSubStage extends TutorialSubStage
    {
        public DropSubStage(final long playerId) {
            super(playerId);
        }
    ...
    public class PlaceSubStage extends TutorialSubStage
    {
        public PlaceSubStage(final long playerId) {
            super(playerId);
    ...
    public class TakeSubStage extends TutorialSubStage
    {
        public TakeSubStage(final long playerId) {
            super(playerId);
