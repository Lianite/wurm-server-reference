...
public final class Materials implements ItemMaterials, MiscConstants
{
    ...
    public static int getTemplateIdForMaterial(final byte material) {
        if (material == 0) {
            return -10;
        }
        switch (material) {
            ...
            default: {
                if (Materials.logger.isLoggable(Level.FINE)) {
                    Materials.logger.fine("Returning Template NOID for unexpected material: " + material);
                }
                return -10;
            }
        }
    ...
    public static String getTreeName(final byte data) {
        return TreeData.TreeType.fromInt(data).toString() + " tree";
    }
    
    public static BushData.BushType getBushTypeForWood(final byte wood) {
        switch (wood) {
            case 46: {
    ...
    public static final int getTransmutedTemplate(final int templateId) {
        int toReturn = 26;
        switch (templateId) {
            case 479: {
                toReturn = 467;
    ...
    public static byte convertMaterialStringIntoByte(final String material) {
        switch (material) {
            case "flesh": {
                return 1;
            }
    ...
    public static String convertMaterialByteIntoString(final byte material) {
        switch (material) {
            case 1: {
                return "flesh";
            }
    ...
    static {
        logger = Logger.getLogger(Materials.class.getName());
    }
}
