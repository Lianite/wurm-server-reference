...
public final class CreationEntryCreator
{
    ...
    private static boolean entriesCreated;
    ...
    public static void createCreationEntries() {
        ...
        if (Features.Feature.METALLIC_ITEMS.isEnabled()) {
            for (final int sourceTemplateId : ItemFactory.metalLumpList) {
                try {
                    final ItemTemplate lump = ItemTemplateFactory.getInstance().getTemplate(sourceTemplateId);
                    final CreationEntry temp = createSimpleEntry(10015, sourceTemplateId, 675, 659, true, true, 0.0f, false, false, CreationCategories.LIGHTS_AND_LAMPS);
        ...
        final int[] metalTypes = { 221, 223, 220, 694, 698, 44, 45, 205, 47, 46, 49, 48, 837 };
        final int[] runeTypes = { 1290, 1293, 1292, 1289, 1291 };
        for (final int metal : metalTypes) {
            for (final int rune : runeTypes) {
        ...
        final CreationEntry brownBearRug = createSimpleEntry(10017, 302, 349, 847, true, true, 0.0f, false, false, 0, 30.0, CreationCategories.RUGS);
        brownBearRug.setDepleteFromSource(3000);
        brownBearRug.setDepleteFromTarget(1);
        final CreationEntry blackBearRug = createSimpleEntry(10017, 302, 349, 846, true, true, 0.0f, false, false, 0, 30.0, CreationCategories.RUGS);
        blackBearRug.setDepleteFromSource(3000);
        blackBearRug.setDepleteFromTarget(1);
        final CreationEntry mountainLionRug = createSimpleEntry(10017, 313, 349, 848, true, true, 0.0f, false, false, 0, 30.0, CreationCategories.RUGS);
        mountainLionRug.setDepleteFromSource(300);
        mountainLionRug.setDepleteFromTarget(1);
        final CreationEntry blackWolfRug = createSimpleEntry(10017, 302, 349, 849, true, true, 0.0f, false, false, 0, 30.0, CreationCategories.RUGS);
        blackWolfRug.setDepleteFromSource(3000);
        blackWolfRug.setDepleteFromTarget(1);
        final AdvancedCreationEntry lRudder = createAdvancedEntry(10082, 23, 22, 544, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        lRudder.addRequirement(new CreationRequirement(1, 22, 5, true));
        final AdvancedCreationEntry bellCot = createAdvancedEntry(1005, 217, 22, 723, false, false, 0.0f, true, false, CreationCategories.CONSTRUCTION_MATERIAL);
        bellCot.addRequirement(new CreationRequirement(1, 22, 25, true));
        bellCot.addRequirement(new CreationRequirement(2, 9, 4, true));
        final AdvancedCreationEntry bellTower = createAdvancedEntry(1005, 718, 723, 722, false, false, 0.0f, true, false, CreationCategories.DECORATION);
        bellTower.addRequirement(new CreationRequirement(1, 319, 1, true));
        final AdvancedCreationEntry bellSmall = createAdvancedEntry(10015, 734, 720, 719, false, false, 0.0f, true, false, CreationCategories.TOYS);
        bellSmall.addRequirement(new CreationRequirement(1, 99, 1, true));
        final AdvancedCreationEntry lHelm = createAdvancedEntry(10082, 23, 22, 548, false, false, 0.0f, true, true, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry well = createAdvancedEntry(1013, 132, 130, 608, false, false, 0.0f, true, true, CreationCategories.FOUNTAINS_AND_WELLS);
        ...
        final AdvancedCreationEntry lStern = createAdvancedEntry(10082, 551, 546, 553, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry lRigS = createAdvancedEntry(10082, 589, 555, 564, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry lRigT = createAdvancedEntry(10082, 588, 554, 563, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        lRigT.addRequirement(new CreationRequirement(1, 559, 2, true));
        lRigT.addRequirement(new CreationRequirement(2, 549, 2, true));
        final AdvancedCreationEntry spinRigT = createAdvancedEntry(10082, 588, 591, 584, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        spinRigT.addRequirement(new CreationRequirement(1, 559, 2, true));
        spinRigT.addRequirement(new CreationRequirement(2, 549, 2, true));
        final AdvancedCreationEntry lRigCrows = createAdvancedEntry(10082, 590, 555, 585, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry tRigCrows = createAdvancedEntry(10082, 552, 555, 587, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry lRigSqY = createAdvancedEntry(10082, 552, 555, 586, false, false, 0.0f, true, false, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry bardingLeather = createAdvancedEntry(10017, 131, 72, 702, false, false, 0.0f, true, false, CreationCategories.ANIMAL_EQUIPMENT);
        ...
        final AdvancedCreationEntry bridle = createAdvancedEntry(10017, 627, 631, 624, false, false, 0.0f, true, false, CreationCategories.ANIMAL_EQUIPMENT);
        bridle.addRequirement(new CreationRequirement(1, 628, 1, true));
        final AdvancedCreationEntry saddle = createAdvancedEntry(10017, 625, 629, 621, false, false, 0.0f, true, false, CreationCategories.ANIMAL_EQUIPMENT);
        saddle.addRequirement(new CreationRequirement(1, 626, 1, true));
        final AdvancedCreationEntry saddleL = createAdvancedEntry(10017, 625, 630, 622, false, false, 0.0f, true, false, CreationCategories.ANIMAL_EQUIPMENT);
        saddleL.addRequirement(new CreationRequirement(1, 626, 1, true));
        final AdvancedCreationEntry saddleBag = createAdvancedEntry(10017, 1332, 102, 1333, false, false, 0.0f, true, false, CreationCategories.ANIMAL_EQUIPMENT);
        ...
        final AdvancedCreationEntry birdcage = createAdvancedEntry(10043, 897, 444, 1025, false, false, 0.0f, true, false, CreationCategories.DECORATION);
        ...
        createBoatEntries();
        final AdvancedCreationEntry sacknife = createAdvancedEntry(1016, 101, 793, 792, false, false, 0.0f, true, false, CreationCategories.WEAPONS);
        ...
        final AdvancedCreationEntry torch = createAdvancedEntry(1010, 153, 23, 138, false, false, 0.0f, true, false, CreationCategories.LIGHTS_AND_LAMPS);
        torch.addRequirement(new CreationRequirement(1, 479, 1, true));
        final AdvancedCreationEntry oven = createAdvancedEntry(1013, 132, 130, 178, false, false, 0.0f, true, true, CreationCategories.FIRE);
        oven.addRequirement(new CreationRequirement(1, 132, 10, true));
        oven.addRequirement(new CreationRequirement(2, 130, 10, true));
        final AdvancedCreationEntry forge = createAdvancedEntry(1013, 132, 130, 180, false, false, 0.0f, true, true, CreationCategories.FIRE);
        forge.addRequirement(new CreationRequirement(1, 132, 10, true));
        forge.addRequirement(new CreationRequirement(2, 130, 10, true));
        final AdvancedCreationEntry colossus = createAdvancedEntry(1013, 519, 130, 518, false, false, 0.0f, true, true, CreationCategories.STATUES);
        ...
        final AdvancedCreationEntry pylon = createAdvancedEntry(1013, 406, 130, 713, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry shrine = createAdvancedEntry(1005, 406, 130, 712, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry temple = createAdvancedEntry(1013, 406, 130, 715, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry obelisk = createAdvancedEntry(1013, 132, 130, 714, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry pillarDecoration = createAdvancedEntry(1013, 132, 130, 736, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry pillar = createAdvancedEntry(1013, 132, 130, 717, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry spiritgate = createAdvancedEntry(1013, 132, 130, 716, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry sbench = createAdvancedEntry(1013, 132, 406, 404, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        sbench.addRequirement(new CreationRequirement(1, 132, 1, true));
        sbench.addRequirement(new CreationRequirement(2, 130, 2, true));
        final AdvancedCreationEntry coff = createAdvancedEntry(1013, 132, 406, 407, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry ropetool = createAdvancedEntry(10044, 22, 23, 320, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ropetool.addRequirement(new CreationRequirement(1, 217, 3, true));
        final AdvancedCreationEntry wheelSmall = createAdvancedEntry(10044, 22, 23, 187, false, false, 0.0f, true, false, CreationCategories.CART_PARTS);
        ...
        final AdvancedCreationEntry wheelAxlSmall = createAdvancedEntry(10044, 23, 187, 191, false, true, 0.0f, true, false, CreationCategories.CART_PARTS);
        wheelAxlSmall.addRequirement(new CreationRequirement(1, 187, 1, true));
        final AdvancedCreationEntry cartSmall = createAdvancedEntry(10044, 22, 191, 186, false, false, 0.0f, true, true, CreationCategories.CARTS);
        ...
        final AdvancedCreationEntry cartLarge = createAdvancedEntry(10044, 22, 191, 539, false, false, 0.0f, true, true, CreationCategories.CARTS);
        ...
        final AdvancedCreationEntry catapultSmall = createAdvancedEntry(10044, 23, 9, 445, false, false, 0.0f, true, true, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry batteringRam = createAdvancedEntry(10044, 860, 217, 1125, false, false, 0.0f, true, true, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry joist = createAdvancedEntry(1005, 23, 9, 429, false, false, 0.0f, true, true, CreationCategories.MINE_DOORS);
        ...
        final AdvancedCreationEntry floor = createAdvancedEntry(1005, 217, 22, 495, false, false, 0.0f, true, true, CreationCategories.CONSTRUCTION_MATERIAL);
        floor.addRequirement(new CreationRequirement(1, 22, 4, true));
        final AdvancedCreationEntry minedoor = createAdvancedEntry(1005, 217, 22, 592, false, false, 0.0f, true, true, CreationCategories.MINE_DOORS);
        ...
        final AdvancedCreationEntry minedoorst = createAdvancedEntry(10015, 167, 597, 596, false, false, 0.0f, true, true, CreationCategories.MINE_DOORS);
        ...
        final AdvancedCreationEntry minedoors = createAdvancedEntry(10015, 167, 598, 595, false, false, 0.0f, true, true, CreationCategories.MINE_DOORS);
        ...
        final AdvancedCreationEntry minedoorg = createAdvancedEntry(10015, 167, 599, 594, false, false, 0.0f, true, true, CreationCategories.MINE_DOORS);
        ...
        final AdvancedCreationEntry cheeseDrill = createAdvancedEntry(10044, 309, 23, 65, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry fruitPress = createAdvancedEntry(10044, 23, 22, 413, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry papyrusPress = createAdvancedEntry(10044, 23, 22, 747, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry raftSmall = createAdvancedEntry(10082, 217, 22, 289, false, false, 0.0f, true, true, CreationCategories.SHIPBUILDING);
        ...
        final AdvancedCreationEntry archeryTarg = createAdvancedEntry(1005, 23, 23, 458, false, false, 0.0f, true, true, CreationCategories.COMBAT_TRAINING);
        ...
        final AdvancedCreationEntry buildmarker = createAdvancedEntry(1005, 23, 23, 679, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry doll = createAdvancedEntry(1005, 217, 23, 321, false, false, 0.0f, true, false, CreationCategories.COMBAT_TRAINING);
        ...
        final AdvancedCreationEntry barrell = createAdvancedEntry(10044, 188, 22, 190, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        barrell.addRequirement(new CreationRequirement(1, 22, 4, true));
        barrell.addRequirement(new CreationRequirement(2, 188, 1, true));
        final AdvancedCreationEntry hbarrell = createAdvancedEntry(10044, 188, 22, 576, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        hbarrell.addRequirement(new CreationRequirement(1, 22, 24, true));
        hbarrell.addRequirement(new CreationRequirement(2, 188, 3, true));
        final AdvancedCreationEntry oilbarrell = createAdvancedEntry(10044, 188, 22, 757, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry grains = createAdvancedEntry(1005, 188, 22, 661, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        grains.addRequirement(new CreationRequirement(1, 22, 24, true));
        grains.addRequirement(new CreationRequirement(2, 217, 4, true));
        final AdvancedCreationEntry bulks = createAdvancedEntry(1005, 188, 22, 662, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        bulks.addRequirement(new CreationRequirement(1, 22, 24, true));
        bulks.addRequirement(new CreationRequirement(2, 217, 4, true));
        final AdvancedCreationEntry trash = createAdvancedEntry(1005, 188, 22, 670, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        trash.addRequirement(new CreationRequirement(1, 22, 10, true));
        trash.addRequirement(new CreationRequirement(2, 218, 2, true));
        final AdvancedCreationEntry barrels = createAdvancedEntry(10044, 218, 22, 189, false, false, 0.0f, true, false, CreationCategories.STORAGE);
        barrels.addRequirement(new CreationRequirement(1, 22, 4, true));
        final AdvancedCreationEntry wineBarrel = createAdvancedEntry(10044, 218, 22, 768, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry buckets = createAdvancedEntry(10044, 218, 22, 421, false, false, 0.0f, true, false, CreationCategories.STORAGE);
        buckets.addRequirement(new CreationRequirement(1, 22, 4, true));
        final AdvancedCreationEntry dredge = createAdvancedEntry(10015, 213, 319, 581, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        dredge.addRequirement(new CreationRequirement(1, 582, 4, true));
        final AdvancedCreationEntry crows = createAdvancedEntry(10044, 188, 22, 583, false, false, 0.0f, true, true, CreationCategories.SHIPBUILDING);
        crows.addRequirement(new CreationRequirement(1, 22, 12, true));
        crows.addRequirement(new CreationRequirement(2, 188, 3, true));
        final AdvancedCreationEntry chests = createAdvancedEntry(10044, 218, 22, 192, false, false, 0.0f, true, false, CreationCategories.STORAGE);
        chests.addRequirement(new CreationRequirement(1, 22, 3, true));
        final AdvancedCreationEntry signp = createAdvancedEntry(10044, 218, 22, 208, false, false, 0.0f, true, false, CreationCategories.SIGNS);
        signp.addRequirement(new CreationRequirement(1, 23, 1, true));
        final AdvancedCreationEntry signl = createAdvancedEntry(10044, 218, 22, 209, false, false, 0.0f, true, false, CreationCategories.SIGNS);
        signl.addRequirement(new CreationRequirement(1, 23, 1, true));
        signl.addRequirement(new CreationRequirement(2, 22, 1, true));
        final AdvancedCreationEntry signshop = createAdvancedEntry(10044, 218, 22, 656, false, false, 0.0f, true, false, CreationCategories.SIGNS);
        signshop.addRequirement(new CreationRequirement(1, 23, 2, true));
        signshop.addRequirement(new CreationRequirement(2, 22, 2, true));
        final AdvancedCreationEntry signs = createAdvancedEntry(10044, 218, 22, 210, false, false, 0.0f, true, false, CreationCategories.SIGNS);
        signs.addRequirement(new CreationRequirement(1, 23, 1, true));
        final AdvancedCreationEntry dale = createAdvancedEntry(10036, 36, 9, 74, false, false, 0.0f, true, true, CreationCategories.PRODUCTION);
        dale.addRequirement(new CreationRequirement(1, 9, 20, true));
        dale.addRequirement(new CreationRequirement(2, 26, 2, true));
        final AdvancedCreationEntry loom = createAdvancedEntry(10044, 218, 22, 226, false, false, 0.0f, true, true, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry marketstall = createAdvancedEntry(10044, 217, 22, 580, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry squareTable = createAdvancedEntry(10044, 23, 22, 262, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry roundTable = createAdvancedEntry(10044, 23, 22, 260, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry diningTable = createAdvancedEntry(10044, 23, 22, 264, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry stoolRound = createAdvancedEntry(10044, 23, 22, 261, false, false, 0.0f, true, false, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry chair = createAdvancedEntry(10044, 22, 23, 263, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        chair.addRequirement(new CreationRequirement(1, 22, 2, true));
        chair.addRequirement(new CreationRequirement(2, 23, 2, true));
        final AdvancedCreationEntry armchair = createAdvancedEntry(10044, 23, 22, 265, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry bed = createAdvancedEntry(10044, 482, 483, 484, false, false, 0.0f, true, true, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry tentExplorer = createAdvancedEntry(10044, 23, 213, 863, false, false, 0.0f, true, true, CreationCategories.TENTS);
        ...
        final AdvancedCreationEntry tentMilitary = createAdvancedEntry(10044, 23, 213, 864, false, false, 0.0f, true, true, CreationCategories.TENTS);
        ...
        final AdvancedCreationEntry pavilion = createAdvancedEntry(10044, 23, 213, 865, false, false, 0.0f, true, true, CreationCategories.TENTS);
        ...
        final AdvancedCreationEntry bedframe = createAdvancedEntry(10044, 217, 22, 483, false, false, 0.0f, true, false, CreationCategories.CONSTRUCTION_MATERIAL);
        bedframe.addRequirement(new CreationRequirement(1, 22, 9, true));
        final AdvancedCreationEntry bedheadboard = createAdvancedEntry(10044, 218, 22, 482, false, false, 0.0f, true, false, CreationCategories.CONSTRUCTION_MATERIAL);
        ...
        final AdvancedCreationEntry bedfootboard = createAdvancedEntry(10044, 218, 22, 485, false, false, 0.0f, true, false, CreationCategories.CONSTRUCTION_MATERIAL);
        ...
        final AdvancedCreationEntry altarwood = createAdvancedEntry(10044, 218, 22, 322, false, false, 0.0f, true, true, CreationCategories.ALTAR);
        ...
        final AdvancedCreationEntry altarStone = createAdvancedEntry(1013, 130, 132, 323, false, false, 0.0f, true, true, CreationCategories.ALTAR);
        ...
        final AdvancedCreationEntry chestl = createAdvancedEntry(10044, 188, 22, 184, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry shieldsm = createAdvancedEntry(10014, 218, 22, 82, false, false, 0.0f, true, false, CreationCategories.SHIELDS);
        shieldsm.addRequirement(new CreationRequirement(1, 188, 1, true));
        final AdvancedCreationEntry shieldTurtle = createAdvancedEntry(10014, 218, 898, 899, false, false, 0.0f, true, false, CreationCategories.SHIELDS);
        shieldTurtle.addRequirement(new CreationRequirement(1, 100, 2, true));
        final AdvancedCreationEntry shieldmed = createAdvancedEntry(10014, 218, 22, 84, false, false, 0.0f, true, false, CreationCategories.SHIELDS);
        ...
        final AdvancedCreationEntry shieldla = createAdvancedEntry(10014, 218, 22, 85, false, false, 0.0f, true, false, CreationCategories.SHIELDS);
        ...
        final AdvancedCreationEntry compass = createAdvancedEntry(1020, 418, 76, 480, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        compass.addRequirement(new CreationRequirement(1, 215, 1, true));
        final AdvancedCreationEntry puppetFo = createAdvancedEntry(10051, 215, 214, 640, false, true, 0.0f, false, false, CreationCategories.TOYS);
        ...
        final AdvancedCreationEntry puppetVynora = createAdvancedEntry(10051, 215, 214, 642, false, true, 0.0f, false, false, CreationCategories.TOYS);
        ...
        final AdvancedCreationEntry puppetLibila = createAdvancedEntry(10051, 215, 214, 643, false, true, 0.0f, false, false, CreationCategories.TOYS);
        ...
        final AdvancedCreationEntry puppetMagranon = createAdvancedEntry(10051, 215, 214, 641, false, true, 0.0f, false, false, CreationCategories.TOYS);
        ...
        final AdvancedCreationEntry epicPortal = createAdvancedEntry(1013, 9, 132, 732, false, false, 0.0f, true, true, CreationCategories.EPIC);
        ...
        final AdvancedCreationEntry mailboxStone = createAdvancedEntry(1013, 132, 130, 511, false, false, 0.0f, true, true, CreationCategories.MAILBOXES);
        ...
        final AdvancedCreationEntry mailboxStone2 = createAdvancedEntry(1013, 132, 130, 513, false, false, 0.0f, true, true, CreationCategories.MAILBOXES);
        ...
        final AdvancedCreationEntry mailboxWood = createAdvancedEntry(10044, 218, 22, 510, false, false, 0.0f, true, true, CreationCategories.MAILBOXES);
        ...
        final AdvancedCreationEntry mailboxWood2 = createAdvancedEntry(10044, 218, 22, 512, false, false, 0.0f, true, true, CreationCategories.MAILBOXES);
        ...
        final AdvancedCreationEntry toolbelt = createAdvancedEntry(10017, 517, 102, 516, false, false, 0.0f, true, false, CreationCategories.CLOTHES);
        toolbelt.addRequirement(new CreationRequirement(1, 72, 1, true));
        toolbelt.addRequirement(new CreationRequirement(2, 213, 1, true));
        final AdvancedCreationEntry trapSticks = createAdvancedEntry(1005, 217, 22, 610, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapPole = createAdvancedEntry(1005, 217, 22, 611, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapCorrosion = createAdvancedEntry(1011, 217, 22, 612, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapAxe = createAdvancedEntry(1005, 217, 22, 613, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapDagger = createAdvancedEntry(1005, 217, 22, 614, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapNet = createAdvancedEntry(1014, 319, 319, 615, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        trapNet.addRequirement(new CreationRequirement(1, 559, 5, true));
        trapNet.addRequirement(new CreationRequirement(2, 23, 1, true));
        final AdvancedCreationEntry trapScythe = createAdvancedEntry(1013, 132, 130, 616, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapMan = createAdvancedEntry(10015, 582, 582, 617, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        trapMan.addRequirement(new CreationRequirement(1, 609, 1, true));
        final AdvancedCreationEntry trapBow = createAdvancedEntry(1005, 217, 22, 618, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        ...
        final AdvancedCreationEntry trapRope = createAdvancedEntry(1014, 319, 559, 619, false, false, 0.0f, true, false, CreationCategories.TRAPS);
        trapRope.addRequirement(new CreationRequirement(1, 23, 1, true));
        trapRope.addRequirement(new CreationRequirement(2, 457, 1, true));
        final AdvancedCreationEntry villageBoard = createAdvancedEntry(1005, 23, 22, 835, false, false, 0.0f, true, true, CreationCategories.SIGNS);
        ...
        final AdvancedCreationEntry copperBrazier = createAdvancedEntry(10015, 838, 839, 841, false, false, 0.0f, true, true, 20, 30.0, CreationCategories.LIGHTS_AND_LAMPS);
        copperBrazier.addRequirement(new CreationRequirement(1, 838, 2, true));
        final AdvancedCreationEntry marbleBrazierPillar = createAdvancedEntry(1013, 786, 492, 842, false, false, 0.0f, true, true, 20, 30.0, CreationCategories.LIGHTS_AND_LAMPS);
        ...
        final AdvancedCreationEntry wagon = createAdvancedEntry(10044, 22, 191, 850, false, false, 0.0f, true, true, 0, 40.0, CreationCategories.CARTS);
        ...
        final AdvancedCreationEntry smallCrate = createAdvancedEntry(1005, 22, 217, 851, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.STORAGE);
        smallCrate.addRequirement(new CreationRequirement(1, 22, 10, true));
        final AdvancedCreationEntry largeCrate = createAdvancedEntry(1005, 22, 217, 852, false, false, 0.0f, true, true, 0, 60.0, CreationCategories.STORAGE);
        largeCrate.addRequirement(new CreationRequirement(1, 22, 15, true));
        final AdvancedCreationEntry shipCarrier = createAdvancedEntry(10044, 22, 191, 853, false, false, 0.0f, true, true, 0, 15.0, CreationCategories.CARTS);
        ...
        final AdvancedCreationEntry creatureCarrier = createAdvancedEntry(10044, 22, 191, 1410, false, false, 0.0f, true, true, 0, 25.0, CreationCategories.CARTS);
        ...
        final AdvancedCreationEntry colossusOfVynora = createAdvancedEntry(1013, 519, 130, 869, false, false, 0.0f, true, true, CreationCategories.STATUES);
        ...
        final AdvancedCreationEntry colossusOfMagranon = createAdvancedEntry(1013, 519, 130, 870, false, false, 0.0f, true, true, CreationCategories.STATUES);
        ...
        final AdvancedCreationEntry bedsideTable = createAdvancedEntry(10044, 23, 22, 885, false, false, 0.0f, true, true, 0, 25.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry colossusOfFo = createAdvancedEntry(1013, 519, 130, 907, false, false, 0.0f, true, true, CreationCategories.STATUES);
        ...
        final AdvancedCreationEntry colossusOfLibila = createAdvancedEntry(1013, 519, 130, 916, false, false, 0.0f, true, true, CreationCategories.STATUES);
        ...
        final AdvancedCreationEntry openFireplace = createAdvancedEntry(1013, 492, 132, 889, false, false, 0.0f, true, true, 0, 35.0, CreationCategories.FIRE);
        ...
        final AdvancedCreationEntry canopyBed = createAdvancedEntry(10044, 482, 483, 890, false, false, 0.0f, true, true, 0, 65.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry woodenBench = createAdvancedEntry(10044, 218, 22, 891, false, false, 0.0f, true, true, 0, 35.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry wardrobe = createAdvancedEntry(10044, 217, 22, 892, false, false, 0.0f, true, true, 0, 55.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry woodenCoffer = createAdvancedEntry(10044, 218, 22, 893, false, false, 0.0f, true, true, 0, 24.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry royalThrone = createAdvancedEntry(10044, 217, 22, 894, false, false, 0.0f, true, true, 0, 70.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry washingBowl = createAdvancedEntry(10015, 64, 221, 895, false, true, 0.0f, false, true, 0, 30.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry tripodTableSmall = createAdvancedEntry(10044, 22, 23, 896, false, false, 0.0f, true, true, 0, 30.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry highBookshelf = createAdvancedEntry(10044, 217, 22, 911, false, false, 0.0f, true, true, 0, 35.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry lowBookshelf = createAdvancedEntry(10044, 217, 22, 912, false, false, 0.0f, true, true, 0, 25.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry emptyHighBookshelf = createAdvancedEntry(10044, 217, 22, 1401, false, false, 0.0f, true, true, 0, 35.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry emptyLowBookshelf = createAdvancedEntry(10044, 217, 22, 1400, false, false, 0.0f, true, true, 0, 25.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry barTable = createAdvancedEntry(10044, 218, 22, 1402, false, false, 0.0f, true, true, 0, 25.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry fineHighChair = createAdvancedEntry(10044, 218, 22, 913, false, false, 0.0f, true, true, 0, 60.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry highChair = createAdvancedEntry(10044, 218, 22, 914, false, false, 0.0f, true, true, 0, 50.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry pauperHighChair = createAdvancedEntry(10044, 218, 22, 915, false, false, 0.0f, true, true, 0, 40.0, CreationCategories.FURNITURE);
        ...
        if (Features.Feature.AMPHORA.isEnabled()) {
            final AdvancedCreationEntry kiln = createAdvancedEntry(1013, 132, 132, 1023, false, false, 0.0f, true, true, CreationCategories.FIRE);
        ...
        final AdvancedCreationEntry smelter = createAdvancedEntry(1013, 132, 132, 1028, false, false, 0.0f, true, true, 0, 50.0, CreationCategories.FIRE);
        ...
        final AdvancedCreationEntry simpleDioptra = createAdvancedEntry(10015, 902, 904, 903, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry rangePole = createAdvancedEntry(1005, 711, 213, 901, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry pewpewdie = createAdvancedEntry(10044, 217, 22, 934, false, false, 0.0f, true, true, 0, 40.0, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry siegeShield = createAdvancedEntry(1005, 217, 22, 931, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry ballistaMount = createAdvancedEntry(10044, 217, 9, 933, false, false, 0.0f, true, true, 0, 60.0, CreationCategories.WARMACHINES);
        ballistaMount.addRequirement(new CreationRequirement(1, 22, 8, true));
        final AdvancedCreationEntry barrier = createAdvancedEntry(1005, 217, 9, 938, false, false, 0.0f, true, true, 0, 5.0, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry ballista = createAdvancedEntry(10044, 933, 22, 936, false, false, 0.0f, true, true, 0, 60.0, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry trebuchet = createAdvancedEntry(10044, 9, 9, 937, false, false, 0.0f, true, true, 0, 80.0, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry archeryTower = createAdvancedEntry(10044, 217, 22, 939, false, false, 0.0f, true, true, 0, 40.0, CreationCategories.WARMACHINES);
        ...
        final AdvancedCreationEntry spinningWheel = createAdvancedEntry(10044, 187, 23, 922, false, false, 0.0f, true, true, 0, 30.0, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry loungeChair = createAdvancedEntry(10044, 22, 23, 923, false, false, 0.0f, true, true, 0, 40.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry royalLoungeChaise = createAdvancedEntry(10044, 22, 23, 924, false, false, 0.0f, true, true, 0, 70.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry woodCupboard = createAdvancedEntry(10044, 218, 22, 927, false, false, 0.0f, true, true, 0, 40.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry alchemyCupboard = createAdvancedEntry(10044, 218, 22, 1117, false, false, 0.0f, true, true, 0, 20.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry storageUnit = createAdvancedEntry(1005, 217, 22, 1119, false, false, 0.0f, true, true, 0, 30.0, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry roundMarbleTable = createAdvancedEntry(10074, 787, 130, 928, false, false, 0.0f, true, true, 0, 60.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry rectagularMarbleTable = createAdvancedEntry(10074, 787, 130, 929, false, false, 0.0f, true, true, 0, 50.0, CreationCategories.FURNITURE);
        ...
        final AdvancedCreationEntry yellowWoolCap = createAdvancedEntry(10016, 128, 943, 944, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry greenWoolCap = createAdvancedEntry(10016, 128, 943, 945, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry redWoolCap = createAdvancedEntry(10016, 128, 943, 946, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry blueWoolCap = createAdvancedEntry(10016, 128, 943, 947, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry NIcoomonWoolHat = createAdvancedEntry(10016, 215, 926, 948, true, false, 5.0f, false, false, 0, 5.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry CIcoomonWoolHat = createAdvancedEntry(10016, 216, 926, 948, true, false, 5.0f, false, false, 0, 5.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry coomonWoolHatDark = createAdvancedEntry(10016, 128, 948, 949, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry coomonWoolHatBrown = createAdvancedEntry(10016, 128, 948, 950, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry coomonWoolHatGreen = createAdvancedEntry(10016, 128, 948, 951, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry coomonWoolHatRed = createAdvancedEntry(10016, 128, 948, 952, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry coomonWoolHatBlue = createAdvancedEntry(10016, 128, 948, 953, true, false, 0.0f, true, false, 0, 20.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry foresterWoolHatGreen = createAdvancedEntry(10016, 128, 954, 955, true, false, 0.0f, true, false, 0, 10.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry foresterWoolHatDark = createAdvancedEntry(10016, 128, 954, 956, true, false, 0.0f, true, false, 0, 10.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry foresterWoolHatBlue = createAdvancedEntry(10016, 128, 954, 957, true, false, 0.0f, true, false, 0, 10.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry foresterWoolHatRed = createAdvancedEntry(10016, 128, 954, 958, true, false, 0.0f, true, false, 0, 10.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry squireWoolCapGreen = createAdvancedEntry(10016, 128, 961, 962, true, false, 0.0f, true, false, 0, 25.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry squireWoolCapBlue = createAdvancedEntry(10016, 128, 961, 963, true, false, 0.0f, true, false, 0, 25.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry squireWoolCapBlack = createAdvancedEntry(10016, 128, 961, 964, true, false, 0.0f, true, false, 0, 25.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry squireWoolCapRed = createAdvancedEntry(10016, 128, 961, 965, true, false, 0.0f, true, false, 0, 25.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry squireWoolCapYellow = createAdvancedEntry(10016, 128, 961, 966, true, false, 0.0f, true, false, 0, 25.0, CreationCategories.CLOTHES);
        ...
        final AdvancedCreationEntry grapeTrellis = createAdvancedEntry(10045, 918, 23, 920, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry grapeTrellis2 = createAdvancedEntry(10045, 266, 23, 920, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.DECORATION);
        grapeTrellis2.setObjectSourceMaterial((byte)49);
        grapeTrellis2.addRequirement(new CreationRequirement(1, 23, 5, true));
        grapeTrellis2.addRequirement(new CreationRequirement(2, 218, 1, true));
        final AdvancedCreationEntry ivyTrellis = createAdvancedEntry(10045, 917, 23, 919, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry roseTrellis = createAdvancedEntry(10045, 1017, 23, 1018, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry roseTrellis2 = createAdvancedEntry(10045, 266, 23, 1018, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.DECORATION);
        roseTrellis2.setObjectSourceMaterial((byte)47);
        roseTrellis2.addRequirement(new CreationRequirement(1, 23, 5, true));
        roseTrellis2.addRequirement(new CreationRequirement(2, 218, 1, true));
        final AdvancedCreationEntry hopsTrellis = createAdvancedEntry(10045, 1275, 23, 1274, false, false, 0.0f, true, true, 0, 10.0, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryStand = createAdvancedEntry(10044, 22, 23, 987, false, false, 0.0f, true, true, CreationCategories.RESOURCES);
        ...
        final AdvancedCreationEntry tapestryP1 = createAdvancedEntry(10016, 926, 987, 988, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryP2 = createAdvancedEntry(10016, 926, 987, 989, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryP3 = createAdvancedEntry(10016, 926, 987, 990, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryM1 = createAdvancedEntry(10016, 926, 987, 991, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryM2 = createAdvancedEntry(10016, 926, 987, 992, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryM3 = createAdvancedEntry(10016, 926, 987, 993, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryFaeldray = createAdvancedEntry(10016, 926, 987, 994, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry swordDisplay = createAdvancedEntry(10044, 987, 21, 1030, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry axeDisplay = createAdvancedEntry(10044, 987, 90, 1031, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry marblePlanter = createAdvancedEntry(10074, 786, 786, 1001, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        marblePlanter.addRequirement(new CreationRequirement(1, 786, 4, true));
        final AdvancedCreationEntry bunchOfRopes = createAdvancedEntry(1014, 319, 319, 1029, false, false, 0.0f, true, false, CreationCategories.ROPES);
        ...
        final AdvancedCreationEntry beeSmoker = createAdvancedEntry(10015, 188, 46, 1243, false, false, 0.0f, true, false, 0, 30.0, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry hive = createAdvancedEntry(10044, 23, 22, 1175, false, false, 0.0f, true, true, 0, 25.0, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry waxkit = createAdvancedEntry(10091, 213, 1254, 1255, false, false, 0.0f, true, false, 0, 21.0, CreationCategories.COOKING_UTENSILS);
        waxkit.addRequirement(new CreationRequirement(1, 1269, 1, true));
        waxkit.addRequirement(new CreationRequirement(2, 214, 1, true));
        final AdvancedCreationEntry skullMug = createAdvancedEntry(1012, 390, 1250, 1253, false, true, 0.0f, false, false, 0, 25.0, CreationCategories.COOKING_UTENSILS);
        ...
        final AdvancedCreationEntry messageBoard = createAdvancedEntry(1005, 23, 22, 1271, false, false, 0.0f, true, true, CreationCategories.SIGNS);
        ...
        final AdvancedCreationEntry still = createAdvancedEntry(10015, 772, 772, 1178, false, false, 0.0f, true, true, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry larder = createAdvancedEntry(10044, 22, 23, 1277, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        ...
        createAdvancedEntry(10015, 1298, 1299, 1296, false, false, 0.0f, true, false, CreationCategories.CONTAINER).addRequirement(new CreationRequirement(1, 76, 1, true)).addRequirement(new CreationRequirement(2, 131, 6, true)).addRequirement(new CreationRequirement(3, 444, 1, true)).addRequirement(new CreationRequirement(4, 100, 2, true)).addRequirement(new CreationRequirement(5, 1298, 2, true));
        final AdvancedCreationEntry weaponsRackS = createAdvancedEntry(10044, 218, 22, 724, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry weaponsRackP = createAdvancedEntry(10044, 218, 22, 725, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry armourStand = createAdvancedEntry(10044, 218, 22, 759, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry weaponsRackB = createAdvancedEntry(10044, 218, 22, 758, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry thatchingTool = createAdvancedEntry(10044, 217, 22, 774, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry wineBarrelRack = createAdvancedEntry(1005, 217, 860, 1108, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        wineBarrelRack.addRequirement(new CreationRequirement(1, 860, 1, true));
        final AdvancedCreationEntry smallBarrelRack = createAdvancedEntry(1005, 217, 860, 1109, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        smallBarrelRack.addRequirement(new CreationRequirement(1, 860, 1, true));
        final AdvancedCreationEntry planterRack = createAdvancedEntry(1005, 217, 860, 1110, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        planterRack.addRequirement(new CreationRequirement(1, 22, 4, true));
        final AdvancedCreationEntry amphoraRack = createAdvancedEntry(1005, 217, 860, 1111, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        amphoraRack.addRequirement(new CreationRequirement(1, 22, 4, true));
        final AdvancedCreationEntry emptyShelf = createAdvancedEntry(1005, 217, 860, 1412, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        if (Features.Feature.HIGHWAYS.isEnabled()) {
            ...
            final AdvancedCreationEntry waystone = createAdvancedEntry(10031, 97, 146, 1112, false, false, 10.0f, false, false, 0, 21.0, CreationCategories.HIGHWAY);
        ...
        final AdvancedCreationEntry archJournal = createAdvancedEntry(10017, 1409, 100, 1404, false, false, 0.0f, true, false, CreationCategories.WRITING);
        archJournal.addRequirement(new CreationRequirement(1, 100, 2, true));
        final AdvancedCreationEntry almanac = createAdvancedEntry(10017, 1409, 100, 1127, false, false, 0.0f, true, false, CreationCategories.WRITING);
        almanac.addRequirement(new CreationRequirement(1, 100, 2, true));
        if (Features.Feature.WAGONER.isEnabled()) {
            final AdvancedCreationEntry wagonerContainer = createAdvancedEntry(1005, 217, 860, 1309, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
            wagonerContainer.addRequirement(new CreationRequirement(1, 860, 1, true));
        }
        final AdvancedCreationEntry crateRack = createAdvancedEntry(1005, 217, 860, 1312, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        ...
        final AdvancedCreationEntry bsbRack = createAdvancedEntry(1005, 217, 860, 1315, false, false, 0.0f, true, true, CreationCategories.CONTAINER);
        bsbRack.addRequirement(new CreationRequirement(1, 860, 1, true));
        bsbRack.addRequirement(new CreationRequirement(2, 22, 6, true));
        final AdvancedCreationEntry bcu = createAdvancedEntry(10044, 217, 860, 1316, false, false, 0.0f, true, true, 35, 50.0, CreationCategories.CONTAINER);
        ...
        if (Features.Feature.TRANSPORTABLE_CREATURES.isEnabled()) {
            final AdvancedCreationEntry creatureCrate = createAdvancedEntry(1005, 22, 217, 1311, false, false, 0.0f, true, true, 0, 60.0, CreationCategories.STORAGE);
        ...
        final AdvancedCreationEntry tapestryEvening = createAdvancedEntry(10016, 926, 987, 1318, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryMclavin = createAdvancedEntry(10016, 926, 987, 1319, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        final AdvancedCreationEntry tapestryEhizellbob = createAdvancedEntry(10016, 926, 987, 1320, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        ...
        createAdvancedMetalicEntry(10015, 64, 220, 1341, false, true, 0.0f, false, false, CreationCategories.TOOLS, new CreationRequirement(1, 790, 3, true), new CreationRequirement(2, 100, 1, true));
        final AdvancedCreationEntry keepNet = createAdvancedEntry(1014, 188, 319, 1342, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry fishingNet = createAdvancedEntry(10016, 214, 214, 1343, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry fishingRod = createAdvancedEntry(10044, 1344, 23, 1346, false, false, 0.0f, true, false, CreationCategories.TOOLS);
        ...
        final AdvancedCreationEntry rackRods = createAdvancedEntry(1005, 218, 22, 1393, false, false, 0.0f, true, true, CreationCategories.STORAGE);
        rackRods.addRequirement(new CreationRequirement(1, 561, 7, true));
        rackRods.addRequirement(new CreationRequirement(2, 22, 9, true));
        final AdvancedCreationEntry bouy = createAdvancedEntry(1005, 189, 565, 1396, false, false, 0.0f, true, true, CreationCategories.DECORATION);
        bouy.addRequirement(new CreationRequirement(1, 23, 1, true));
        bouy.addRequirement(new CreationRequirement(2, 497, 1, true));
        final AdvancedCreationEntry pearlNecklace = createAdvancedEntry(10043, 214, 1397, 1399, false, false, 0.0f, true, false, CreationCategories.DECORATION);
        ...
        if (Features.Feature.CHICKEN_COOPS.isEnabled()) {
            final AdvancedCreationEntry chickenCoop = createAdvancedEntry(10044, 22, 217, 1432, false, false, 0.0f, true, true, 0, 50.0, CreationCategories.STORAGE);
        ...
        CreationEntryCreator.logger.info("Initialising the CreationEntries took " + (System.nanoTime() - start) / 1000000.0f + " millis.");
    }
    
    private static void createNewClothing(final int aArticle, final int aSource, final int aTarget, final int... components) {
        final AdvancedCreationEntry article = createAdvancedEntry(10016, aSource, aTarget, aArticle, false, false, 0.0f, true, false, 0, 10.0, CreationCategories.CLOTHES);
    ...
    public static void createBoatEntries() {
        if (!CreationEntryCreator.entriesCreated) {
            CreationEntryCreator.entriesCreated = true;
            final AdvancedCreationEntry lRowBoat = createAdvancedEntry(10082, 560, 560, 490, false, false, 0.0f, true, true, CreationCategories.SHIPS);
            ...
            final AdvancedCreationEntry lSailBoat = createAdvancedEntry(10082, 560, 560, 491, false, false, 0.0f, true, true, CreationCategories.SHIPS);
            ...
            final AdvancedCreationEntry lCorbita = createAdvancedEntry(10082, 560, 560, 541, false, false, 0.0f, true, true, CreationCategories.SHIPS);
            ...
            final AdvancedCreationEntry lCog = createAdvancedEntry(10082, 560, 560, 540, false, false, 0.0f, true, true, CreationCategories.SHIPS);
            ...
            final AdvancedCreationEntry lKnarr = createAdvancedEntry(10082, 560, 560, 542, false, false, 0.0f, true, true, CreationCategories.SHIPS);
            ...
            final AdvancedCreationEntry lCaravel = createAdvancedEntry(10082, 560, 560, 543, false, false, 0.0f, true, true, CreationCategories.SHIPS);
    ...
    public static CreationEntry createSimpleEntry(final int aPrimarySkill, final int aObjectSource, final int aObjectTarget, final int aObjectCreated, final boolean depleteSource, final boolean depleteTarget, final float aPercentageLost, final boolean depleteEqually, final boolean aCreateOnGround, final CreationCategories aCategory) {
        final CreationEntry entry = new SimpleCreationEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCategory);
        CreationMatrix.getInstance().addCreationEntry(entry);
        return entry;
    }
    
    public static CreationEntry createMetallicEntries(final int aPrimarySkill, final int aObjectSource, final int aObjectTarget, final int aObjectCreated, final boolean depleteSource, final boolean depleteTarget, final float aPercentageLost, final boolean depleteEqually, final boolean aCreateOnGround, final CreationCategories aCategory) {
        final CreationEntry defaultEntry = createSimpleEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCategory);
        if (ItemFactory.isMetalLump(aObjectTarget)) {
            for (final int targetTemplateId : ItemFactory.metalLumpList) {
                if (targetTemplateId != aObjectTarget) {
                    createSimpleEntry(aPrimarySkill, aObjectSource, targetTemplateId, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCategory);
                }
            }
        }
            ...
            for (final int sourceTemplateId : ItemFactory.metalLumpList) {
                if (sourceTemplateId != aObjectSource) {
                    createSimpleEntry(aPrimarySkill, sourceTemplateId, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCategory);
                }
            }
        }
        return defaultEntry;
    ...
    public static CreationEntry createSimpleEntry(final int aPrimarySkill, final int aObjectSource, final int aObjectTarget, final int aObjectCreated, final boolean depleteSource, final boolean depleteTarget, final float aPercentageLost, final boolean depleteEqually, final boolean aCreateOnGround, final int aCustomCreationCutOff, final double aMinimumSkill, final CreationCategories aCategory) {
        final CreationEntry entry = new SimpleCreationEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCustomCreationCutOff, aMinimumSkill, aCategory);
        CreationMatrix.getInstance().addCreationEntry(entry);
        return entry;
    }
    
    public static CreationEntry createMetallicEntries(final int aPrimarySkill, final int aObjectSource, final int aObjectTarget, final int aObjectCreated, final boolean depleteSource, final boolean depleteTarget, final float aPercentageLost, final boolean depleteEqually, final boolean aCreateOnGround, final int aCustomCreationCutOff, final double aMinimumSkill, final CreationCategories aCategory) {
        final CreationEntry defaultEntry = createSimpleEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCustomCreationCutOff, aMinimumSkill, aCategory);
        if (ItemFactory.isMetalLump(aObjectTarget)) {
            for (final int targetTemplateId : ItemFactory.metalLumpList) {
                if (targetTemplateId != aObjectTarget) {
                    createSimpleEntry(aPrimarySkill, aObjectSource, targetTemplateId, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCustomCreationCutOff, aMinimumSkill, aCategory);
                }
            }
        }
        else if (ItemFactory.isMetalLump(aObjectSource)) {
            for (final int sourceTemplateId : ItemFactory.metalLumpList) {
                if (sourceTemplateId != aObjectSource) {
                    createSimpleEntry(aPrimarySkill, sourceTemplateId, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCustomCreationCutOff, aMinimumSkill, aCategory);
                }
            }
        }
        return defaultEntry;
    ...
    public static AdvancedCreationEntry createAdvancedEntry(final int primarySkill, final int objectSource, final int objectTarget, final int objectCreated, final boolean depleteSource, final boolean depleteTarget, final float percentageLost, final boolean destroyBoth, final boolean createOnGround, final CreationCategories category) {
        final AdvancedCreationEntry entry = new AdvancedCreationEntry(primarySkill, objectSource, objectTarget, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
        CreationMatrix.getInstance().addCreationEntry(entry);
        return entry;
    }
    
    public static AdvancedCreationEntry createAdvancedEntry(final int primarySkill, final int objectSource, final int objectTarget, final int objectCreated, final boolean destroyTarget, final boolean useCapacity, final float percentageLost, final boolean destroyBoth, final boolean createOnGround, final int customCutOffChance, final double aMinimumSkill, final CreationCategories category) {
        final AdvancedCreationEntry entry = new AdvancedCreationEntry(primarySkill, objectSource, objectTarget, objectCreated, destroyTarget, useCapacity, percentageLost, destroyBoth, createOnGround, customCutOffChance, aMinimumSkill, category);
        CreationMatrix.getInstance().addCreationEntry(entry);
        return entry;
    }
    
    public static AdvancedCreationEntry createAdvancedMetalicEntry(final int primarySkill, final int objectSource, final int objectTarget, final int objectCreated, final boolean depleteSource, final boolean depleteTarget, final float percentageLost, final boolean destroyBoth, final boolean createOnGround, final CreationCategories category, final CreationRequirement... extras) {
        final AdvancedCreationEntry defaultEntry = createAdvancedEntry(primarySkill, objectSource, objectTarget, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
        for (final CreationRequirement extra : extras) {
            defaultEntry.addRequirement(extra);
        }
        if (ItemFactory.isMetalLump(objectTarget)) {
            for (final int targetTemplateId : ItemFactory.metalLumpList) {
                if (targetTemplateId != objectTarget) {
                    final AdvancedCreationEntry metalEntry = createAdvancedEntry(primarySkill, objectSource, targetTemplateId, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
                    for (final CreationRequirement extra2 : extras) {
                        metalEntry.addRequirement(extra2);
                    }
                }
            }
        }
            ...
            for (final int sourceTemplateId : ItemFactory.metalLumpList) {
                if (sourceTemplateId != objectSource) {
                    final AdvancedCreationEntry metalEntry = createAdvancedEntry(primarySkill, sourceTemplateId, objectTarget, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
                    for (final CreationRequirement extra2 : extras) {
                        metalEntry.addRequirement(extra2);
                    }
                }
    ...
    public static AdvancedCreationEntry createAdvancedMetalicEntry(final int primarySkill, final int objectSource, final int objectTarget, final int objectCreated, final boolean destroyTarget, final boolean useCapacity, final float percentageLost, final boolean destroyBoth, final boolean createOnGround, final int customCutOffChance, final double aMinimumSkill, final CreationCategories category, final CreationRequirement... extras) {
        final AdvancedCreationEntry defaultEntry = createAdvancedEntry(primarySkill, objectSource, objectTarget, objectCreated, destroyTarget, useCapacity, percentageLost, destroyBoth, createOnGround, customCutOffChance, aMinimumSkill, category);
        for (final CreationRequirement extra : extras) {
            defaultEntry.addRequirement(extra);
        }
        if (ItemFactory.isMetalLump(objectTarget)) {
            for (final int targetTemplateId : ItemFactory.metalLumpList) {
                if (targetTemplateId != objectTarget) {
                    final AdvancedCreationEntry metalEntry = createAdvancedEntry(primarySkill, objectSource, objectTarget, objectCreated, destroyTarget, useCapacity, percentageLost, destroyBoth, createOnGround, customCutOffChance, aMinimumSkill, category);
                    for (final CreationRequirement extra2 : extras) {
                        metalEntry.addRequirement(extra2);
                    }
                }
    ...
    static {
        logger = Logger.getLogger(CreationEntryCreator.class.getName());
        CreationEntryCreator.entriesCreated = false;
    }
}
