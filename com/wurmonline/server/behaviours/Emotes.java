...
{
    private static List<ActionEntry> defaultNiceEmotes;
    private static List<ActionEntry> defaultNeutralEmotes;
    private static List<ActionEntry> defaultOffensiveEmotes;
    private static List<ActionEntry> allEmotes;
    ...
    public static final ActionEntry[] emoteEntrys;
    
    private static void createDefaultNiceEmotes() {
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[0]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[1]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[2]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[3]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[4]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[5]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[6]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[7]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[8]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[9]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[10]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[11]);
        Emotes.defaultNiceEmotes.add(Emotes.emoteEntrys[12]);
    }
    
    private static void createDefaultNeutralEmotes() {
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[13]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[14]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[15]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[16]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[17]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[18]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[19]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[20]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[21]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[22]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[23]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[30]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[31]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[32]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[33]);
        Emotes.defaultNeutralEmotes.add(Emotes.emoteEntrys[34]);
    }
    
    private static void createDefaultOffensiveEmotes() {
        Emotes.defaultOffensiveEmotes.add(Emotes.emoteEntrys[24]);
        Emotes.defaultOffensiveEmotes.add(Emotes.emoteEntrys[25]);
        Emotes.defaultOffensiveEmotes.add(Emotes.emoteEntrys[26]);
        Emotes.defaultOffensiveEmotes.add(Emotes.emoteEntrys[27]);
        Emotes.defaultOffensiveEmotes.add(Emotes.emoteEntrys[28]);
        Emotes.defaultOffensiveEmotes.add(Emotes.emoteEntrys[29]);
    }
    
    static List<ActionEntry> getEmoteList() {
        return Emotes.allEmotes;
    }
    
    private static final void createEmoteList() {
        Emotes.allEmotes.add(new ActionEntry((short)(-3), "Emotes", "emoting", new int[] { 0 }));
        final List<ActionEntry> niceEmotes = getDefaultNiceEmotes();
        final List<ActionEntry> neutralEmotes = getDefaultNeutralEmotes();
        final List<ActionEntry> offensiveEmotes = getDefaultOffensiveEmotes();
        Emotes.allEmotes.add(new ActionEntry((short)(-niceEmotes.size()), "Nice", "emoting nice", new int[] { 0 }));
        for (final ActionEntry entry : niceEmotes) {
            Emotes.allEmotes.add(entry);
        }
        Emotes.allEmotes.add(new ActionEntry((short)(-neutralEmotes.size()), "Neutral", "emoting neutral", new int[] { 0 }));
        for (final ActionEntry entry : neutralEmotes) {
            Emotes.allEmotes.add(entry);
        }
        Emotes.allEmotes.add(new ActionEntry((short)(-offensiveEmotes.size()), "Offensive", "emoting offensive", new int[] { 0 }));
        for (final ActionEntry entry : offensiveEmotes) {
            Emotes.allEmotes.add(entry);
        }
    }
    
    private static List<ActionEntry> getDefaultNiceEmotes() {
        return Emotes.defaultNiceEmotes;
    }
    
    private static List<ActionEntry> getDefaultNeutralEmotes() {
        return Emotes.defaultNeutralEmotes;
    }
    
    private static List<ActionEntry> getDefaultOffensiveEmotes() {
        return Emotes.defaultOffensiveEmotes;
    }
    
    static void emoteAt(final short emote, final Creature performer, final Creature receiver) {
        ...
        String bcastString = "";
        final String pname = performer.getNameWithGenus();
        final String rname = receiver.getNameWithGenus();
        if (emote == 2000) {
            ...
            final String hisher = receiver.getHisHerItsString();
        ...
        if (performer.mayEmote()) {
            ...
            performer.playAnimation(Emotes.emoteEntrys[emote - 2000].getActionString().toLowerCase(), false);
        }
        ...
        if (receiver.hasTrait(10) && (Server.rand.nextInt(6) == 0 || Servers.localServer.testServer)) {
            ...
            if (performer.isWithinDistanceTo(receiver.getPosX(), receiver.getPosY(), receiver.getPositionZ() + receiver.getAltOffZ(), 5.0f, 0.0f) && Blocking.getBlockerBetween(receiver, performer, 5) == null) {
                try {
                    ...
                    Emotes.logger.log(Level.WARNING, ex.getMessage(), ex);
                }
            }
        }
    }
    
    static void emoteAt(final short emote, final Creature performer, final Item target) {
        final String pname = performer.getNameWithGenus();
        final String rname = target.getNameWithGenus();
        final boolean isBodyPart = target.isBodyPartAttached();
    ...
    static void emoteAt(final short emote, final Creature performer, final Wall wall) {
        final String pname = performer.getNameWithGenus();
        try {
            final Structure structure = Structures.getStructure(wall.getStructureId());
            final String rname = structure.getName();
            final int tilex = wall.getTileX();
            final int tiley = wall.getTileY();
            final int tilez = (int)(performer.getStatus().getPositionZ() + performer.getAltOffZ()) >> 2;
            if (!performer.isWithinTileDistanceTo(tilex, tiley, tilez, Emotes.emoteEntrys[emote - 2000].getRange() / 4)) {
    ...
    static void emoteAt(final short emote, final Creature performer, final Floor floor) {
        final String pname = performer.getNameWithGenus();
        try {
    ...
    static void emoteAt(final short emote, final Creature performer, final BridgePart brisgePart) {
        final String pname = performer.getNameWithGenus();
        try {
            final Structure structure = Structures.getStructure(brisgePart.getStructureId());
            final String rname = structure.getName();
            final int tilex = brisgePart.getTileX();
            final int tiley = brisgePart.getTileY();
            final int tilez = (int)(performer.getStatus().getPositionZ() + performer.getAltOffZ()) >> 2;
            if (!performer.isWithinTileDistanceTo(tilex, tiley, tilez, Emotes.emoteEntrys[emote - 2000].getRange() / 4)) {
                emote(emote, performer);
            }
    ...
    static void emoteAt(final short emote, final Creature performer, final Wound wound) {
        final String pname = performer.getNameWithGenus();
        final String rname = "a " + wound.getDescription() + " wound";
        emoteAt(emote, performer, pname, rname, null, false);
    }
    
    static void emoteAt(final short emote, final Creature performer, final Fence fence) {
        final String pname = performer.getNameWithGenus();
        final String rname = "a " + fence.getName();
    ...
    static void emoteAt(final short emote, final Creature performer, final int tilex, final int tiley, final int tilez, final int tile) {
    ...
    private static void emoteAt(final short emote, final Creature performer, final String pname, final String rname, @Nullable final Item item, final boolean isBodyPart) {
        String performerString = "";
        String bcastString = "";
        ...
        if (c != null) {
            possessionString = (ownerString = c.getNameWithGenus() + (c.getName().endsWith("s") ? "'" : "'s"));
        }
        if (emote == 2000) {
            if (isBodyPart) {
    ...
    static void emote(final short emote, final Creature performer) {
        String performerString = "";
        String bcastString = "";
        final String pname = performer.getNameWithGenus();
        if (emote == 2000) {
