...
public enum TakeResultEnum
{
    ...
    private TakeResultEnum(final boolean print, final boolean abortTakeFromPile, final boolean formatted) {
        this.texts = new ConcurrentHashMap<Long, String[]>();
        this.print = print;
    ...
    private TakeResultEnum(final boolean print, final boolean abortTakeFromPile, final boolean formatted, final boolean safePrint) {
        this.texts = new ConcurrentHashMap<Long, String[]>();
        this.print = print;
        this.abortTakeFromPile = abortTakeFromPile;
        this.formatted = formatted;
    ...
    private TakeResultEnum(final String message, final boolean print, final boolean abortTakeFromPile, final boolean formatted) {
        this.texts = new ConcurrentHashMap<Long, String[]>();
    ...
    private TakeResultEnum(final String message, final boolean print, final boolean abortTakeFromPile, final boolean formatted, final boolean safePrint) {
        this.texts = new ConcurrentHashMap<Long, String[]>();
        this.message = message;
        this.print = print;
        this.abortTakeFromPile = abortTakeFromPile;
    ...
    public final String getResultStringFormattedWith(final String text) {
        return StringUtil.format(this.message, text);
    }
    
    public final String getMessage(final long performerId) {
        if (this.haveMessageParameters() && this.texts.containsKey(performerId)) {
            final String[] vars = this.texts.get(performerId);
            this.texts.remove(performerId);
            return StringUtil.format(this.message, (Object[])vars);
        }
        return this.message;
    }
    ...
    public void setIndexText(final long performerId, final String... strings) {
    ...
    public void sendToPerformer(final Creature performer) {
        if (this.shouldPrint()) {
            if (this.safePrint) {
