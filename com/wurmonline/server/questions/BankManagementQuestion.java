...
public final class BankManagementQuestion extends Question implements MiscConstants, TimeConstants
{
    ...
    public BankManagementQuestion(final Creature aResponder, final String aTitle, final String aQuestion, final long aTarget, @Nullable final Bank aBank) {
    ...
    public void answer(final Properties answers) {
        ...
        if (!this.getResponder().isGuest()) {
            try {
                final Item token = Items.getItem(this.target);
                final Village village = Villages.getVillage(token.getData2());
                String key = "open";
        ...
        if (!this.getResponder().isGuest()) {
            if (this.bank == null) {
                ...
                if (this.bank.startedMoving > 0L) {
                    ...
                    try {
                        final Village village = this.bank.getCurrentVillage();
