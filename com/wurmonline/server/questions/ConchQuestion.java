...
public class ConchQuestion extends Question
{
    ...
    public ConchQuestion(final Creature aResponder, final long aTarget) {
    ...
    private static final boolean sendAchievementNeeded(final Creature responder, final StringBuilder buf, final Item conch) {
        final Achievements ach = Achievements.getAchievementObject(responder.getWurmId());
        ...
        return (conch.getAuxData() == 12 || ach.getAchievement(52) == null) && sendSeventhBml(responder, buf, 52, conch);
    }
    
    private static final boolean sendItemNeeded(final Creature responder, final StringBuilder buf, final Item conch) {
    ...
    public void answer(final Properties answers) {
        ...
        final String val = answers.getProperty("listen");
        if (Boolean.parseBoolean(val)) {
            ...
            final ConchQuestion newq = new ConchQuestion(this.getResponder(), this.conch.getWurmId());
    ...
    private static final void addBml(final Creature responder, final Item conch, final StringBuilder buf) {
    ...
    private static final boolean addFinalBml(final Creature responder, final StringBuilder buf, final Item conch) {
    ...
    private static final boolean sendFirstBml(final Creature responder, final StringBuilder buf, final int templateId, final Item conch) {
    ...
    public final void sendAfterFirstBml(final Creature responder, final StringBuilder buf, final Item conch) {
        String tome = "tome";
        try {
            final ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(conch.getData1());
            tome = template.getName();
        }
        catch (Exception ex) {}
        buf.append("text{text=\"'You should look for a " + tome + ".\"}text{text=\"\"}");
        final Item item = this.getItemToSend(conch.getData1());
        if (item == null) {
            ...
            buf.append("text{text=\"'Look in the sky. We have created a colored spirit light for you to follow', the " + addSpiritVoiceType(responder) + " whispers.\"}text{text=\"\"}");
        }
    ...
    private static final boolean sendSecondBml(final Creature responder, final StringBuilder buf, final int templateId, final Item conch) {
        conch.setData1(templateId);
        conch.setAuxData((byte)2);
    ...
    public final void sendAfterSecondBml(final Creature responder, final StringBuilder buf, final Item conch) {
        String tome = "tome";
        try {
            final ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(conch.getData1());
            tome = template.getName();
        ...
        if (item == null) {
            ...
            this.sendSignalToItemTemplate(item);
            buf.append("text{text=\"'We have created a colored spirit light for you to follow', the " + addSpiritVoiceType(responder) + " whispers.\"}text{text=\"\"}");
        }
        buf.append("text{text=\"'Listen to this shell again if you require guidance.\"}text{text=\"\"}");
    ...
    private static final boolean sendThirdBml(final Creature responder, final StringBuilder buf, final int templateId, final Item conch) {
        conch.setData1(templateId);
        conch.setAuxData((byte)4);
    ...
    public final void sendAfterThirdBml(final Creature responder, final StringBuilder buf, final Item conch) {
        String tome = "tome";
        try {
            final ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(conch.getData1());
            tome = template.getName();
    ...
    private static final boolean sendFourthBml(final Creature responder, final StringBuilder buf, final int templateId, final Item conch) {
        conch.setData1(templateId);
        conch.setAuxData((byte)6);
    ...
    public final void sendAfterFourthBml(final Creature responder, final StringBuilder buf, final Item conch) {
        String tome = "tome";
        try {
            final ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(conch.getData1());
            tome = template.getName();
    ...
    private static final boolean sendFifthBml(final Creature responder, final StringBuilder buf, final int templateId, final Item conch) {
        conch.setData1(templateId);
        conch.setAuxData((byte)8);
    ...
    public final void sendAfterFifthBml(final Creature responder, final StringBuilder buf, final Item conch) {
        String tome = "tome";
        try {
            final ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(conch.getData1());
            tome = template.getName();
        ...
        if (item == null) {
            ...
            this.sendSignalToItemTemplate(item);
            buf.append("text{text=\"'This spirit light will show you to the last thing you need to find.', says the " + addSpiritVoiceType(responder) + ".\"}text{text=\"\"}");
        }
        buf.append("text{text=\"'Godspeed.'\"}text{text=\"\"}");
        buf.append("text{text=\"The voice grows silent.\"}text{text=\"\"}");
    }
    
    private static final boolean sendSixthBml(final Creature responder, final StringBuilder buf, final int achievementId, final Item conch) {
        ...
        buf.append("text{text=\"'It is a test we do to honour Ceyer since he himself understood his cowardness', the " + addSpiritVoiceType(responder) + " explains.\"}text{text=\"\"}");
    ...
    public static final void sendAfterSixthBml(final Creature responder, final StringBuilder buf, final Item conch) {
        sendSignalToHota(conch, responder);
        buf.append("text{text=\"There should be a light guiding your way', the " + addSpiritVoiceType(responder) + " says. 'Let us show you the way to the area where the Hunt Of The Ancients take place.'\"}text{text=\"\"}");
        buf.append("text{text=\"'Good Hunting!'\"}text{text=\"\"}");
        buf.append("text{text=\"The voice grows silent.\"}text{text=\"\"}");
    }
    
    private static final boolean sendSeventhBml(final Creature responder, final StringBuilder buf, final int achievementId, final Item conch) {
        conch.setData1(achievementId);
        conch.setAuxData((byte)12);
        buf.append("text{text=\"'The hidden entrance to the place where the container with Ceyer's Key lies hidden is one task away now', concludes " + addSpiritVoiceType(responder) + ".\"}text{text=\"\"}");
    ...
    public static final void sendAfterSeventhBml(final Creature responder, final StringBuilder buf, final Item conch) {
        buf.append("text{text=\"There will be no light this time', says the " + addSpiritVoiceType(responder) + ". 'We will save our energy for the final push.'\"}text{text=\"\"}");
    ...
    public static final boolean isThisAdventureServer() {
        try {
            final Item i = Items.getItem(5390755858690L);
    ...
    public static final String addSpiritVoiceType(final Creature responder) {
        final int spirit = Zones.getSpiritsForTile(responder.getTileX(), responder.getTileY(), responder.isOnSurface());
    ...
    public static final void sendSignalToEntrance(final Creature responder, final Item conch) {
        if (isThisAdventureServer() && responder.isPlayer()) {
            final Player presp = (Player)responder;
            final int x = 822;
            final int y = 493;
    ...
    public static final void sendSignalToHota(final Item conch, final Creature responder) {
        final FocusZone hota = FocusZone.getHotaZone();
        if (responder.isPlayer()) {
            final Player presp = (Player)responder;
            if (hota != null) {
                final int cx = hota.getStartX() + (hota.getEndX() - hota.getStartX()) / 2;
                final int cy = hota.getStartY() + (hota.getEndY() - hota.getStartY()) / 2;
                float posz = 10.0f;
                try {
    ...
    private final Item getItemToSend(final int templateId) {
        final LinkedList<Item> availItems = new LinkedList<Item>();
        ...
        if (availItems.size() > 0) {
            final int num = Server.rand.nextInt(availItems.size());
            return availItems.get(num);
        }
        return null;
    }
    
    public final void sendSignalToItemTemplate(final Item item) {
        if (this.getResponder().isPlayer() && item != null) {
            final Player presp = (Player)this.getResponder();
