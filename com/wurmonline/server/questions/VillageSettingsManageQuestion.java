...
public final class VillageSettingsManageQuestion extends Question implements VillageStatus, TimeConstants
{
    ...
    public VillageSettingsManageQuestion(final Creature aResponder, final String aTitle, final String aQuestion, final long aTarget) {
    ...
    public void sendQuestion() {
        try {
            ...
            if (Features.Feature.HIGHWAYS.isEnabled()) {
                ...
                final boolean hasKOS = village.getReputations().length > 0;
                final String disable = ";enabled=\"false\"";
                String hover = "";
                String en = "";
                ch = "";
            ...
            VillageSettingsManageQuestion.logger.log(Level.WARNING, "Failed to locate village deed with id " + this.target, nsi);
            ...
            VillageSettingsManageQuestion.logger.log(Level.WARNING, "Failed to locate village for deed with id " + this.target, nsv);
    ...
    static {
        logger = Logger.getLogger(VillageSettingsManageQuestion.class.getName());
    }
}
