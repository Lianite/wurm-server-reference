...
{
    public TraderRentalQuestion(final Creature aResponder, final String aTitle, final String aQuestion, final long aTarget) {
    ...
    public void sendQuestion() {
        boolean citiz = false;
        final Village v = this.getResponder().getCurrentTile().getVillage();
        if (v != null) {
            citiz = true;
        }
