...
public final class PlayerProfileQuestion extends Question
{
    ...
    public PlayerProfileQuestion(final Creature aResponder) {
    ...
    public void answer(final Properties aAnswer) {
        ...
        if (this.type == 0) {
            PlayerProfileQuestion.logger.log(Level.INFO, "Received answer for a question with NOQUESTION.");
            return;
        }
        if (this.type == 106) {
            ...
            final boolean seeCA = ((Player)this.getResponder()).seesPlayerAssistantWindow();
            if (seeCA != opt) {
                if (opt) {
            ...
            final boolean sendextra = Boolean.parseBoolean(aAnswer.getProperty("sendextra"));
            ((Player)this.getResponder()).setSendExtraBytes(sendextra);
            opt = Boolean.parseBoolean(aAnswer.getProperty("opt22"));
            final boolean seeGV = ((Player)this.getResponder()).seesGVHelpWindow();
            if (seeGV != opt) {
                if (opt) {
    ...
    public void checkFlag(final int oldFlag, final boolean newFlag, final boolean state, final String what) {
        if (oldFlag == 44 && this.getResponder().getVehicle() != -10L && !this.getResponder().isVehicleCommander() && !((Player)this.getResponder()).isBlockingPvP()) {
            try {
                final Item bItem = Items.getItem(this.getResponder().getVehicle());
                if (bItem.isBoat()) {
        ...
        if (this.getResponder().hasFlag(oldFlag) != newFlag) {
            ...
            final String oo = (newFlag == state) ? "on " : "off ";
    ...
    public void sendQuestion() {
        ...
        buf.append("label{text=\"1. Incoming PMs\"};radio{group=\"opt1\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(1) + "\";text=\"Allow\"};radio{group=\"" + "opt1" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(1) + "\";text=\"Disallow\"};");
        buf.append("label{text=\"2. Cross-Kingdoms\"};radio{group=\"opt2\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(2) + "\";text=\"Same Only\"};radio{group=\"" + "opt2" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(2) + "\";text=\"Any\"};");
        buf.append("label{text=\"3. Cross-Servers\"};radio{group=\"opt3\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(3) + "\";text=\"Local Only\"};radio{group=\"" + "opt3" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(3) + "\";text=\"Any\"};");
        buf.append("label{text=\"4. Friends-Override\"};radio{group=\"opt4\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(4) + "\";text=\"Always\"};radio{group=\"" + "opt4" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(4) + "\";text=\"Never\"};");
        buf.append("}");
        buf.append("text{text=\"\"}");
        ...
        buf.append("label{text=\"1. Equip options\"};radio{group=\"opt5\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(7) + "\";text=\"Show\"};radio{group=\"" + "opt5" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(7) + "\";text=\"Hide\"};");
        if (Server.getInstance().isPS() || !Servers.localServer.isChallengeOrEpicServer()) {
            buf.append("label{text=\"2. Block PvP Crossing\"};radio{group=\"opt21\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(44) + "\";text=\"On\"};radio{group=\"" + "opt21" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(44) + "\";text=\"Off\"};");
        }
        buf.append("}");
        buf.append("text{text=\"\"}");
        buf.append("text{type=\"bold\";text=\"Other Chat Options (show is default)\"}");
        buf.append("table{rows=\"2\";cols=\"6\";");
        buf.append("label{text=\"1. Kingdom Chat\"};radio{group=\"opt6\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(29) + "\";text=\"Show\"};radio{group=\"" + "opt6" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(29) + "\";text=\"Hide\"};label{text=\" | Startup Message\"}radio{group=\"" + "opt7" + "\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(35) + "\";text=\"Show\"};radio{group=\"" + "opt7" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(35) + "\";text=\"Hide\"};");
        buf.append("label{text=\"2. Global Kingdom Chat\"};radio{group=\"opt8\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(30) + "\";text=\"Show\"};radio{group=\"" + "opt8" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(30) + "\";text=\"Hide\"};label{text=\" | Startup Message\"}radio{group=\"" + "opt9" + "\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(36) + "\";text=\"Show\"};radio{group=\"" + "opt9" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(36) + "\";text=\"Hide\"};");
        buf.append("label{text=\"3. Global Trade Channel\"};radio{group=\"opt10\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(31) + "\";text=\"Show\"};radio{group=\"" + "opt10" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(31) + "\";text=\"Hide\"};label{text=\" | Startup Message\"}radio{group=\"" + "opt11" + "\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(37) + "\";text=\"Show\"};radio{group=\"" + "opt11" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(37) + "\";text=\"Hide\"};");
        final boolean seeCA = ((Player)this.getResponder()).seesPlayerAssistantWindow();
        buf.append("label{text=\"4. CA Help\"};radio{group=\"opt16\";id=\"true\";selected=\"" + seeCA + "\";text=\"Show\"};radio{group=\"" + "opt16" + "\";id=\"false\";selected=\"" + !seeCA + "\";text=\"Hide\"};label{text=\"\"}label{text=\"\"};label{text=\"\"};");
        if (((Player)this.getResponder()).maySeeGVHelpWindow()) {
            final boolean seeGVHelp = ((Player)this.getResponder()).seesGVHelpWindow();
            buf.append("label{text=\"5. GV Help\"};radio{group=\"opt22\";id=\"true\";selected=\"" + seeGVHelp + "\";text=\"Show\"};radio{group=\"" + "opt22" + "\";id=\"false\";selected=\"" + !seeGVHelp + "\";text=\"Hide\"};label{text=\"\"}label{text=\"\"};label{text=\"\"};");
        }
        buf.append("}");
        buf.append("text{text=\"\"}");
        buf.append("text{type=\"bold\";text=\"Your Corpse Lootability (allow is default)\"}");
        buf.append("table{rows=\"3\";cols=\"3\";");
        buf.append("label{text=\"1. Alliance\"};radio{group=\"opt17\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(32) + "\";text=\"Allow\"};radio{group=\"" + "opt17" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(32) + "\";text=\"Deny\"};");
        buf.append("label{text=\"2. Village\"};radio{group=\"opt18\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(33) + "\";text=\"Allow\"};radio{group=\"" + "opt18" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(33) + "\";text=\"Deny\"};");
        buf.append("label{text=\"3. Trusted Friends\"};radio{group=\"opt19\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(34) + "\";text=\"Allow\"};radio{group=\"" + "opt19" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(34) + "\";text=\"Deny\"};");
        buf.append("}");
        buf.append("text{text=\"\"}");
        buf.append("text{type=\"bold\";text=\"Other Settings\"}");
        buf.append("table{rows=\"2\";cols=\"3\";");
        buf.append("label{text=\"1. Sleep Bonus Idle Timeout (" + Server.getTimeFor(600000L) + ")\"};radio{group=\"" + "opt20" + "\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(43) + "\";text=\"On\"};radio{group=\"" + "opt20" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(43) + "\";text=\"Off\"};");
        if (!this.getResponder().hasFlag(53)) {
            buf.append("label{text=\"2. Fix Cooking Affinities\"};radio{group=\"opt23\";id=\"true\";selected=\"" + this.getResponder().hasFlag(53) + "\";text=\"On\"};radio{group=\"" + "opt23" + "\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(53) + "\";text=\"Off\"};");
        }
        else {
        ...
        buf.append("label{text=\"3. Wagoner Chat\"};radio{group=\"opt24\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(54) + "\";text=\"Hear\"};radio{group=\"" + "opt24" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(54) + "\";text=\"Ignore\"};");
        buf.append("label{text=\"4. Show Other Player Titles\"};radio{group=\"opt25\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(56) + "\";text=\"Show\"};radio{group=\"" + "opt25" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(56) + "\";text=\"Hide\"};");
        buf.append("label{text=\"5. Show Other Player Villages\"};radio{group=\"opt26\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(57) + "\";text=\"Show\"};radio{group=\"" + "opt26" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(57) + "\";text=\"Hide\"};");
        buf.append("label{text=\"6. Show Own Village Titles\"};radio{group=\"opt27\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(58) + "\";text=\"Show\"};radio{group=\"" + "opt27" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(58) + "\";text=\"Hide\"};");
        buf.append("label{text=\"7. Participate in PvE Deaths tab on Dying\"};radio{group=\"opt28\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(59) + "\";text=\"Show\"};radio{group=\"" + "opt28" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(59) + "\";text=\"Hide\"};");
        buf.append("label{text=\"8. Ignore the PvE Deaths Tab\"};radio{group=\"opt29\";id=\"false\";selected=\"" + !this.getResponder().hasFlag(60) + "\";text=\"Show\"};radio{group=\"" + "opt29" + "\";id=\"true\";selected=\"" + this.getResponder().hasFlag(60) + "\";text=\"Hide\"};");
        buf.append("}");
    ...
    static {
        logger = Logger.getLogger(PlayerProfileQuestion.class.getName());
    }
}
