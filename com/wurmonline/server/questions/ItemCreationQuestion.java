...
public final class ItemCreationQuestion extends Question
{
    ...
    public ItemCreationQuestion(final Creature aResponder, final String aTitle, final String aQuestion, final long aTarget) {
        super(aResponder, aTitle, aQuestion, 5, aTarget);
        this.itemplates = new LinkedList<ItemTemplate>();
        this.filter = "*";
    }
    
    public ItemCreationQuestion(final Creature aResponder, final String aTitle, final String aQuestion, final long aTarget, final String aFilter) {
        super(aResponder, aTitle, aQuestion, 5, aTarget);
        this.itemplates = new LinkedList<ItemTemplate>();
        this.filter = aFilter;
    }
    ...
    public void answer(final Properties answers) {
        ...
        if (val != null && val.equals("true")) {
            ...
            final ItemCreationQuestion icq = new ItemCreationQuestion(this.getResponder(), this.title, this.question, this.target, val);
            icq.sendQuestion();
        }
        else {
    ...
    ItemTemplate getTemplate(final int aTemplateId) {
