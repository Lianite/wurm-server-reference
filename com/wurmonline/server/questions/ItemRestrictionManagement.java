...
public class ItemRestrictionManagement extends Question
{
    ...
    public ItemRestrictionManagement(final Creature aResponder, final Permissions.IAllow aObj, final long aTargetId) {
        super(aResponder, "Manage Item Restrictions", makeQuestion(aResponder, aObj, aTargetId), 122, aTargetId);
        this.obj = aObj;
    }
    
    private static String makeQuestion(final Creature aResponder, final Permissions.IAllow aObj, final long aTargetId) {
        String named = "";
    ...
    public void answer(final Properties aAnswer) {
        ...
        if (this.type == 0) {
            ItemRestrictionManagement.logger.log(Level.INFO, "Received answer for a question with NOQUESTION.");
            return;
        }
        if (this.type == 122 && this.getResponder().getPower() >= 2) {
            final String itemName = "The " + this.obj.getName() + " ";
            boolean change = false;
            boolean spellremoved = false;
            boolean spelladded = true;
            if (this.obj.canHaveCourier()) {
                final boolean courier = Boolean.parseBoolean(aAnswer.getProperty("courier"));
                final boolean darkmessenger = Boolean.parseBoolean(aAnswer.getProperty("darkmessenger"));
                final String spow = aAnswer.getProperty("pow");
                if (courier && darkmessenger) {
                    ...
                    final Item item = (Item)this.obj;
                    if (spell != null) {
                        final byte ench = spell.getEnchantment();
                        final SpellEffect eff = item.getSpellEffect(ench);
                        if (eff != null) {
                    ...
                    if (spell != null) {
                        spell.castSpell(pow, this.getResponder(), item);
                        spelladded = true;
                    }
                }
            }
            if (this.obj.canBeSealedByPlayer() || this.obj.canBePeggedByPlayer() || this.canGMSeal()) {
                final boolean sealed = Boolean.parseBoolean(aAnswer.getProperty("sealed"));
            ...
            if (this.obj.canBeAutoFilled()) {
                final boolean autoFill = Boolean.parseBoolean(aAnswer.getProperty("autofill"));
            ...
            if (this.obj.canBeAutoLit()) {
                final boolean autoLight = Boolean.parseBoolean(aAnswer.getProperty("autolight"));
            ...
            if (this.obj.canBeAlwaysLit()) {
                final boolean alwaysLit = Boolean.parseBoolean(aAnswer.getProperty("alwaysLit"));
            ...
            if (this.obj.canDisableDecay()) {
                final boolean noDecay = Boolean.parseBoolean(aAnswer.getProperty("noDecay"));
            ...
            if (this.obj.canDisableEatAndDrink()) {
                final boolean noEatOrDrink = Boolean.parseBoolean(aAnswer.getProperty("noEatOrDrink"));
            ...
            if (this.obj.canDisableTake()) {
                final boolean noTake = Boolean.parseBoolean(aAnswer.getProperty("noTake"));
            ...
            if (this.obj.canDisableSpellTarget()) {
                final boolean noSpells = Boolean.parseBoolean(aAnswer.getProperty("noSpells"));
            ...
            if (this.obj.canDisableDestroy()) {
                final boolean noDestroy = Boolean.parseBoolean(aAnswer.getProperty("noDestroy"));
            ...
            if (this.obj.canDisableLocking()) {
                final boolean noLock = Boolean.parseBoolean(aAnswer.getProperty("noLock"));
            ...
            if (this.obj.canDisableLockpicking()) {
                final boolean noLockpick = Boolean.parseBoolean(aAnswer.getProperty("noLockpick"));
            ...
            if (this.obj.canDisableMoveable()) {
                final boolean noMove = Boolean.parseBoolean(aAnswer.getProperty("noMove"));
            ...
            if (this.obj.canDisableTurning()) {
                final boolean noTurn = Boolean.parseBoolean(aAnswer.getProperty("noTurn"));
            ...
            if (this.obj.canDisableOwnerMoveing()) {
                final boolean ownerMove = Boolean.parseBoolean(aAnswer.getProperty("ownerMove"));
            ...
            if (this.obj.canDisableOwnerTurning()) {
                final boolean ownerTurn = Boolean.parseBoolean(aAnswer.getProperty("ownerTurn"));
            ...
            if (this.obj.canDisablePainting()) {
                final boolean noPaint = Boolean.parseBoolean(aAnswer.getProperty("noPaint"));
            ...
            if (this.obj.canDisableRuneing()) {
                final boolean noRunes = Boolean.parseBoolean(aAnswer.getProperty("noRunes"));
            ...
            if (this.obj.canDisableImprove()) {
                final boolean noImprove = Boolean.parseBoolean(aAnswer.getProperty("noImprove"));
            ...
            if (this.obj.canDisableRepair()) {
                final boolean noRepair = Boolean.parseBoolean(aAnswer.getProperty("noRepair"));
            ...
            if (this.obj.canDisableDrag()) {
                final boolean noDrag = Boolean.parseBoolean(aAnswer.getProperty("noDrag"));
            ...
            if (this.obj.canDisableDrop()) {
                final boolean noDrop = Boolean.parseBoolean(aAnswer.getProperty("noDrop"));
            ...
            if (this.obj.canDisableRepair()) {
                final boolean noPut = Boolean.parseBoolean(aAnswer.getProperty("noPut"));
            ...
            if (this.obj.canBePlanted()) {
                final boolean plant = Boolean.parseBoolean(aAnswer.getProperty("planted"));
                if (plant != this.obj.isPlanted()) {
                    if (this.obj instanceof Item && !plant && ((Item)this.obj).isRoadMarker()) {
                        final Item theTarget = (Item)this.obj;
            ...
            if (val != null && val.length() > 0) {
                try {
                    final double newQL = Double.parseDouble(val);
            ...
            if (val != null && val.length() > 0) {
                try {
                    final double newDMG = Double.parseDouble(val);
    ...
    public void sendQuestion() {
        ...
        if (this.obj.canHaveCourier()) {
            ...
            if (spell != null) {
                final byte ench = spell.getEnchantment();
                final SpellEffect eff = ((Item)this.obj).getSpellEffect(ench);
                if (eff != null) {
                    pow = (int)eff.getPower();
                }
            }
        }
        final String blank = "image{src=\"img.gui.bridge.blank\";size=\"160,2\";text=\"\"}";
        buf.append("text{text=\"\"}");
        buf.append("label{type=\"bold\";text=\"Attributes / Restrictions\"}");
        buf.append("table{rows=\"5\";cols=\"4\";");
        buf.append(permission("alwaysLit", this.obj.isAlwaysLit(), "Always Lit", this.obj.canBeAlwaysLit(), "Ticked if item will always be lit.", "Item is always lit.", "Item cannot be always lit."));
        buf.append(permission("autofill", this.obj.isAutoFilled(), "Auto-Fill", this.obj.canBeAutoFilled(), "Ticked if item will auto-fill. Wells or Fountains (only).", "Item is always Auto-Filled.", "Item cannot be Auto-Filled."));
        buf.append(permission("autolight", this.obj.isAutoLit(), "Auto-Lights", this.obj.canBeAutoLit(), "Ticked if item will auto-light.", "Item is always Auto-Lit.", "Item cannot be Auto-Lit."));
        buf.append(permission("noDecay", this.obj.hasNoDecay(), "Decay Disabled", this.obj.canDisableDecay(), "Tick to disable decay on this item.", "Item always has decay disabled.", "Item cannot have decay disabled."));
        buf.append(permission("noDestroy", this.obj.isIndestructible(), "No Destroy / Bash", this.obj.canDisableDestroy(), "Tick to disallow bashing/destroying of this item.", "Item is always Indestructable.", "Item cannot be made Industrictable."));
        buf.append(permission("noDrag", this.obj.isNoDrag(), "No Drag", this.obj.canDisableDrag(), "Tick to disallow dragging of this item.", "Item is always not draggable.", "Item cannot be made not draggable."));
        buf.append(permission("noDrop", this.obj.isNoDrop(), "No Drop", this.obj.canDisableDrop(), "Tick to disallow dropping of this item.", "Item is always not droppable.", "Item cannot be made not droppable."));
        buf.append(permission("noEatOrDrink", this.obj.isNoEatOrDrink(), "No Eat Or Drink", this.obj.canDisableEatAndDrink(), "Tick to disallow eating and drinking of this item.", "Item is always not eatable or drinkable.", "Item cannot be made not eatable or drinkable."));
        buf.append(permission("noPut", this.obj.isNoPut(), "No Put", this.obj.canDisablePut(), "Tick to disallow putting items in this item.", "Item is always noPut.", "Item cannot be made noPut."));
        buf.append(permission("noSpells", this.obj.isNotSpellTarget(), "No Spells", this.obj.canDisableSpellTarget(), "Tick to disallow spells to be cast on this item.", "Item cannot accept spells anyway.", "Item cannot be made to not be a spell target."));
        buf.append(permission("noTake", this.obj.isNoTake(), "No Take", this.obj.canDisableTake(), "Tick to override the No Take.", "Item is always No Take.", "Item cannot be made No Take."));
        buf.append(permission("noImprove", this.obj.isNoImprove(), "Not Improvable", this.obj.canDisableImprove(), "Tick to disallow improving of this item.", "Item is always not improvable.", "Item cannot be made not improvable."));
        buf.append(permission("noLock", this.obj.isNotLockable(), "Not Lockable", this.obj.canDisableLocking(), "Tick to disallow locking of this item.", "Item is always not lockable.", "Item cannot be made not lockable."));
        ...
        buf.append(permission("noMove", this.obj.isNoMove(), "Not Moveable", this.obj.canDisableMoveable(), "Tick to disallow movement of this item.", "Item is always not moveable.", "Item cannot be made not moveable."));
        buf.append(permission("noPaint", this.obj.isNotPaintable(), "Not Paintable", this.obj.canDisablePainting(), "Tick to disallow painting of this item.", "Item is always not paintable.", "Item cannot be made not paintable."));
        buf.append(permission("noRepair", this.obj.isNoRepair(), "Not Repairable", this.obj.canDisableRepair(), "Tick to disallow repairing of this item.", "Item is always not repairable.", "Item cannot be made not repairable."));
        buf.append(permission("noRunes", this.obj.isNotRuneable(), "Not Runeable", this.obj.canDisableRuneing(), "Tick to disallow runeing of this item.", "Item is always not runeable.", "Item cannot be made not runeable."));
        buf.append(permission("noTurn", this.obj.isNotTurnable(), "Not Turnable", this.obj.canDisableTurning(), "Tick to disallow turning of this item.", "Item is always not turnable.", "Item cannot be made not turnable."));
        buf.append(permission("ownerTurn", this.obj.isOwnerTurnable(), "Owner Turnable", this.obj.canDisableOwnerTurning(), "Tick to disallow owner turning of this item.", "Item is always not turnable by owner.", "Item cannot be made not turnable by owner."));
        buf.append(permission("ownerMove", this.obj.isOwnerMoveable(), "Owner Moveable", this.obj.canDisableOwnerMoveing(), "Tick to disallow owner moveing of this item.", "Item is always not moveable by owner.", "Item cannot be made not moveable by owner."));
        buf.append(permission("planted", this.obj.isPlanted(), "Planted", this.obj.canBePlanted(), "Ticked if item is planted.", "Item is always planted.", "Item cannot be planted."));
        buf.append(permission("sealed", this.obj.isSealedByPlayer(), "Sealed", this.obj.canBeSealedByPlayer() || this.obj.canBePeggedByPlayer() || this.canGMSeal(), "Ticked if item is sealed by player.", "Item is always sealed.", "Item cannot be sealed by player."));
        buf.append("label{text=\"\"}");
        buf.append(permission("courier", this.obj.hasCourier(), "Has Courier", this.obj.canHaveCourier(), "Ticked it Courier has been cast on it.", "Item always has courier.", "Item cannot have courier."));
        buf.append(permission("darkmessenger", this.obj.hasDarkMessenger(), "Has Dark Messenger", this.obj.canHaveDakrMessenger(), "Ticked if Dark Messenger has been cast on it.", "Item always has dark messeneger.", "Item cannot have dark messenger."));
    ...
    private static String permission(final String sid, final boolean selected, final String text, final boolean enabled, final String hover, final String always, final String never) {
        if (enabled) {
    ...
    private boolean canGMSeal() {
        if (WurmId.getType(this.target) == 2) {
            ...
            if (item.getTemplateId() == 768) {
                final Item[] contains = item.getItemsAsArray();
    ...
    static {
        logger = Logger.getLogger(ItemRestrictionManagement.class.getName());
    }
}
