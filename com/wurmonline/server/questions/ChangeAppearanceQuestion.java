...
public final class ChangeAppearanceQuestion extends Question
{
    ...
    public ChangeAppearanceQuestion(final Creature aResponder, final Item aItem) {
    ...
    private void handleGenderChange() {
        if (this.getResponder().getSex() != this.gender) {
            ...
            try {
                ...
                ChangeAppearanceQuestion.logger.warning("Error setting face for player " + player.getName() + ": " + ex.getMessage());
                return;
            }
    ...
    public void answer(final Properties answers) {
        ...
        if (answers.getProperty("confirm", "").equals("yes")) {
            ...
            final ChangeAppearanceQuestion question = new ChangeAppearanceQuestion(this.getResponder(), this.mirror);
