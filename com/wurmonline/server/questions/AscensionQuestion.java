...
public class AscensionQuestion extends Question implements MiscConstants
{
    ...
    public AscensionQuestion(final Creature aResponder, final long aTarget, final String _deityName) {
    ...
    public static final String getNewPrefix(final String currentName) {
        final int hash = currentName.hashCode();
        final Random r = new Random(hash);
        final int result = r.nextInt(20);
        String prefix = "Evi";
        switch (result) {
            case 0: {
                prefix = "Ana";
