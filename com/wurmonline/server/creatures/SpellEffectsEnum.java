...
public enum SpellEffectsEnum
{
    ...
    private SpellEffectsEnum(final long id, final String name, final int typeId, final byte effectType, final byte influence, final boolean sendDuration) {
        this.id = id;
        this.name = name;
        this.typeId = typeId;
    ...
    private SpellEffectsEnum(final long id, final String name, final int typeId, final byte effectType, final byte influence) {
        this.id = id;
        this.name = name;
        this.typeId = typeId;
        this.effectType = effectType;
    ...
    private SpellEffectsEnum(final long id, final String name, final int typeId, final boolean sendToBuffBar, final byte effectType, final byte influence) {
        this.id = id;
        this.name = name;
        this.typeId = typeId;
    ...
    public static final SpellEffectsEnum getResistanceForSpell(final short spellActionId) {
        switch (spellActionId) {
            case 418: {
                return SpellEffectsEnum.RES_TENTACLES;
            }
            case 450: {
                return SpellEffectsEnum.RES_DISPEL;
            }
            case 255: {
                return SpellEffectsEnum.RES_DRAINHEALTH;
            }
            case 254: {
                return SpellEffectsEnum.RES_DRAINSTAMINA;
            }
            case 424: {
                return SpellEffectsEnum.RES_FIREHEART;
            }
            case 420: {
                return SpellEffectsEnum.RES_FIREPILLAR;
            }
            case 433: {
                return SpellEffectsEnum.RES_FUNGUSTRAP;
            }
            case 249: {
                return SpellEffectsEnum.RES_HEAL;
            }
            case 414: {
                return SpellEffectsEnum.RES_ICEPILLAR;
            }
            case 438: {
                return SpellEffectsEnum.RES_LIGHTOFFO;
            }
            case 432: {
                return SpellEffectsEnum.RES_PAINRAIN;
            }
            case 428: {
                return SpellEffectsEnum.RES_ROTTINGGUT;
            }
            case 448: {
                return SpellEffectsEnum.RES_SCORNLIBILA;
            }
            case 485: {
                return SpellEffectsEnum.RES_SHARDOFICE;
            }
            case 252: {
                return SpellEffectsEnum.RES_SMITE;
            }
            case 429: {
                return SpellEffectsEnum.RES_WEAKNESS;
            }
            default: {
                if (spellActionId == SpellEffectsEnum.STUNNED.getTypeId()) {
                    return SpellEffectsEnum.RES_STUNNED;
                }
                return SpellEffectsEnum.RES_GENERIC;
            }
        }
    }
    
    public static final byte getDebuffForEnum(final SpellEffectsEnum checkedEnum) {
        switch (checkedEnum) {
    ...
    public long createId(final long modifier) {
    ...
    public static final SpellEffectsEnum getEnumByName(final String name) {
        for (int i = 0; i < SpellEffectsEnum.effects.length; ++i) {
            if (SpellEffectsEnum.effects[i].getName().equalsIgnoreCase(name)) {
                return SpellEffectsEnum.effects[i];
            }
        }
        return SpellEffectsEnum.NONE;
    }
    
    public static final SpellEffectsEnum getEnumById(final long id) {
        for (int i = 0; i < SpellEffectsEnum.effects.length; ++i) {
            if (SpellEffectsEnum.effects[i].getId() == id) {
                return SpellEffectsEnum.effects[i];
            }
        }
        return SpellEffectsEnum.NONE;
    ...
    public static final SpellEffectsEnum getEnumForItemTemplateId(final int templateId, final int extraInfo) {
        switch (templateId) {
            case 1049: {
                return SpellEffectsEnum.ITEM_COTTON_CRUSHING;
            }
            case 1050: {
                return SpellEffectsEnum.ITEM_COTTON_SLASHING;
            }
            case 1051: {
                return SpellEffectsEnum.ITEM_NONE_BASHING;
            }
            case 1052: {
                return SpellEffectsEnum.ITEM_LEATHER_TWOHANDED;
            }
            case 1053:
            case 1066: {
                return SpellEffectsEnum.ITEM_STUDDED_TWOHANDED;
            }
            case 1054: {
                return SpellEffectsEnum.ITEM_LIGHT_BASHING;
            }
            case 1055:
            case 1092: {
                return SpellEffectsEnum.ITEM_MEDIUM_BASHING;
            }
            case 1056:
            case 1093: {
                return SpellEffectsEnum.ITEM_COTTON_SLASHDAM;
            }
            case 1057:
            case 1094: {
                return SpellEffectsEnum.ITEM_FACEDAM;
            }
            case 1058:
            case 1095: {
                return SpellEffectsEnum.ITEM_LEATHER_CRUSHDAM;
            }
            case 1059: {
                return SpellEffectsEnum.ITEM_CHAIN_SLASHDAM;
            }
            case 1060: {
                return SpellEffectsEnum.ITEM_CHAIN_PIERCEDAM;
            }
            case 1061: {
                return SpellEffectsEnum.ITEM_AREA_SPELL;
            }
            case 1062: {
                return SpellEffectsEnum.ITEM_ENCHANT_DAMREDUCT;
            }
            case 1063: {
                return SpellEffectsEnum.ITEM_AREASPELL_DAMREDUCT;
            }
            case 1064: {
                return SpellEffectsEnum.ITEM_MEDLIGHT_DAMINCREASE;
            }
            case 1065: {
                return SpellEffectsEnum.ITEM_HEAVY_ARCHERY;
            }
            case 1076: {
                switch (extraInfo) {
                    case 1: {
                        return SpellEffectsEnum.ITEM_RING_STAMINA;
                    }
                    case 2: {
                        return SpellEffectsEnum.ITEM_RING_DODGE;
                    }
                    case 3: {
                        return SpellEffectsEnum.ITEM_RING_CR;
                    }
                    case 4: {
                        return SpellEffectsEnum.ITEM_RING_SPELLRESIST;
                    }
                    case 5: {
                        return SpellEffectsEnum.ITEM_RING_HEALING;
                    }
                    default: {
                        return SpellEffectsEnum.ITEM_RING_SKILLGAIN;
                    }
                }
                break;
            }
            ...
            case 1078: {
                return SpellEffectsEnum.ITEM_RING_SWIMMING;
            }
            case 1079: {
                return SpellEffectsEnum.ITEM_RING_STEALTH;
            }
            case 1080: {
                return SpellEffectsEnum.ITEM_RING_DETECTION;
            }
            case 1081: {
                return SpellEffectsEnum.ITEM_BRACELET_CRUSH;
            }
            case 1082: {
                return SpellEffectsEnum.ITEM_BRACELET_TWOHANDED;
            }
            case 1083: {
                return SpellEffectsEnum.ITEM_BRACELET_PIERCEDAM;
            }
            case 1084: {
                return SpellEffectsEnum.ITEM_BRACELET_POLEARMDAM;
            }
            case 1085: {
                return SpellEffectsEnum.ITEM_BRACELET_ENCHANTDAM;
            }
            case 1086: {
                return SpellEffectsEnum.ITEM_NECKLACE_SKILLEFF;
            }
            case 1087: {
                return SpellEffectsEnum.ITEM_NECKLACE_SKILLMAX;
            }
            case 1088: {
                return SpellEffectsEnum.ITEM_NECKLACE_HURTING;
            }
            case 1089: {
                return SpellEffectsEnum.ITEM_NECKLACE_FOCUS;
            }
            case 1090: {
                return SpellEffectsEnum.ITEM_NECKLACE_REPLENISH;
            }
            default: {
                return null;
            }
    ...
    public static final SpellEffectsEnum getDebuffEnumForItemTemplateId(final int templateId, final int extraInfo) {
        switch (templateId) {
            case 1076: {
                switch (extraInfo) {
                    case 1: {
                        return SpellEffectsEnum.ITEM_DEBUFF_VULNERABILITY;
                    }
                    case 2: {
                        return SpellEffectsEnum.ITEM_DEBUFF_CLUMSINESS;
                    }
                    case 3: {
                        return SpellEffectsEnum.ITEM_DEBUFF_CLUMSINESS;
                    }
                    case 4: {
                        return SpellEffectsEnum.ITEM_DEBUFF_EXHAUSTION;
                    }
                    case 5: {
                        return SpellEffectsEnum.ITEM_DEBUFF_VULNERABILITY;
                    }
    ...
    static {
        SpellEffectsEnum.effects = values();
    }
}
