...
public final class CreatureTemplateCreator implements CreatureTypes, CreatureTemplateIds, SoundNames, ItemMaterials
{
    ...
    public static final int getDragonLoot(final int type) {
        switch (type) {
            case 89: {
                return 979;
            }
    ...
    public static final int getRandomDrakeId() {
        final int rng = Server.rand.nextInt(5);
        switch (rng) {
            case 0: {
                return 103;
            }
    ...
    public static final int getRandomDragonOrDrakeId() {
        final int rng = Server.rand.nextInt(10);
        switch (rng) {
            case 0: {
                return 91;
            }
    ...
    public static void createCreatureTemplates() {
        CreatureTemplateCreator.logger.info("Starting to create Creature Templates");
        ...
        createCreatureTemplate(36, "Mol-Rehan tower guard", "Mol-Rehan tower guards", "This person seems to be able to put up some resistance. These guards will help defend you if you say help.");
        ...
        CreatureTemplateCreator.logger.info("Creating Creature Templates took " + (end - start) + " ms");
    }
    
    private static void createCreatureTemplate(final int id, final String name, final String plural, final String longDesc) {
        ...
        try {
            ...
            else if (CreatureTemplateCreator.logger.isLoggable(Level.FINE)) {
                CreatureTemplateCreator.logger.fine("Using standard creature skills and characteristics for template id: " + id);
            }
        }
        catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static void createHellScorpionTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 6, 13, 16, 29, 32, 34, 39, 46, 55, 60, 61 };
    ...
    private static void createHellHoundTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        ...
        final int[] types = { 7, 6, 13, 3, 29, 36, 39, 32, 46, 55, 60, 61 };
    ...
    private static void createWorgTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 6, 13, 3, 29, 36, 39 };
    ...
    private static void createHellHorseTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 41, 3, 14, 9, 27, 32, 6, 39, 55 };
    ...
    private static void createHellFoalTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 3, 14, 9, 27, 32, 6, 39, 55, 63 };
    ...
    private static void createIncarnationLibilaTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 8, 13, 16, 27, 36, 12, 62, 24, 25, 40, 45, 47 };
    ...
    private static void createManifestationFoTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(10052, 75.0f);
        final int[] types = { 8, 13, 16, 27, 36, 12, 24, 40, 45, 47, 62 };
    ...
    private static void createMagranonJuggernautTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createEpiphanyVynoraTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(10052, 75.0f);
        final int[] types = { 8, 24, 13, 16, 27, 62, 36, 12, 40, 45, 47 };
    ...
    private static void createEagleSpiritTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 35.0f);
        ...
        final int[] types = { 41, 8, 13, 16, 29, 12, 24, 40, 22, 46, 50 };
    ...
    private static void createDrakeSpiritTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 65.0f);
        skills.learnTemp(103, 30.0f);
        ...
        skills.learnTemp(106, 39.0f);
        skills.learnTemp(10052, 75.0f);
        final int[] types = { 41, 8, 13, 16, 29, 12, 40, 22, 24, 46, 50 };
    ...
    private static void createSonOfNogumpTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 80.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 80.0f);
        skills.learnTemp(100, 7.0f);
        ...
        final int[] types = { 30, 8, 13, 16, 27, 24, 40, 45, 46, 50 };
    ...
    private static void createSpawnUttachaTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        ...
        final int[] types = { 7, 13, 16, 29, 39, 24, 40, 46, 50 };
        final int biteDamage = 15;
    ...
    private static void createDeathCrawlerMinionTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 20.0f);
        skills.learnTemp(100, 3.0f);
    ...
    private static void createDemonSolTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 35.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 30.0f);
        ...
        final int[] types = { 8, 13, 16, 29, 30, 36, 39, 24, 40, 45, 46, 50, 55 };
        final int biteDamage = 20;
    ...
    private static void createZombieTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 40.0f);
        skills.learnTemp(100, 20.0f);
    ...
    private static void createSkeletonTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createLadyLakeTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        ...
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 0, 17, 18, 40, 20, 37 };
    ...
    private static void createKingCobraTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 50.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 30.0f);
    ...
    private static void createAnadondaTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 2.0f);
        ...
        final int[] types = { 7, 3, 29, 12, 6, 39, 24, 60, 61 };
    ...
    private static void createPigTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 10.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 2.0f);
        ...
        final int[] types = { 7, 3, 43, 27, 14, 32 };
    ...
    private static void createLavaCreatureTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 30.0f);
        ...
        skills.learnTemp(106, 5.0f);
        skills.learnTemp(10052, 50.0f);
        final int[] types = { 7, 6, 13, 16, 40, 29, 30, 34, 32, 36, 39, 45, 55, 61 };
        final int biteDamage = 10;
    ...
    private static void createLavaSpiderTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 35.0f);
        ...
        skills.learnTemp(106, 2.0f);
        skills.learnTemp(10052, 70.0f);
        final int[] types = { 7, 6, 13, 3, 29, 39, 55, 60, 61 };
        int biteDamage = 7;
    ...
    private static void createFogSpiderTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 35.0f);
        skills.learnTemp(100, 8.0f);
        ...
        skills.learnTemp(106, 2.0f);
        skills.learnTemp(10052, 70.0f);
        final int[] types = { 7, 6, 13, 3, 29, 39 };
        int biteDamage = 11;
        if (Servers.localServer.PVPSERVER) {
            biteDamage = 14;
        }
    ...
    private static void createSpiderTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 35.0f);
        skills.learnTemp(100, 8.0f);
        ...
        skills.learnTemp(106, 2.0f);
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 7, 6, 13, 3, 29, 39, 60, 61 };
        int biteDamage = 6;
        if (Servers.localServer.PVPSERVER) {
            biteDamage = 10;
        }
    ...
    private static void createHyenaLabilaTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 35.0f);
        skills.learnTemp(100, 8.0f);
        ...
        skills.learnTemp(106, 2.0f);
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 7, 41, 25, 13, 3, 29, 36, 39 };
    ...
    private static void createSharkHugeTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 50.0f);
        skills.learnTemp(100, 14.0f);
        ...
        final int[] types = { 8, 38, 6, 13, 16, 29, 44, 40, 48, 37, 61 };
    ...
    private static void createBlueWhaleTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 50.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 50.0f);
        skills.learnTemp(100, 14.0f);
        ...
        skills.learnTemp(106, 5.0f);
        skills.learnTemp(10052, 85.0f);
        final int[] types = { 8, 38, 13, 3, 29, 44, 48, 37, 60, 61 };
    ...
    private static void createDolphinTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 65.0f);
        skills.learnTemp(103, 50.0f);
        skills.learnTemp(100, 14.0f);
        ...
        final int[] types = { 8, 38, 13, 16, 29, 44, 48, 37, 60, 61 };
    ...
    private static void createOctopusTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 35.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 40.0f);
        skills.learnTemp(100, 14.0f);
    ...
    private static void createSealTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 6.0f);
        ...
        final int[] types = { 8, 12, 35, 3, 29, 44, 48, 51, 32, 60, 61 };
    ...
    private static void createSealCubTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 10.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 15.0f);
        skills.learnTemp(100, 6.0f);
        ...
        skills.learnTemp(106, 15.0f);
        skills.learnTemp(10052, 15.0f);
        final int[] types = { 8, 12, 35, 3, 29, 44, 48, 51, 32, 63 };
    ...
    private static void createSeaSerpentTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(10052, 85.0f);
        skills.learnTemp(1023, 80.0f);
        final int[] types = { 8, 38, 6, 13, 16, 29, 44, 40, 37, 61 };
    ...
    private static void createAvengerOfLightTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 40.0f);
        skills.learnTemp(104, 55.0f);
        skills.learnTemp(103, 60.0f);
        skills.learnTemp(100, 24.0f);
        ...
        skills.learnTemp(106, 39.0f);
        skills.learnTemp(10052, 75.0f);
        final int[] types = { 8, 13, 16, 27, 36, 12, 24, 45, 50, 62, 65 };
    ...
    private static void createBoarFoTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 40.0f);
        skills.learnTemp(100, 2.0f);
        ...
        skills.learnTemp(106, 3.0f);
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 7, 41, 24, 13, 3, 27, 36, 39 };
    ...
    private static void createGorillaMagranonTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 40.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 40.0f);
        skills.learnTemp(100, 8.0f);
        ...
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 7, 24, 13, 3, 30, 27, 36, 39, 45 };
    ...
    private static void createGuardKingdomTowerTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        ...
        skills.learnTemp(10052, 45.0f);
        final String modelname = "model.creature.humanoid.human.guard.tower";
        final int[] types = { 21, 12, 13, 17, 45 };
        ...
        final int cr = Servers.localServer.isChallengeServer() ? 12 : 6;
    ...
    private static void createDummyDollTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 60.0f);
        skills.learnTemp(100, 20.0f);
    ...
    private static void createCatWildTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 3, 6, 32, 29, 60, 61 };
    ...
    private static void createCaveBugTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 10.0f);
        skills.learnTemp(104, 13.0f);
        ...
        final int[] types = { 7, 3, 6, 13, 27, 32, 34, 60, 61 };
    ...
    private static void createTortoiseTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 3, 6, 35, 44, 28, 32, 51, 48, 12, 60, 61 };
    ...
    private static void createCrabTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(106, 4.0f);
        skills.learnTemp(10052, 16.0f);
        final int[] types = { 7, 3, 6, 13, 27, 32, 51, 48, 12, 60, 61 };
    ...
    private static void createLionMountainTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        ...
        final int[] types = { 7, 3, 6, 13, 30, 32, 29, 60, 61 };
    ...
    private static void createRatLargeTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 3, 6, 12, 13, 27, 32, 60, 61 };
    ...
    private static void createDragonRedTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 80.0f);
        ...
        skills.learnTemp(10052, 95.0f);
        skills.learnTemp(1023, 80.0f);
        final int[] types = { 20, 19, 41, 7, 6, 13, 16, 32, 29, 12, 40 };
    ...
    private static void createDragonBlueTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 80.0f);
        skills.learnTemp(104, 90.0f);
    ...
    private static void createDragonGreenTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createDragonBlackTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 80.0f);
        skills.learnTemp(104, 90.0f);
        skills.learnTemp(103, 90.0f);
        skills.learnTemp(100, 56.0f);
    ...
    private static void createDragonWhiteTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 80.0f);
        skills.learnTemp(104, 90.0f);
    ...
    private static void createDrakeRedTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 50.0f);
        skills.learnTemp(104, 65.0f);
        skills.learnTemp(103, 70.0f);
        ...
        skills.learnTemp(10052, 80.0f);
        skills.learnTemp(1023, 80.0f);
        final int[] types = { 20, 19, 41, 7, 12, 6, 13, 16, 32, 29, 40 };
    ...
    private static void createDrakeBlueTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createDrakeWhiteTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 40.0f);
        skills.learnTemp(104, 55.0f);
        skills.learnTemp(103, 60.0f);
        skills.learnTemp(100, 24.0f);
    ...
    private static void createDrakeGreenTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createDrakeBlackTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 50.0f);
        skills.learnTemp(104, 75.0f);
        skills.learnTemp(103, 70.0f);
        skills.learnTemp(100, 27.0f);
    ...
    private static void createForestGiantTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 40.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 60.0f);
        skills.learnTemp(100, 5.0f);
        ...
        final int[] types = { 20, 7, 6, 13, 16, 27, 32, 40, 45 };
    ...
    private static void createCyclopsTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 80.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 80.0f);
        skills.learnTemp(100, 7.0f);
        ...
        final int[] types = { 30, 20, 7, 6, 13, 16, 27, 32, 40, 45 };
    ...
    private static void createTrollKingTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 70.0f);
        skills.learnTemp(104, 45.0f);
        skills.learnTemp(103, 70.0f);
        skills.learnTemp(100, 15.0f);
        ...
        skills.learnTemp(10052, 80.0f);
        skills.learnTemp(10064, 90.0f);
        final int[] types = { 20, 7, 6, 13, 16, 18, 29, 30, 32, 40, 45 };
    ...
    private static void createTrollTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 40.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 40.0f);
        skills.learnTemp(100, 8.0f);
        ...
        final int[] types = { 7, 6, 40, 13, 16, 18, 29, 30, 32, 36, 39, 45, 60, 61 };
    ...
    private static void createGoblinLeaderTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 50.0f);
        ...
        skills.learnTemp(1023, 80.0f);
        final int[] types = { 20, 7, 6, 13, 16, 29, 30, 32, 40, 45 };
    ...
    private static void createGoblinTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 20.0f);
        skills.learnTemp(100, 12.0f);
        ...
        final int[] types = { 7, 6, 13, 16, 29, 30, 32, 34, 45, 60, 61 };
    ...
    private static void createScorpionTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 20.0f);
        skills.learnTemp(100, 2.0f);
        ...
        final int[] types = { 7, 41, 6, 13, 16, 29, 32, 34, 39, 60, 61 };
    ...
    private static void createUnicornTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        ...
        final int[] types = { 7, 41, 3, 32, 28, 9, 39, 35 };
    ...
    private static void createUnicornFoalTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 6.0f);
        ...
        skills.learnTemp(106, 10.0f);
        skills.learnTemp(10052, 15.0f);
        final int[] types = { 7, 3, 9, 28, 32, 63, 35, 39 };
    ...
    private static void createBearBlackTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createBearBrownTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 4.0f);
        ...
        skills.learnTemp(106, 4.0f);
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 8, 41, 3, 6, 12, 13, 32, 29, 39, 60, 61 };
    ...
    private static void createEasterBunnyTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 5.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 70.0f);
        skills.learnTemp(100, 3.0f);
    ...
    private static void createCrocodileTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 35.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 20.0f);
        skills.learnTemp(100, 6.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 50.0f);
        final int[] types = { 6, 41, 7, 3, 13, 32, 29, 12, 39, 60, 61 };
    ...
    private static void createDogTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 20.0f);
        skills.learnTemp(100, 6.0f);
        ...
        final int[] types = { 8, 3, 13, 43, 32, 27, 12 };
    ...
    private static void createBlackWolfTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 6.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 10.0f);
        final int[] types = { 8, 3, 6, 13, 32, 29, 60, 61 };
    ...
    private static void createGuardSpiritGoodLenientTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 15.0f);
    ...
    private static void createGuardSpiritEvilLenientTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 15.0f);
    ...
    private static void createWraithTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
    ...
    private static void createGuardSpiritAbleTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
    ...
    private static void createGuardSpiritEvilDangerousTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
        skills.learnTemp(103, 35.0f);
        skills.learnTemp(100, 17.0f);
    ...
    private static void createGuardSpiritGoodDangerousTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
        skills.learnTemp(103, 35.0f);
        skills.learnTemp(100, 17.0f);
    ...
    private static void createGuardBrutalTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 30.0f);
        skills.learnTemp(104, 30.0f);
        ...
        skills.learnTemp(10006, 90.0f);
        skills.learnTemp(10052, 90.0f);
        final int[] types = { 12, 13, 17, 24, 45, 40, 21, 53, 7 };
    ...
    private static void createGuardToughTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(10052, 90.0f);
        final int[] types = { 12, 13, 17, 24, 45, 40, 53, 7 };
    ...
    private static void createGuardAbleTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 22.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 26.0f);
        skills.learnTemp(100, 18.0f);
        ...
        skills.learnTemp(10006, 60.0f);
        skills.learnTemp(10052, 75.0f);
        final int[] types = { 11, 12, 13, 17, 45, 40, 53, 7 };
    ...
    private static void createGuardDecentTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 17.0f);
        skills.learnTemp(103, 21.0f);
        skills.learnTemp(100, 15.0f);
    ...
    private static void createGuardLenientTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
    ...
    private static void createGuideHotsTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 10.0f);
    ...
    private static void createGuideTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 10.0f);
    ...
    private static void createEvilSantaTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 10.0f);
    ...
    private static void createSantaClausTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 10.0f);
    ...
    private static void createBartenderTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 10.0f);
    ...
    private static void createSalesmanTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 30.0f);
    ...
    private static void createChickenTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 3, 14, 43, 28, 32, 63 };
    ...
    private static void createHenTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 5.0f);
        final int[] types = { 7, 3, 14, 43, 28, 32, 35, 49, 64 };
    ...
    private static void createPheasantTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 5.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 5.0f);
        skills.learnTemp(100, 5.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 7.0f);
        final int[] types = { 7, 3, 28, 32, 35, 49, 60, 61 };
    ...
    private static void createRoosterTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 5.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 5.0f);
        skills.learnTemp(100, 5.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 10.0f);
        final int[] types = { 7, 3, 14, 43, 28, 32, 64 };
    ...
    private static void createDeerTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        ...
        skills.learnTemp(10052, 10.0f);
        final int[] types = { 7, 3, 9, 28, 32, 49, 35, 60, 61 };
    ...
    private static void createFoalTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 10.0f);
        skills.learnTemp(104, 10.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 3.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 5.0f);
        final int[] types = { 7, 12, 3, 43, 14, 9, 28, 32, 63 };
    ...
    private static void createHorseTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 40.0f);
        skills.learnTemp(100, 7.0f);
    ...
    private static void createBisonTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        ...
        skills.learnTemp(106, 3.0f);
        skills.learnTemp(10052, 15.0f);
        final int[] types = { 7, 3, 43, 14, 9, 28, 32, 49, 35, 15 };
    ...
    private static void createBullTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 23.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 5.0f);
    ...
    private static void createCalfTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 10.0f);
        skills.learnTemp(104, 10.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 3.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 5.0f);
        final int[] types = { 7, 3, 14, 43, 9, 28, 32, 49, 35, 63 };
    ...
    private static void createBrownCowTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 5.0f);
        ...
        final int[] types = { 7, 41, 3, 43, 14, 15, 9, 28, 32, 49, 35 };
    ...
    private static void createLambTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 5.0f);
        final int[] types = { 7, 3, 43, 14, 54, 9, 28, 32, 49, 35, 63 };
    ...
    private static void createSheepTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 17.0f);
        skills.learnTemp(104, 17.0f);
        skills.learnTemp(103, 25.0f);
        skills.learnTemp(100, 5.0f);
        ...
        skills.learnTemp(106, 1.0f);
        skills.learnTemp(10052, 8.0f);
        final int[] types = { 7, 3, 43, 14, 54, 15, 9, 28, 32, 49, 35, 52 };
    ...
    private static void createRamTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        ...
        final int[] types = { 7, 3, 43, 14, 54, 9, 28, 32, 49, 35, 52 };
    ...
    private static void createKidTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 10.0f);
        skills.learnTemp(104, 10.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 3.0f);
    ...
    private static void createHumanTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        final float num = Servers.localServer.getSkillbasicval();
        skills.learn(1, num);
        skills.learn(3, num);
        skills.learn(2, num);
        ...
        final int[] types = { 1, 12, 13, 17, 45, 7 };
    ...
    private static void createRiftTemplateOne(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 35.0f);
        skills.learnTemp(103, 25.0f);
        skills.learnTemp(100, 8.0f);
        ...
        skills.learnTemp(106, 2.0f);
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 7, 13, 3, 29, 6, 12 };
    ...
    private static void createRiftTemplateTwo(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 12.0f);
        ...
        skills.learnTemp(106, 12.0f);
        skills.learnTemp(10052, 40.0f);
        final int[] types = { 7, 6, 13, 16, 40, 29, 30, 34, 39, 45, 55, 18, 12 };
        final int biteDamage = 10;
    ...
    private static void createRiftTemplateThree(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 12.0f);
    ...
    private static void createRiftTemplateFour(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 25.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 12.0f);
    ...
    private static void createRiftCasterTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 20.0f);
    ...
    private static void createRiftOgreMageTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 20.0f);
        skills.learnTemp(104, 20.0f);
        skills.learnTemp(103, 20.0f);
        skills.learnTemp(100, 42.0f);
    ...
    private static void createRiftSummonerTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 40.0f);
        skills.learnTemp(104, 25.0f);
        skills.learnTemp(103, 30.0f);
        skills.learnTemp(100, 18.0f);
    ...
    private static void createNpcHumanTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        skills.learnTemp(102, 15.0f);
        skills.learnTemp(104, 15.0f);
        skills.learnTemp(103, 10.0f);
        skills.learnTemp(100, 10.0f);
    ...
    private static void createFishTemplate(final int id, final String name, final String plural, final String longDesc, final Skills skills) throws IOException {
        final int[] types = { 4, 38, 37 };
    ...
    static {
        logger = Logger.getLogger(CreatureTemplateCreator.class.getName());
    }
}
