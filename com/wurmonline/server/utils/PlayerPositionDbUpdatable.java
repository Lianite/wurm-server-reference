...
public final class PlayerPositionDbUpdatable implements WurmDbUpdatable
{
    ...
    public PlayerPositionDbUpdatable(final long aId, final float aPositionX, final float aPositionY, final float aPositionZ, final float aRotation, final int aZoneid, final int aLayer, final long bridgeid) {
        this.id = aId;
