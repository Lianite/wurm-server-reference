...
public interface WebInterface extends Remote
{
    ...
    Ban[] getPlayersBanned(final String p0) throws RemoteException;
    
    Ban[] getIpsBanned(final String p0) throws RemoteException;
    ...
    String ascend(final String p0, final int p1, final String p2, final long p3, final byte p4, final byte p5, final byte p6, final float p7, final float p8, final float p9, final float p10, final float p11, final float p12, final float p13) throws RemoteException;
