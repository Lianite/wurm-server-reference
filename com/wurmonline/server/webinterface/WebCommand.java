...
public abstract class WebCommand
{
    ...
    WebCommand(final long _id) {
        this.isRestrictedEpic = false;
        this.id = _id;
        this.type = 0;
    }
    
    WebCommand(final long _id, final short _type) {
        this.isRestrictedEpic = false;
        this.id = _id;
        this.type = _type;
    }
    
    WebCommand(final long _id, final short _type, final byte[] _data) {
        this.isRestrictedEpic = false;
        this.id = _id;
        this.type = _type;
        this.data = _data;
    ...
    final void setData(final byte[] _data) {
        this.data = _data;
    }
    ...
    static final WebCommand createWebCommand(final short wctype, final long id, final byte[] data) {
        switch (wctype) {
            case 1: {
    ...
    public final void sendToServer(final int serverId) {
        this.encode();
