...
public final class WcTrelloHighway extends WebCommand implements MiscConstants
{
    ...
    WcTrelloHighway(final long aId, final byte[] _data) {
    ...
    public WcTrelloHighway(final String title, final String description) {
    ...
    public byte[] encode() {
        ...
        try {
            ...
            WcTrelloHighway.logger.log(Level.WARNING, "Pack exception " + ex.getMessage(), ex);
        }
        finally {
    ...
    public void execute() {
        ...
        try {
            ...
            WcTrelloHighway.logger.log(Level.WARNING, "Unpack exception " + ex.getMessage(), ex);
        }
        finally {
    ...
    static {
        logger = Logger.getLogger(WcTrelloHighway.class.getName());
    }
}
