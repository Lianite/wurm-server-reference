...
public enum WallEnum
{
    ...
    NARROW_WINDOW_PLAIN_STONE((short)650, StructureTypeEnum.NARROW_WINDOW, StructureMaterialEnum.PLAIN_STONE, "Plain stone window narrow", "building narrow window", (short)60, false), 
    NARROW_WINDOW_SLATE((short)774, StructureTypeEnum.NARROW_WINDOW, StructureMaterialEnum.SLATE, "Slate window narrow", "building narrow window", (short)60, false), 
    NARROW_WINDOW_ROUNDED_STONE((short)786, StructureTypeEnum.NARROW_WINDOW, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone window narrow", "building narrow window", (short)60, false), 
    NARROW_WINDOW_POTTERY((short)798, StructureTypeEnum.NARROW_WINDOW, StructureMaterialEnum.POTTERY, "Pottery window narrow", "building narrow window", (short)60, false), 
    NARROW_WINDOW_SANDSTONE((short)810, StructureTypeEnum.NARROW_WINDOW, StructureMaterialEnum.SANDSTONE, "Sandstone window narrow", "building narrow window", (short)60, false), 
    NARROW_WINDOW_MARBLE((short)822, StructureTypeEnum.NARROW_WINDOW, StructureMaterialEnum.MARBLE, "Marble window narrow", "building narrow window", (short)60, false), 
    ...
    DOUBLE_DOOR_PLAIN_STONE((short)652, StructureTypeEnum.DOUBLE_DOOR, StructureMaterialEnum.PLAIN_STONE, "Plain stone door double", "building double door", (short)60, true), 
    DOUBLE_DOOR_TIMBER_FRAMED((short)625, StructureTypeEnum.DOUBLE_DOOR, StructureMaterialEnum.TIMBER_FRAMED, "Timber framed door double", "building double door", (short)60, true), 
    ...
    DOUBLE_DOOR_ROUNDED_STONE((short)788, StructureTypeEnum.DOUBLE_DOOR, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone door double", "building double door", (short)60, true), 
    DOUBLE_DOOR_POTTERY((short)800, StructureTypeEnum.DOUBLE_DOOR, StructureMaterialEnum.POTTERY, "Pottery door double", "building double door", (short)60, true), 
    DOUBLE_DOOR_SANDSTONE((short)812, StructureTypeEnum.DOUBLE_DOOR, StructureMaterialEnum.SANDSTONE, "Sandstone door double", "building double door", (short)60, true), 
    ...
    LEFT_ARCHED_PLAIN_STONE((short)769, StructureTypeEnum.ARCHED_LEFT, StructureMaterialEnum.PLAIN_STONE, "Plain stone arch left", "building arch left", (short)60, true), 
    LEFT_ARCHED_TIMBER_FRAMED((short)766, StructureTypeEnum.ARCHED_LEFT, StructureMaterialEnum.TIMBER_FRAMED, "Timber framed arch left", "building arch left", (short)60, true), 
    ...
    LEFT_ARCHED_ROUNDED_STONE((short)793, StructureTypeEnum.ARCHED_LEFT, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone arch left", "building arch left", (short)60, true), 
    ...
    LEFT_ARCHED_SANDSTONE((short)817, StructureTypeEnum.ARCHED_LEFT, StructureMaterialEnum.SANDSTONE, "Sandstone arch left", "building arch left", (short)60, true), 
    ...
    RIGHT_ARCHED_PLAIN_STONE((short)770, StructureTypeEnum.ARCHED_RIGHT, StructureMaterialEnum.PLAIN_STONE, "Plain stone arch right", "building arch right", (short)60, true), 
    RIGHT_ARCHED_TIMBER_FRAMED((short)767, StructureTypeEnum.ARCHED_RIGHT, StructureMaterialEnum.TIMBER_FRAMED, "Timber framed arch right", "building arch right", (short)60, true), 
    ...
    RIGHT_ARCHED_ROUNDED_STONE((short)794, StructureTypeEnum.ARCHED_RIGHT, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone arch right", "building arch right", (short)60, true), 
    RIGHT_ARCHED_POTTERY((short)806, StructureTypeEnum.ARCHED_RIGHT, StructureMaterialEnum.POTTERY, "Pottery arch right", "building arch right", (short)60, true), 
    RIGHT_ARCHED_SANDSTONE((short)818, StructureTypeEnum.ARCHED_RIGHT, StructureMaterialEnum.SANDSTONE, "Sandstone arch right", "building arch right", (short)60, true), 
    ...
    T_ARCHED_TIMBER_FRAMED((short)768, StructureTypeEnum.ARCHED_T, StructureMaterialEnum.TIMBER_FRAMED, "Timber framed arch T", "building arch T", (short)60, true), 
    ...
    T_ARCHED_ROUNDED_STONE((short)795, StructureTypeEnum.ARCHED_T, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone arch T", "building arch T", (short)60, true), 
    ...
    PORTCULLIS_PLAIN_STONE((short)655, StructureTypeEnum.PORTCULLIS, StructureMaterialEnum.PLAIN_STONE, "Plain stone portcullis", "building portcullis", (short)60, true), 
    ...
    PORTCULLIS_ROUNDED_STONE((short)790, StructureTypeEnum.PORTCULLIS, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone portcullis", "building portcullis", (short)60, true), 
    ...
    PORTCULLIS_SANDSTONE((short)814, StructureTypeEnum.PORTCULLIS, StructureMaterialEnum.SANDSTONE, "Sandstone portcullis", "building portcullis", (short)60, true), 
    ...
    BARRED_PLAIN_STONE((short)656, StructureTypeEnum.BARRED, StructureMaterialEnum.PLAIN_STONE, "Plain stone wall barred", "building wall barred", (short)60, false), 
    ...
    BARRED_ROUNDED_STONE((short)791, StructureTypeEnum.BARRED, StructureMaterialEnum.ROUNDED_STONE, "Rounded stone wall barred", "building wall barred", (short)60, true), 
    ...
    TIMBER_FRAMED_BALCONY((short)676, StructureTypeEnum.BALCONY, StructureMaterialEnum.TIMBER_FRAMED, "Timber framed balcony", "building balcony", (short)60, true);
    ...
    private WallEnum(final short actionId, final StructureTypeEnum type, final StructureMaterialEnum material, final String name, final String actionString, final short icon, final boolean isDoor) {
        this.type = type;
        this.icon = icon;
    ...
    public static List<WallEnum> getWallsByTool(final Creature performer, final Item tool, final boolean needsDoor, final boolean hasAFence) {
        final StructureMaterialEnum[] mats = getMaterialsFromToolType(tool, performer);
        final List<WallEnum> list = new ArrayList<WallEnum>();
        for (final WallEnum en : values()) {
            if (en.getType() != StructureTypeEnum.PLAN) {
                if (!hasAFence || Wall.isArched(en.getType())) {
                    for (final StructureMaterialEnum mat : mats) {
                        if (needsDoor) {
    ...
    public static List<WallEnum> getWallsByToolAndMaterial(final Creature performer, final Item tool, final boolean needsDoor, final boolean hasAFence, final StructureMaterialEnum material) {
        final StructureMaterialEnum[] mats = getMaterialsFromToolType(tool, performer);
        final List<WallEnum> list = new ArrayList<WallEnum>();
        for (final WallEnum en : values()) {
            if (en.getType() != StructureTypeEnum.PLAN) {
                if (en.getMaterial() == material) {
                    if (!hasAFence || Wall.isArched(en.getType())) {
                        for (final StructureMaterialEnum mat : mats) {
                            if (needsDoor) {
                                if (en.getMaterial() == mat && en.isDoor()) {
    ...
    public static final boolean canBuildWall(final Wall wall, final StructureMaterialEnum material, final Creature performer) {
        final int skillNumber = getSkillNumber(material);
        final Skill skill = performer.getSkills().getSkillOrLearn(skillNumber);
        return skill != null && (skillNumber != 1013 || skill.getKnowledge(0.0) >= 30.0) && FloorBehaviour.getRequiredBuildSkillForFloorLevel(wall.getFloorLevel(), false) <= skill.getKnowledge(0.0);
    }
    
    public static final boolean canBuildWall(final Wall wall, final Creature performer) {
    ...
    public static final int getSkillNumber(final StructureMaterialEnum material) {
    ...
    public static WallEnum getWall(final StructureTypeEnum type, final StructureMaterialEnum material) {
        for (final WallEnum en : values()) {
            if (en.getType() == type && en.getMaterial() == material) {
                return en;
            }
        }
        return WallEnum.WALL_PLAN;
    }
    
    public static WallEnum getWallByActionId(final short actionId) {
        for (final WallEnum en : values()) {
    ...
    public static int[] getTotalMaterialsNeeded(final WallEnum en) {
        return new int[0];
    }
    
    public static int[] getMaterialsNeeded(final Wall wall) {
        final int needed = wall.getFinalState().state - wall.getState().state;
    ...
    public static boolean isCorrectTool(final WallEnum wall, final Creature performer, final Item tool) {
        if (tool == null) {
            return false;
        }
        final List<Integer> tools = getToolsForWall(wall, performer);
    ...
    public final boolean isCorrectToolForType(final Item tool, final Creature performer) {
        final List<Integer> list = getToolsForWall(this, performer);
        return list.contains(tool.getTemplateId());
    }
    
    public static List<Integer> getToolsForWall(final WallEnum wall, final Creature performer) {
    ...
    public static StructureMaterialEnum[] getMaterialsFromToolType(final Item tool, final Creature performer) {
    ...
    public final ActionEntry createActionEntry() {
        return ActionEntry.createEntry(this.actionId, this.name, this.actionString, WallEnum.emptyArr);
    }
    
    static {
        WallEnum.emptyArr = new int[0];
    }
}
