...
public final class TrelloURL
{
    ...
    public static TrelloURL create(final String url, final String... pathParams) {
        return new TrelloURL(url, pathParams);
    }
    
    public static String make(final String url, final String... pathParams) {
        return new TrelloURL(url, pathParams).build();
    }
    
    private TrelloURL(final String aUrl, final String... aPathParams) {
        this.apiKey = Constants.trelloApiKey;
        this.token = Constants.trelloToken;
        this.filters = null;
        this.url = aUrl;
        this.pathParams = aPathParams;
    }
    
    public TrelloURL filter(final String... aFilters) {
        this.filters = (String[])(isArrayEmpty(aFilters) ? null : aFilters);
        return this;
    }
    ...
    private String createAuthQueryString() {
        final StringBuilder sb = new StringBuilder("?key=").append(this.apiKey);
        if (this.token != null) {
    ...
    private static boolean isArrayEmpty(final String[] arr) {
