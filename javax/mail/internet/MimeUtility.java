...
public class MimeUtility
{
    ...
    private static boolean nonAsciiCharset(final ContentType ct) {
        ...
        synchronized (MimeUtility.nonAsciiCharsetMap) {
            bool = MimeUtility.nonAsciiCharsetMap.get(charset);
        }
        if (bool == null) {
            try {
                final byte[] b = "\r\n".getBytes(charset);
            ...
            synchronized (MimeUtility.nonAsciiCharsetMap) {
                MimeUtility.nonAsciiCharsetMap.put(charset, bool);
            }
        }
        return bool;
    }
    ...
    static {
        ...
        try {
            InputStream is = ((MimeUtility.class$javax$mail$internet$MimeUtility == null) ? (MimeUtility.class$javax$mail$internet$MimeUtility = class$("javax.mail.internet.MimeUtility")) : MimeUtility.class$javax$mail$internet$MimeUtility).getResourceAsStream("/META-INF/javamail.charset.map");
            if (is != null) {
                try {
